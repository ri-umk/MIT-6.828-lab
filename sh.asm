       ...
       f:	0f 8f c5 00 00 00    	jg     da <main+0xda>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      1c:	00 
      1d:	c7 04 24 41 11 00 00 	movl   $0x1141,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      30:	80 3d a2 17 00 00 20 	cmpb   $0x20,0x17a2
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
      ...
      51:	00 
      52:	c7 04 24 a0 17 00 00 	movl   $0x17a0,(%esp)
      59:	e8 8a 00 00 00       	call   e8 <getcmd>
      5e:	85 c0                	test   %eax,%eax
      60:	78 2f                	js     91 <main+0x91>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      62:	80 3d a0 17 00 00 63 	cmpb   $0x63,0x17a0
      69:	75 d1                	jne    3c <main+0x3c>
      6b:	80 3d a1 17 00 00 64 	cmpb   $0x64,0x17a1
    ...
    if(fork1() == 0)
      ...
      runcmd(parsecmd(buf));
      7d:	c7 04 24 a0 17 00 00 	movl   $0x17a0,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      buf[strlen(buf)-1] = 0;  // chop \n
      96:	c7 04 24 a0 17 00 00 	movl   $0x17a0,(%esp)
      9d:	e8 ca 0a 00 00       	call   b6c <strlen>
      a2:	c6 80 9f 17 00 00 00 	movb   $0x0,0x179f(%eax)
      if(chdir(buf+3) < 0)
      a9:	c7 04 24 a3 17 00 00 	movl   $0x17a3,(%esp)
      b0:	e8 87 0c 00 00       	call   d3c <chdir>
      b5:	85 c0                	test   %eax,%eax
      b7:	79 91                	jns    4a <main+0x4a>
        printf(2, "cannot cd %s\n", buf+3);
      b9:	c7 44 24 08 a3 17 00 	movl   $0x17a3,0x8(%esp)
      c0:	00 
      c1:	c7 44 24 04 49 11 00 	movl   $0x1149,0x4(%esp)
      c8:	00 
      c9:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      d0:	e8 37 0d 00 00       	call   e0c <printf>
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
      f6:	c7 44 24 04 a0 10 00 	movl   $0x10a0,0x4(%esp)
      fd:	00 
      fe:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     105:	e8 02 0d 00 00       	call   e0c <printf>
  memset(buf, 0, nbuf);
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     145:	c7 44 24 04 3d 11 00 	movl   $0x113d,0x4(%esp)
     14c:	00 
     14d:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     154:	e8 b3 0c 00 00       	call   e0c <printf>
  exit();
     ...
     171:	c3                   	ret    
{
  ...
  if(pid == -1)
    panic("fork");
     172:	c7 04 24 a3 10 00 00 	movl   $0x10a3,(%esp)
...
runcmd(struct cmd *cmd)
{
  ...
  default:
    panic("runcmd");
     193:	c7 04 24 a8 10 00 00 	movl   $0x10a8,(%esp)
  ...
  switch(cmd->type){
     ...
     1f3:	ff 24 85 58 11 00 00 	jmp    *0x1158(,%eax,4)
    wait();
    break;
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     267:	c7 44 24 04 af 10 00 	movl   $0x10af,0x4(%esp)
     26e:	00 
     26f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     276:	e8 91 0b 00 00       	call   e0c <printf>
    break;
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     287:	c7 44 24 04 bf 10 00 	movl   $0x10bf,0x4(%esp)
     28e:	00 
     28f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     296:	e8 71 0b 00 00       	call   e0c <printf>
      exit();
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
      panic("pipe");
     2a0:	c7 04 24 cf 10 00 00 	movl   $0x10cf,(%esp)
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     32a:	e8 91 0c 00 00       	call   fc0 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     366:	e8 55 0c 00 00       	call   fc0 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3c2:	e8 f9 0b 00 00       	call   fc0 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     40a:	e8 b1 0b 00 00       	call   fc0 <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     452:	e8 69 0b 00 00       	call   fc0 <malloc>
     ...
     4a4:	43                   	inc    %ebx
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4b0:	c7 04 24 7c 17 00 00 	movl   $0x177c,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4fc:	c7 04 24 7c 17 00 00 	movl   $0x177c,(%esp)
  ...
  *ps = s;
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     533:	c7 04 24 74 17 00 00 	movl   $0x1774,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     54f:	c7 04 24 7c 17 00 00 	movl   $0x177c,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5c8:	c7 04 24 7c 17 00 00 	movl   $0x177c,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     620:	c7 44 24 08 f1 10 00 	movl   $0x10f1,0x8(%esp)
     627:	00 
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
      panic("missing file for redirection");
     6db:	c7 04 24 d4 10 00 00 	movl   $0x10d4,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     6f7:	c7 44 24 08 f4 10 00 	movl   $0x10f4,0x8(%esp)
     6fe:	00 
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     752:	c7 44 24 08 0b 11 00 	movl   $0x110b,0x8(%esp)
     759:	00 
    ...
    if(argc >= MAXARGS)
     ...
     7a3:	75 97                	jne    73c <parseexec+0x54>
      panic("too many args");
     7a5:	c7 04 24 fd 10 00 00 	movl   $0x10fd,(%esp)
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
      panic("syntax");
     7f1:	c7 04 24 f6 10 00 00 	movl   $0x10f6,(%esp)
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     81d:	c7 44 24 08 10 11 00 	movl   $0x1110,0x8(%esp)
     824:	00 
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
     8c2:	c7 44 24 08 12 11 00 	movl   $0x1112,0x8(%esp)
     8c9:	00 
  ...
  if(peek(ps, es, ";")){
     8da:	c7 44 24 08 0e 11 00 	movl   $0x110e,0x8(%esp)
     8e1:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     947:	c7 44 24 08 f4 10 00 	movl   $0x10f4,0x8(%esp)
     94e:	00 
  ...
  if(!peek(ps, es, ")"))
     989:	c7 44 24 08 30 11 00 	movl   $0x1130,0x8(%esp)
     990:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
    panic("parseblock");
     9d5:	c7 04 24 14 11 00 00 	movl   $0x1114,(%esp)
     9dc:	e8 57 f7 ff ff       	call   138 <panic>
  gettoken(ps, es, 0, 0);
  cmd = parseline(ps, es);
  if(!peek(ps, es, ")"))
    panic("syntax - missing )");
     9e1:	c7 04 24 1f 11 00 00 	movl   $0x111f,(%esp)
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     a0e:	ff 24 85 70 11 00 00 	jmp    *0x1170(,%eax,4)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ab2:	c7 44 24 08 be 10 00 	movl   $0x10be,0x8(%esp)
     ab9:	00 
  ...
  if(s != es){
    printf(2, "leftovers: %s\n", s);
     ...
     ae5:	c7 44 24 04 32 11 00 	movl   $0x1132,0x4(%esp)
     aec:	00 
     aed:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     af4:	e8 13 03 00 00       	call   e0c <printf>
    panic("syntax");
     af9:	c7 04 24 f6 10 00 00 	movl   $0x10f6,(%esp)
...
putc(int fd, char c)
{
     ...
     d82:	88 55 f4             	mov    %dl,-0xc(%ebp)
  write(fd, &c, 1);
     d85:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
     d8c:	00 
     d8d:	8d 55 f4             	lea    -0xc(%ebp),%edx
     d90:	89 54 24 04          	mov    %edx,0x4(%esp)
     d94:	89 04 24             	mov    %eax,(%esp)
     d97:	e8 50 ff ff ff       	call   cec <write>
}
     d9c:	c9                   	leave  
     d9d:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
     dad:	8b 5d 08             	mov    0x8(%ebp),%ebx
     db0:	85 db                	test   %ebx,%ebx
     db2:	74 04                	je     db8 <printint+0x18>
     db4:	85 d2                	test   %edx,%edx
     db6:	78 4a                	js     e02 <printint+0x62>
  ...
  i = 0;
     dba:	31 db                	xor    %ebx,%ebx
     dbc:	eb 04                	jmp    dc2 <printint+0x22>
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     dc4:	f7 f1                	div    %ecx
     dc6:	8a 92 8f 11 00 00    	mov    0x118f(%edx),%dl
     dcc:	88 54 1d d8          	mov    %dl,-0x28(%ebp,%ebx,1)
     dd0:	8d 53 01             	lea    0x1(%ebx),%edx
  }while((x /= base) != 0);
     dd3:	85 c0                	test   %eax,%eax
     dd5:	75 e9                	jne    dc0 <printint+0x20>
  if(neg)
     dd7:	85 ff                	test   %edi,%edi
     dd9:	74 08                	je     de3 <printint+0x43>
    buf[i++] = '-';
     ddb:	c6 44 15 d8 2d       	movb   $0x2d,-0x28(%ebp,%edx,1)
     de0:	8d 53 02             	lea    0x2(%ebx),%edx

  while(--i >= 0)
     de3:	8d 5a ff             	lea    -0x1(%edx),%ebx
     de6:	66 90                	xchg   %ax,%ax
    putc(fd, buf[i]);
     de8:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
     ded:	89 f0                	mov    %esi,%eax
     def:	e8 88 ff ff ff       	call   d7c <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
     df4:	4b                   	dec    %ebx
     df5:	83 fb ff             	cmp    $0xffffffff,%ebx
     df8:	75 ee                	jne    de8 <printint+0x48>
    putc(fd, buf[i]);
}
  ...
  if(sgn && xx < 0){
    neg = 1;
     e04:	bf 01 00 00 00       	mov    $0x1,%edi
    x = -xx;
     e09:	eb af                	jmp    dba <printint+0x1a>
     e0b:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
     e18:	8b 5d 0c             	mov    0xc(%ebp),%ebx
     e1b:	8a 0b                	mov    (%ebx),%cl
     e1d:	84 c9                	test   %cl,%cl
     e1f:	74 7b                	je     e9c <printf+0x90>
  char *s;
  int c, i, state;
  uint *ap;
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
     e21:	8d 45 10             	lea    0x10(%ebp),%eax
     e24:	89 45 e4             	mov    %eax,-0x1c(%ebp)
{
  char *s;
  int c, i, state;
  uint *ap;
  ...
  state = 0;
     e27:	31 f6                	xor    %esi,%esi
     e29:	eb 17                	jmp    e42 <printf+0x36>
     e2b:	90                   	nop
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
     e2c:	83 f9 25             	cmp    $0x25,%ecx
     e2f:	74 73                	je     ea4 <printf+0x98>
        state = '%';
      } else {
        putc(fd, c);
     e31:	0f be d1             	movsbl %cl,%edx
     e34:	89 f8                	mov    %edi,%eax
     e36:	e8 41 ff ff ff       	call   d7c <putc>
      } else if(c == '%'){
        putc(fd, c);
      } else {
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
     e3c:	8a 0b                	mov    (%ebx),%cl
     e3e:	84 c9                	test   %cl,%cl
     e40:	74 5a                	je     e9c <printf+0x90>
    c = fmt[i] & 0xff;
     e42:	0f b6 c9             	movzbl %cl,%ecx
    if(state == 0){
     e45:	85 f6                	test   %esi,%esi
     e47:	74 e3                	je     e2c <printf+0x20>
      if(c == '%'){
        state = '%';
      } else {
        putc(fd, c);
     ...
     e49:	83 fe 25             	cmp    $0x25,%esi
     e4c:	75 ed                	jne    e3b <printf+0x2f>
      if(c == 'd'){
     e4e:	83 f9 64             	cmp    $0x64,%ecx
     e51:	0f 84 c1 00 00 00    	je     f18 <printf+0x10c>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
     e57:	83 f9 78             	cmp    $0x78,%ecx
     e5a:	74 50                	je     eac <printf+0xa0>
     e5c:	83 f9 70             	cmp    $0x70,%ecx
     e5f:	74 4b                	je     eac <printf+0xa0>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
     e61:	83 f9 73             	cmp    $0x73,%ecx
     e64:	74 6a                	je     ed0 <printf+0xc4>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
     ...
     e66:	83 f9 63             	cmp    $0x63,%ecx
     e69:	0f 84 91 00 00 00    	je     f00 <printf+0xf4>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
        putc(fd, c);
     e6f:	ba 25 00 00 00       	mov    $0x25,%edx
     e74:	89 f8                	mov    %edi,%eax
          s++;
        }
      } else if(c == 'c'){
        putc(fd, *ap);
     ...
     e76:	83 f9 25             	cmp    $0x25,%ecx
     e79:	74 10                	je     e8b <printf+0x7f>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
     e7b:	89 4d e0             	mov    %ecx,-0x20(%ebp)
     e7e:	e8 f9 fe ff ff       	call   d7c <putc>
        putc(fd, c);
     e83:	8b 4d e0             	mov    -0x20(%ebp),%ecx
     e86:	0f be d1             	movsbl %cl,%edx
     e89:	89 f8                	mov    %edi,%eax
     e8b:	e8 ec fe ff ff       	call   d7c <putc>
      }
      state = 0;
     e90:	31 f6                	xor    %esi,%esi
      } else if(c == '%'){
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
     e93:	8a 0b                	mov    (%ebx),%cl
     e95:	84 c9                	test   %cl,%cl
     e97:	75 a9                	jne    e42 <printf+0x36>
     e99:	8d 76 00             	lea    0x0(%esi),%esi
        putc(fd, c);
      }
      state = 0;
    }
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
      if(c == '%'){
        state = '%';
     ea4:	be 25 00 00 00       	mov    $0x25,%esi
     ea9:	eb 90                	jmp    e3b <printf+0x2f>
     eab:	90                   	nop
    } else if(state == '%'){
      if(c == 'd'){
        printint(fd, *ap, 10, 1);
     ...
     eb3:	b9 10 00 00 00       	mov    $0x10,%ecx
     eb8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     ebb:	8b 10                	mov    (%eax),%edx
     ebd:	89 f8                	mov    %edi,%eax
     ebf:	e8 dc fe ff ff       	call   da0 <printint>
        ap++;
     ec4:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
     ...
     ec8:	31 f6                	xor    %esi,%esi
      if(c == 'd'){
        ...
        printint(fd, *ap, 16, 0);
        ap++;
     eca:	e9 6c ff ff ff       	jmp    e3b <printf+0x2f>
     ecf:	90                   	nop
      } else if(c == 's'){
        s = (char*)*ap;
     ed0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     ed3:	8b 30                	mov    (%eax),%esi
        ap++;
     ed5:	83 c0 04             	add    $0x4,%eax
     ed8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
     edb:	85 f6                	test   %esi,%esi
     edd:	74 5a                	je     f39 <printf+0x12d>
          s = "(null)";
        while(*s != 0){
     edf:	8a 16                	mov    (%esi),%dl
     ee1:	84 d2                	test   %dl,%dl
     ee3:	74 14                	je     ef9 <printf+0xed>
     ee5:	8d 76 00             	lea    0x0(%esi),%esi
          putc(fd, *s);
     ee8:	0f be d2             	movsbl %dl,%edx
     eeb:	89 f8                	mov    %edi,%eax
     eed:	e8 8a fe ff ff       	call   d7c <putc>
          s++;
     ef2:	46                   	inc    %esi
      } else if(c == 's'){
        s = (char*)*ap;
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
     ef3:	8a 16                	mov    (%esi),%dl
     ef5:	84 d2                	test   %dl,%dl
     ef7:	75 ef                	jne    ee8 <printf+0xdc>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
      ...
      state = 0;
     ef9:	31 f6                	xor    %esi,%esi
     efb:	e9 3b ff ff ff       	jmp    e3b <printf+0x2f>
        while(*s != 0){
          putc(fd, *s);
          s++;
        }
     ...
     f03:	0f be 10             	movsbl (%eax),%edx
     f06:	89 f8                	mov    %edi,%eax
     f08:	e8 6f fe ff ff       	call   d7c <putc>
        ap++;
     f0d:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
      ...
      state = 0;
     f11:	31 f6                	xor    %esi,%esi
     f13:	e9 23 ff ff ff       	jmp    e3b <printf+0x2f>
      } else {
        putc(fd, c);
      }
    } else if(state == '%'){
     ...
     f1f:	b1 0a                	mov    $0xa,%cl
     f21:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     f24:	8b 10                	mov    (%eax),%edx
     f26:	89 f8                	mov    %edi,%eax
     f28:	e8 73 fe ff ff       	call   da0 <printint>
        ap++;
     f2d:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
      ...
      state = 0;
     f31:	66 31 f6             	xor    %si,%si
     f34:	e9 02 ff ff ff       	jmp    e3b <printf+0x2f>
        ap++;
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
          s = "(null)";
     f39:	be 88 11 00 00       	mov    $0x1188,%esi
     f3e:	eb 9f                	jmp    edf <printf+0xd3>
...
free(void *ap)
{
     ...
     f44:	56                   	push   %esi
     f45:	53                   	push   %ebx
     f46:	8b 5d 08             	mov    0x8(%ebp),%ebx
  Header *bp, *p;

  bp = (Header*)ap - 1;
     f49:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     f4c:	a1 04 18 00 00       	mov    0x1804,%eax
     f51:	8d 76 00             	lea    0x0(%esi),%esi
     f54:	8b 10                	mov    (%eax),%edx
     f56:	39 c8                	cmp    %ecx,%eax
     f58:	73 04                	jae    f5e <free+0x1e>
     f5a:	39 d1                	cmp    %edx,%ecx
     f5c:	72 12                	jb     f70 <free+0x30>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
     f5e:	39 d0                	cmp    %edx,%eax
     f60:	72 08                	jb     f6a <free+0x2a>
     f62:	39 c8                	cmp    %ecx,%eax
     f64:	72 0a                	jb     f70 <free+0x30>
     f66:	39 d1                	cmp    %edx,%ecx
     f68:	72 06                	jb     f70 <free+0x30>
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  if(bp + bp->s.size == p->s.ptr){
     ...
     f76:	39 d7                	cmp    %edx,%edi
     f78:	74 19                	je     f93 <free+0x53>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
     f7a:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
     f7d:	8b 50 04             	mov    0x4(%eax),%edx
     f80:	8d 34 d0             	lea    (%eax,%edx,8),%esi
     f83:	39 f1                	cmp    %esi,%ecx
     f85:	74 23                	je     faa <free+0x6a>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
     f87:	89 08                	mov    %ecx,(%eax)
  freep = p;
     f89:	a3 04 18 00 00       	mov    %eax,0x1804
}
     f8e:	5b                   	pop    %ebx
     f8f:	5e                   	pop    %esi
     f90:	5f                   	pop    %edi
  ...
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
     f93:	03 72 04             	add    0x4(%edx),%esi
     f96:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
     f99:	8b 10                	mov    (%eax),%edx
     f9b:	8b 12                	mov    (%edx),%edx
     f9d:	89 53 f8             	mov    %edx,-0x8(%ebx)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
     fa0:	8b 50 04             	mov    0x4(%eax),%edx
     fa3:	8d 34 d0             	lea    (%eax,%edx,8),%esi
     fa6:	39 f1                	cmp    %esi,%ecx
     fa8:	75 dd                	jne    f87 <free+0x47>
    p->s.size += bp->s.size;
     faa:	03 53 fc             	add    -0x4(%ebx),%edx
     fad:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
     fb0:	8b 53 f8             	mov    -0x8(%ebx),%edx
     fb3:	89 10                	mov    %edx,(%eax)
  } else
    p->s.ptr = bp;
  freep = p;
     fb5:	a3 04 18 00 00       	mov    %eax,0x1804
}
     fba:	5b                   	pop    %ebx
     fbb:	5e                   	pop    %esi
     fbc:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
     ...
     fcc:	83 c3 07             	add    $0x7,%ebx
     fcf:	c1 eb 03             	shr    $0x3,%ebx
     fd2:	43                   	inc    %ebx
  if((prevp = freep) == 0){
     fd3:	8b 0d 04 18 00 00    	mov    0x1804,%ecx
     fd9:	85 c9                	test   %ecx,%ecx
     fdb:	0f 84 95 00 00 00    	je     1076 <malloc+0xb6>
     fe1:	8b 01                	mov    (%ecx),%eax
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
     fe6:	39 da                	cmp    %ebx,%edx
     fe8:	73 66                	jae    1050 <malloc+0x90>
        p->s.size -= nunits;
        p += p->s.size;
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
     fea:	8d 3c dd 00 00 00 00 	lea    0x0(,%ebx,8),%edi
     ff1:	eb 0c                	jmp    fff <malloc+0x3f>
     ff3:	90                   	nop
    }
    if(p == freep)
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
     ff6:	8b 01                	mov    (%ecx),%eax
    if(p->s.size >= nunits){
     ff8:	8b 50 04             	mov    0x4(%eax),%edx
     ffb:	39 d3                	cmp    %edx,%ebx
     ffd:	76 51                	jbe    1050 <malloc+0x90>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
     fff:	3b 05 04 18 00 00    	cmp    0x1804,%eax
    1005:	75 ed                	jne    ff4 <malloc+0x34>
morecore(uint nu)
{
  char *p;
  Header *hp;
  ...
  if(nu < 4096)
    1007:	81 fb ff 0f 00 00    	cmp    $0xfff,%ebx
    100d:	76 35                	jbe    1044 <malloc+0x84>
    100f:	89 f8                	mov    %edi,%eax
    1011:	89 de                	mov    %ebx,%esi
    nu = 4096;
  p = sbrk(nu * sizeof(Header));
    1013:	89 04 24             	mov    %eax,(%esp)
    1016:	e8 39 fd ff ff       	call   d54 <sbrk>
  if(p == (char*)-1)
    101b:	83 f8 ff             	cmp    $0xffffffff,%eax
    101e:	74 18                	je     1038 <malloc+0x78>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
    1020:	89 70 04             	mov    %esi,0x4(%eax)
  free((void*)(hp + 1));
    1023:	83 c0 08             	add    $0x8,%eax
    1026:	89 04 24             	mov    %eax,(%esp)
    1029:	e8 12 ff ff ff       	call   f40 <free>
  return freep;
    102e:	8b 0d 04 18 00 00    	mov    0x1804,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
    ...
    1034:	85 c9                	test   %ecx,%ecx
    1036:	75 be                	jne    ff6 <malloc+0x36>
        return 0;
    1038:	31 c0                	xor    %eax,%eax
  }
}
    103a:	83 c4 1c             	add    $0x1c,%esp
    103d:	5b                   	pop    %ebx
    103e:	5e                   	pop    %esi
    103f:	5f                   	pop    %edi
    1040:	5d                   	pop    %ebp
    1041:	c3                   	ret    
    1042:	66 90                	xchg   %ax,%ax
morecore(uint nu)
{
  char *p;
  Header *hp;
  ...
  if(nu < 4096)
    1044:	b8 00 80 00 00       	mov    $0x8000,%eax
    nu = 4096;
    1049:	be 00 10 00 00       	mov    $0x1000,%esi
    104e:	eb c3                	jmp    1013 <malloc+0x53>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
    1050:	39 d3                	cmp    %edx,%ebx
    1052:	74 1c                	je     1070 <malloc+0xb0>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
    1054:	29 da                	sub    %ebx,%edx
    1056:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    1059:	8d 04 d0             	lea    (%eax,%edx,8),%eax
        p->s.size = nunits;
    105c:	89 58 04             	mov    %ebx,0x4(%eax)
      }
      freep = prevp;
    105f:	89 0d 04 18 00 00    	mov    %ecx,0x1804
      return (void*)(p + 1);
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1072:	89 11                	mov    %edx,(%ecx)
    1074:	eb e9                	jmp    105f <malloc+0x9f>
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    1076:	c7 05 04 18 00 00 08 	movl   $0x1808,0x1804
    107d:	18 00 00 
    1080:	c7 05 08 18 00 00 08 	movl   $0x1808,0x1808
    1087:	18 00 00 
    base.s.size = 0;
    108a:	c7 05 0c 18 00 00 00 	movl   $0x0,0x180c
    1091:	00 00 00 
    1094:	b8 08 18 00 00       	mov    $0x1808,%eax
    1099:	e9 4c ff ff ff       	jmp    fea <malloc+0x2a>
