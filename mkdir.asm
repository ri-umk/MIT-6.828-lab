...
main(int argc, char *argv[])
  ...
  25:	e8 72 02 00 00       	call   29c <mkdir>
  ...
  41:	c7 44 24 04 1d 06 00 	movl   $0x61d,0x4(%esp)
  48:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 32c:	f7 f1                	div    %ecx
 32e:	8a 92 40 06 00 00    	mov    0x640(%edx),%dl
 ...
 38c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
{
 ...
 49c:	e9 02 ff ff ff       	jmp    3a3 <printf+0x2f>
        ...
        if(s == 0)
          s = "(null)";
 4a1:	be 39 06 00 00       	mov    $0x639,%esi
...
free(void *ap)
{
 ...
 4b4:	a1 f8 08 00 00       	mov    0x8f8,%eax
...
free(void *ap)
{
 ...
 4ef:	89 08                	mov    %ecx,(%eax)
  freep = p;
 4f1:	a3 f8 08 00 00       	mov    %eax,0x8f8
}
 4f6:	5b                   	pop    %ebx
 4f7:	5e                   	pop    %esi
 4f8:	5f                   	pop    %edi
 ...
 51b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 51d:	a3 f8 08 00 00       	mov    %eax,0x8f8
}
 522:	5b                   	pop    %ebx
 523:	5e                   	pop    %esi
 524:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 53a:	43                   	inc    %ebx
  if((prevp = freep) == 0){
 53b:	8b 0d f8 08 00 00    	mov    0x8f8,%ecx
 ...
 565:	76 51                	jbe    5b8 <malloc+0x90>
    ...
    if(p == freep)
 567:	3b 05 f8 08 00 00    	cmp    0x8f8,%eax
...
morecore(uint nu)
{
 ...
 591:	e8 12 ff ff ff       	call   4a8 <free>
  return freep;
 596:	8b 0d f8 08 00 00    	mov    0x8f8,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
...
morecore(uint nu)
{
 ...
 5c4:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 5c7:	89 0d f8 08 00 00    	mov    %ecx,0x8f8
      return (void*)(p + 1);
 ...
 5dc:	eb e9                	jmp    5c7 <malloc+0x9f>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 5de:	c7 05 f8 08 00 00 fc 	movl   $0x8fc,0x8f8
 5e5:	08 00 00 
 5e8:	c7 05 fc 08 00 00 fc 	movl   $0x8fc,0x8fc
 5ef:	08 00 00 
    base.s.size = 0;
 5f2:	c7 05 00 09 00 00 00 	movl   $0x0,0x900
 5f9:	00 00 00 
 5fc:	b8 fc 08 00 00       	mov    $0x8fc,%eax
