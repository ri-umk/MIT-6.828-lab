...
forktest(void)
{
  ...
  printf(1, "fork test\n");
  43:	c7 44 24 04 70 03 00 	movl   $0x370,0x4(%esp)
  4a:	00 
  ...
  5c:	74 7f                	je     dd <forktest+0xa1>
{
  ...
  printf(1, "fork test OK\n");
  8c:	c7 44 24 04 a2 03 00 	movl   $0x3a2,0x4(%esp)
  93:	00 
  ...
  af:	00 
  b0:	c7 44 24 04 b0 03 00 	movl   $0x3b0,0x4(%esp)
  b7:	00 
  ...
  for(; n > 0; n--){
    if(wait() < 0){
      printf(1, "wait stopped early\n");
  c9:	c7 44 24 04 7b 03 00 	movl   $0x37b,0x4(%esp)
  d0:	00 
  ...
  if(wait() != -1){
    printf(1, "wait got too many\n");
  e2:	c7 44 24 04 8f 03 00 	movl   $0x38f,0x4(%esp)
  e9:	00 
