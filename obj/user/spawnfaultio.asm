...
umain(int argc, char **argv)
{
  ...
  800076:	c7 44 24 08 26 25 80 	movl   $0x802526,0x8(%esp)
  80007d:	00 
  80007e:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  800085:	00 
  800086:	c7 04 24 40 25 80 00 	movl   $0x802540,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800130:	c7 04 24 60 25 80 00 	movl   $0x802560,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002cd:	0f be 80 83 25 80 00 	movsbl 0x802583(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800485:	c7 44 24 08 9b 25 80 	movl   $0x80259b,0x8(%esp)
  80048c:	00 
  ...
  8004dc:	75 05                	jne    8004e3 <vprintfmt+0x185>
				p = "(null)";
  8004de:	be 94 25 80 00       	mov    $0x802594,%esi
			if (width > 0 && padc != '-')
