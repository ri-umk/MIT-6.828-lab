...
umain(int argc, char **argv)
{
  ...
  800037:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  80003a:	c7 05 00 30 80 00 e0 	movl   $0x801ee0,0x803000
  800041:	1e 80 00 
...
sys_env_destroy(envid_t envid)
{
  ...
  800126:	00 
  800127:	c7 44 24 08 ef 1e 80 	movl   $0x801eef,0x8(%esp)
  80012e:	00 
  80012f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800136:	00 
  800137:	c7 04 24 0c 1f 80 00 	movl   $0x801f0c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001b8:	00 
  8001b9:	c7 44 24 08 ef 1e 80 	movl   $0x801eef,0x8(%esp)
  8001c0:	00 
  8001c1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001c8:	00 
  8001c9:	c7 04 24 0c 1f 80 00 	movl   $0x801f0c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80020b:	00 
  80020c:	c7 44 24 08 ef 1e 80 	movl   $0x801eef,0x8(%esp)
  800213:	00 
  800214:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80021b:	00 
  80021c:	c7 04 24 0c 1f 80 00 	movl   $0x801f0c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80025e:	00 
  80025f:	c7 44 24 08 ef 1e 80 	movl   $0x801eef,0x8(%esp)
  800266:	00 
  800267:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80026e:	00 
  80026f:	c7 04 24 0c 1f 80 00 	movl   $0x801f0c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002b1:	00 
  8002b2:	c7 44 24 08 ef 1e 80 	movl   $0x801eef,0x8(%esp)
  8002b9:	00 
  8002ba:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002c1:	00 
  8002c2:	c7 04 24 0c 1f 80 00 	movl   $0x801f0c,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800304:	00 
  800305:	c7 44 24 08 ef 1e 80 	movl   $0x801eef,0x8(%esp)
  80030c:	00 
  80030d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800314:	00 
  800315:	c7 04 24 0c 1f 80 00 	movl   $0x801f0c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800357:	00 
  800358:	c7 44 24 08 ef 1e 80 	movl   $0x801eef,0x8(%esp)
  80035f:	00 
  800360:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800367:	00 
  800368:	c7 04 24 0c 1f 80 00 	movl   $0x801f0c,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  8003cc:	00 
  8003cd:	c7 44 24 08 ef 1e 80 	movl   $0x801eef,0x8(%esp)
  8003d4:	00 
  8003d5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003dc:	00 
  8003dd:	c7 04 24 0c 1f 80 00 	movl   $0x801f0c,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
  8004e9:	42                   	inc    %edx
  8004ea:	8b 04 95 98 1f 80 00 	mov    0x801f98(,%edx,4),%eax
  ...
  800505:	c7 04 24 1c 1f 80 00 	movl   $0x801f1c,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800761:	c7 04 24 5d 1f 80 00 	movl   $0x801f5d,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800837:	c7 04 24 79 1f 80 00 	movl   $0x801f79,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8008ee:	c7 04 24 3c 1f 80 00 	movl   $0x801f3c,(%esp)
...
fsipc(unsigned type, void *dstva)
{
  ...
  800a00:	e8 02 12 00 00       	call   801c07 <ipc_find_env>
  ...
  800a26:	e8 72 11 00 00       	call   801b9d <ipc_send>
  ...
  800a3e:	e8 f1 10 00 00       	call   801b34 <ipc_recv>
}
...
devfile_stat(struct Fd *fd, struct Stat *st)
{
  ...
  800ac9:	e8 41 0d 00 00       	call   80180f <strcpy>
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  800af2:	83 ec 18             	sub    $0x18,%esp
	...
	panic("devfile_write not implemented");
  800af5:	c7 44 24 08 a8 1f 80 	movl   $0x801fa8,0x8(%esp)
  800afc:	00 
  800afd:	c7 44 24 04 90 00 00 	movl   $0x90,0x4(%esp)
  800b04:	00 
  800b05:	c7 04 24 c6 1f 80 00 	movl   $0x801fc6,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800b46:	c7 44 24 0c d1 1f 80 	movl   $0x801fd1,0xc(%esp)
  800b4d:	00 
  800b4e:	c7 44 24 08 d8 1f 80 	movl   $0x801fd8,0x8(%esp)
  800b55:	00 
  800b56:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  800b5d:	00 
  800b5e:	c7 04 24 c6 1f 80 00 	movl   $0x801fc6,(%esp)
  800b65:	e8 02 06 00 00       	call   80116c <_panic>
	assert(r <= PGSIZE);
  800b6a:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800b6f:	7e 24                	jle    800b95 <devfile_read+0x84>
  800b71:	c7 44 24 0c ed 1f 80 	movl   $0x801fed,0xc(%esp)
  800b78:	00 
  800b79:	c7 44 24 08 d8 1f 80 	movl   $0x801fd8,0x8(%esp)
  800b80:	00 
  800b81:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  800b88:	00 
  800b89:	c7 04 24 c6 1f 80 00 	movl   $0x801fc6,(%esp)
  ...
  800ba7:	e8 dc 0d 00 00       	call   801988 <memmove>
	return r;
}
...
open(const char *path, int mode)
{
  ...
  800bc3:	e8 14 0c 00 00       	call   8017dc <strlen>
  ...
  800beb:	e8 1f 0c 00 00       	call   80180f <strcpy>
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800c6c:	c7 44 24 04 f9 1f 80 	movl   $0x801ff9,0x4(%esp)
  800c73:	00 
  800c74:	89 34 24             	mov    %esi,(%esp)
  800c77:	e8 93 0b 00 00       	call   80180f <strcpy>
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800d3f:	c7 04 24 00 20 80 00 	movl   $0x802000,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800fdc:	c7 44 24 04 18 20 80 	movl   $0x802018,0x4(%esp)
  800fe3:	00 
  800fe4:	8b 45 0c             	mov    0xc(%ebp),%eax
  800fe7:	89 04 24             	mov    %eax,(%esp)
  800fea:	e8 20 08 00 00       	call   80180f <strcpy>
	return 0;
}
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80102c:	e8 57 09 00 00       	call   801988 <memmove>
		sys_cputs(buf, m);
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801198:	c7 04 24 24 20 80 00 	movl   $0x802024,(%esp)
  ...
  8011ae:	e8 50 00 00 00       	call   801203 <vcprintf>
	cprintf("\n");
  8011b3:	c7 04 24 11 20 80 00 	movl   $0x802011,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8012d9:	e8 b2 09 00 00       	call   801c90 <__udivdi3>
  ...
  80132c:	e8 7f 0a 00 00       	call   801db0 <__umoddi3>
  801331:	89 7c 24 04          	mov    %edi,0x4(%esp)
  801335:	0f be 80 47 20 80 00 	movsbl 0x802047(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8013d9:	0f 84 6b 03 00 00    	je     80174a <vprintfmt+0x384>
				return;
			putch(ch, putdat);
  ...
  801447:	0f 87 e1 02 00 00    	ja     80172e <vprintfmt+0x368>
  80144d:	0f b6 d2             	movzbl %dl,%edx
  801450:	ff 24 95 80 21 80 00 	jmp    *0x802180(,%edx,4)
  ...
  801510:	c7 44 24 08 ea 1f 80 	movl   $0x801fea,0x8(%esp)
  801517:	00 
  ...
  801544:	75 05                	jne    80154b <vprintfmt+0x185>
				p = "(null)";
  801546:	be 58 20 80 00       	mov    $0x802058,%esi
			if (width > 0 && padc != '-')
  ...
  801562:	e8 8b 02 00 00       	call   8017f2 <strnlen>
...
getint(va_list *ap, int lflag)
{
  ...
  80165f:	e9 8c 00 00 00       	jmp    8016f0 <vprintfmt+0x32a>
  ...
  80167e:	eb 70                	jmp    8016f0 <vprintfmt+0x32a>
			goto number;

		// unsigned decimal
		case 'u':
			num = getuint(&ap, lflag);
  801680:	89 ca                	mov    %ecx,%edx
  801682:	8d 45 14             	lea    0x14(%ebp),%eax
  801685:	e8 c0 fc ff ff       	call   80134a <getuint>
  80168a:	89 c6                	mov    %eax,%esi
  80168c:	89 d7                	mov    %edx,%edi
			base = 10;
  80168e:	b8 0a 00 00 00       	mov    $0xa,%eax
			goto number;
  801693:	eb 5b                	jmp    8016f0 <vprintfmt+0x32a>
  ...
  8016cc:	89 55 14             	mov    %edx,0x14(%ebp)
		...
		case 'p':
			...
			putch('x', putdat);
			num = (unsigned long long)
  8016cf:	8b 30                	mov    (%eax),%esi
  8016d1:	bf 00 00 00 00       	mov    $0x0,%edi
				(uintptr_t) va_arg(ap, void *);
			base = 16;
  8016d6:	b8 10 00 00 00       	mov    $0x10,%eax
			goto number;
  8016db:	eb 13                	jmp    8016f0 <vprintfmt+0x32a>

		// (unsigned) hexadecimal
		case 'x':
			num = getuint(&ap, lflag);
  8016dd:	89 ca                	mov    %ecx,%edx
  8016df:	8d 45 14             	lea    0x14(%ebp),%eax
  8016e2:	e8 63 fc ff ff       	call   80134a <getuint>
  8016e7:	89 c6                	mov    %eax,%esi
  8016e9:	89 d7                	mov    %edx,%edi
			base = 16;
  8016eb:	b8 10 00 00 00       	mov    $0x10,%eax
		number:
			printnum(putch, putdat, num, base, width, padc);
  8016f0:	0f be 55 d8          	movsbl -0x28(%ebp),%edx
  8016f4:	89 54 24 10          	mov    %edx,0x10(%esp)
  8016f8:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8016fb:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8016ff:	89 44 24 08          	mov    %eax,0x8(%esp)
  801703:	89 34 24             	mov    %esi,(%esp)
  801706:	89 7c 24 04          	mov    %edi,0x4(%esp)
  80170a:	89 da                	mov    %ebx,%edx
  80170c:	8b 45 08             	mov    0x8(%ebp),%eax
  80170f:	e8 6c fb ff ff       	call   801280 <printnum>
			break;
  801714:	8b 75 e0             	mov    -0x20(%ebp),%esi
  801717:	e9 cd fc ff ff       	jmp    8013e9 <vprintfmt+0x23>
  ...
  801723:	ff 55 08             	call   *0x8(%ebp)
	...
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
  801726:	8b 75 e0             	mov    -0x20(%ebp),%esi
			break;
		...
		case '%':
			putch(ch, putdat);
			break;
  801729:	e9 bb fc ff ff       	jmp    8013e9 <vprintfmt+0x23>

		// unrecognized escape sequence - just print it literally
		default:
			putch('%', putdat);
  80172e:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801732:	c7 04 24 25 00 00 00 	movl   $0x25,(%esp)
  801739:	ff 55 08             	call   *0x8(%ebp)
			for (fmt--; fmt[-1] != '%'; fmt--)
  80173c:	eb 01                	jmp    80173f <vprintfmt+0x379>
  80173e:	4e                   	dec    %esi
  80173f:	80 7e ff 25          	cmpb   $0x25,-0x1(%esi)
  801743:	75 f9                	jne    80173e <vprintfmt+0x378>
  801745:	e9 9f fc ff ff       	jmp    8013e9 <vprintfmt+0x23>
				/* do nothing */;
			break;
		}
	}
...
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
  ...
  80175e:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801761:	8d 4c 10 ff          	lea    -0x1(%eax,%edx,1),%ecx
  801765:	89 4d f0             	mov    %ecx,-0x10(%ebp)
  801768:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)

	if (buf == NULL || n < 1)
  80176f:	85 c0                	test   %eax,%eax
  801771:	74 30                	je     8017a3 <vsnprintf+0x51>
  801773:	85 d2                	test   %edx,%edx
  801775:	7e 33                	jle    8017aa <vsnprintf+0x58>
		return -E_INVAL;

	// print the string to the buffer
	vprintfmt((void*)sprintputch, &b, fmt, ap);
  801777:	8b 45 14             	mov    0x14(%ebp),%eax
  80177a:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80177e:	8b 45 10             	mov    0x10(%ebp),%eax
  801781:	89 44 24 08          	mov    %eax,0x8(%esp)
  801785:	8d 45 ec             	lea    -0x14(%ebp),%eax
  801788:	89 44 24 04          	mov    %eax,0x4(%esp)
  80178c:	c7 04 24 84 13 80 00 	movl   $0x801384,(%esp)
  801793:	e8 2e fc ff ff       	call   8013c6 <vprintfmt>
  ...
  8017a1:	eb 0c                	jmp    8017af <vsnprintf+0x5d>
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
	struct sprintbuf b = {buf, buf+n-1, 0};
  ...
  8017a8:	eb 05                	jmp    8017af <vsnprintf+0x5d>
...
snprintf(char *buf, int n, const char *fmt, ...)
{
  ...
  8017b4:	83 ec 18             	sub    $0x18,%esp
	...
	va_start(ap, fmt);
  8017b7:	8d 45 14             	lea    0x14(%ebp),%eax
  ...
  8017d2:	e8 7b ff ff ff       	call   801752 <vsnprintf>
	va_end(ap);
...
strlen(const char *s)
{
  ...
  8017e7:	eb 01                	jmp    8017ea <strlen+0xe>
		n++;
  8017e9:	40                   	inc    %eax
int
strlen(const char *s)
{
	...
	for (n = 0; *s != '\0'; s++)
  8017ea:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
  8017ee:	75 f9                	jne    8017e9 <strlen+0xd>
		n++;
	return n;
}
  8017f0:	5d                   	pop    %ebp
  ...
  8017f8:	8b 55 0c             	mov    0xc(%ebp),%edx
{
  ...
  801800:	eb 01                	jmp    801803 <strnlen+0x11>
		n++;
  801802:	40                   	inc    %eax
int
strnlen(const char *s, size_t size)
{
	...
	for (n = 0; size > 0 && *s != '\0'; s++, size--)
  801803:	39 d0                	cmp    %edx,%eax
  801805:	74 06                	je     80180d <strnlen+0x1b>
  801807:	80 3c 01 00          	cmpb   $0x0,(%ecx,%eax,1)
  80180b:	75 f5                	jne    801802 <strnlen+0x10>
		n++;
	return n;
}
  80180d:	5d                   	pop    %ebp
...
strcpy(char *dst, const char *src)
{
  ...
  80181e:	8a 0c 13             	mov    (%ebx,%edx,1),%cl
  801821:	88 0c 10             	mov    %cl,(%eax,%edx,1)
  801824:	42                   	inc    %edx
  801825:	84 c9                	test   %cl,%cl
  801827:	75 f5                	jne    80181e <strcpy+0xf>
		/* do nothing */;
	return ret;
}
  801829:	5b                   	pop    %ebx
...
strncpy(char *dst, const char *src, size_t size) {
  ...
  801862:	8b 75 10             	mov    0x10(%ebp),%esi
	size_t i;
	char *ret;

	ret = dst;
	for (i = 0; i < size; i++) {
  801865:	b9 00 00 00 00       	mov    $0x0,%ecx
  80186a:	eb 0c                	jmp    801878 <strncpy+0x21>
		*dst++ = *src;
  80186c:	8a 1a                	mov    (%edx),%bl
  80186e:	88 1c 08             	mov    %bl,(%eax,%ecx,1)
		// If strlen(src) < size, null-pad 'dst' out to 'size' chars
		if (*src != '\0')
			src++;
  801871:	80 3a 01             	cmpb   $0x1,(%edx)
  801874:	83 da ff             	sbb    $0xffffffff,%edx
strncpy(char *dst, const char *src, size_t size) {
	size_t i;
	char *ret;
	...
	for (i = 0; i < size; i++) {
  801877:	41                   	inc    %ecx
  801878:	39 f1                	cmp    %esi,%ecx
  80187a:	75 f0                	jne    80186c <strncpy+0x15>
		// If strlen(src) < size, null-pad 'dst' out to 'size' chars
		if (*src != '\0')
			src++;
	}
...
strlcpy(char *dst, const char *src, size_t size)
{
  ...
  80188b:	8b 55 10             	mov    0x10(%ebp),%edx
	char *dst_in;

	dst_in = dst;
	if (size > 0) {
  80188e:	85 d2                	test   %edx,%edx
  801890:	75 0a                	jne    80189c <strlcpy+0x1c>
  801892:	89 f0                	mov    %esi,%eax
  801894:	eb 1a                	jmp    8018b0 <strlcpy+0x30>
		while (--size > 0 && *src != '\0')
			*dst++ = *src++;
  801896:	88 18                	mov    %bl,(%eax)
  801898:	40                   	inc    %eax
  801899:	41                   	inc    %ecx
  80189a:	eb 02                	jmp    80189e <strlcpy+0x1e>
strlcpy(char *dst, const char *src, size_t size)
{
	char *dst_in;
  ...
  80189c:	89 f0                	mov    %esi,%eax
		while (--size > 0 && *src != '\0')
  80189e:	4a                   	dec    %edx
  80189f:	74 0a                	je     8018ab <strlcpy+0x2b>
  8018a1:	8a 19                	mov    (%ecx),%bl
  8018a3:	84 db                	test   %bl,%bl
  8018a5:	75 ef                	jne    801896 <strlcpy+0x16>
  8018a7:	89 c2                	mov    %eax,%edx
  8018a9:	eb 02                	jmp    8018ad <strlcpy+0x2d>
  8018ab:	89 c2                	mov    %eax,%edx
			*dst++ = *src++;
		*dst = '\0';
  8018ad:	c6 02 00             	movb   $0x0,(%edx)
	}
	return dst - dst_in;
  8018b0:	29 f0                	sub    %esi,%eax
}
  8018b2:	5b                   	pop    %ebx
  8018b3:	5e                   	pop    %esi
  8018b4:	5d                   	pop    %ebp
...
strcmp(const char *p, const char *q)
{
  ...
  8018bc:	8b 55 0c             	mov    0xc(%ebp),%edx
	while (*p && *p == *q)
  8018bf:	eb 02                	jmp    8018c3 <strcmp+0xd>
		p++, q++;
  8018c1:	41                   	inc    %ecx
  8018c2:	42                   	inc    %edx
}
...
{
	while (*p && *p == *q)
  8018c3:	8a 01                	mov    (%ecx),%al
  8018c5:	84 c0                	test   %al,%al
  8018c7:	74 04                	je     8018cd <strcmp+0x17>
  8018c9:	3a 02                	cmp    (%edx),%al
  8018cb:	74 f4                	je     8018c1 <strcmp+0xb>
		p++, q++;
	return (int) ((unsigned char) *p - (unsigned char) *q);
  8018cd:	0f b6 c0             	movzbl %al,%eax
  8018d0:	0f b6 12             	movzbl (%edx),%edx
  8018d3:	29 d0                	sub    %edx,%eax
}
  8018d5:	5d                   	pop    %ebp
  8018d6:	c3                   	ret    
...
strncmp(const char *p, const char *q, size_t n)
{
  ...
  8018e1:	8b 55 10             	mov    0x10(%ebp),%edx
	while (n > 0 && *p && *p == *q)
  8018e4:	eb 03                	jmp    8018e9 <strncmp+0x12>
		n--, p++, q++;
  8018e6:	4a                   	dec    %edx
  8018e7:	40                   	inc    %eax
  8018e8:	41                   	inc    %ecx
...
strncmp(const char *p, const char *q, size_t n)
{
  ...
  8018eb:	74 14                	je     801901 <strncmp+0x2a>
  8018ed:	8a 18                	mov    (%eax),%bl
  8018ef:	84 db                	test   %bl,%bl
  8018f1:	74 04                	je     8018f7 <strncmp+0x20>
  8018f3:	3a 19                	cmp    (%ecx),%bl
  8018f5:	74 ef                	je     8018e6 <strncmp+0xf>
		n--, p++, q++;
	if (n == 0)
		return 0;
	else
  ...
  8018fa:	0f b6 11             	movzbl (%ecx),%edx
  8018fd:	29 d0                	sub    %edx,%eax
  8018ff:	eb 05                	jmp    801906 <strncmp+0x2f>
strncmp(const char *p, const char *q, size_t n)
{
	while (n > 0 && *p && *p == *q)
		n--, p++, q++;
...
strchr(const char *s, char c)
{
  ...
  80190f:	8a 4d 0c             	mov    0xc(%ebp),%cl
	for (; *s; s++)
  801912:	eb 05                	jmp    801919 <strchr+0x10>
		if (*s == c)
  801914:	38 ca                	cmp    %cl,%dl
  801916:	74 0c                	je     801924 <strchr+0x1b>
// Return a pointer to the first occurrence of 'c' in 's',
// or a null pointer if the string has no 'c'.
char *
strchr(const char *s, char c)
{
	for (; *s; s++)
  801918:	40                   	inc    %eax
  801919:	8a 10                	mov    (%eax),%dl
  80191b:	84 d2                	test   %dl,%dl
  80191d:	75 f5                	jne    801914 <strchr+0xb>
		if (*s == c)
			return (char *) s;
	return 0;
...
strfind(const char *s, char c)
{
  ...
  80192c:	8a 4d 0c             	mov    0xc(%ebp),%cl
	for (; *s; s++)
  80192f:	eb 05                	jmp    801936 <strfind+0x10>
		if (*s == c)
...
strfind(const char *s, char c)
{
  ...
  801938:	84 d2                	test   %dl,%dl
  80193a:	75 f5                	jne    801931 <strfind+0xb>
		if (*s == c)
			break;
	return (char *) s;
}
...
memset(void *v, int c, size_t n)
{
  ...
  80194f:	74 30                	je     801981 <memset+0x43>
		return v;
	if ((int)v%4 == 0 && n%4 == 0) {
  801951:	f7 c7 03 00 00 00    	test   $0x3,%edi
  801957:	75 25                	jne    80197e <memset+0x40>
  801959:	f6 c1 03             	test   $0x3,%cl
  80195c:	75 20                	jne    80197e <memset+0x40>
		c &= 0xFF;
  80195e:	0f b6 d0             	movzbl %al,%edx
		c = (c<<24)|(c<<16)|(c<<8)|c;
  801961:	89 d3                	mov    %edx,%ebx
  801963:	c1 e3 08             	shl    $0x8,%ebx
  801966:	89 d6                	mov    %edx,%esi
  801968:	c1 e6 18             	shl    $0x18,%esi
  80196b:	89 d0                	mov    %edx,%eax
  80196d:	c1 e0 10             	shl    $0x10,%eax
  801970:	09 f0                	or     %esi,%eax
  801972:	09 d0                	or     %edx,%eax
  801974:	09 d8                	or     %ebx,%eax
  ...
  801976:	c1 e9 02             	shr    $0x2,%ecx
	...
	if ((int)v%4 == 0 && n%4 == 0) {
		...
		asm volatile("cld; rep stosl\n"
  801979:	fc                   	cld    
  80197a:	f3 ab                	rep stos %eax,%es:(%edi)
  80197c:	eb 03                	jmp    801981 <memset+0x43>
			:: "D" (v), "a" (c), "c" (n/4)
			: "cc", "memory");
	} else
		asm volatile("cld; rep stosb\n"
  80197e:	fc                   	cld    
  80197f:	f3 aa                	rep stos %al,%es:(%edi)
			:: "D" (v), "a" (c), "c" (n)
			: "cc", "memory");
	return v;
}
...
memmove(void *dst, const void *src, size_t n)
{
  ...
  801990:	8b 75 0c             	mov    0xc(%ebp),%esi
  801993:	8b 4d 10             	mov    0x10(%ebp),%ecx
	...
	d = dst;
	if (s < d && s + n > d) {
  801996:	39 c6                	cmp    %eax,%esi
  801998:	73 34                	jae    8019ce <memmove+0x46>
  80199a:	8d 14 0e             	lea    (%esi,%ecx,1),%edx
  80199d:	39 d0                	cmp    %edx,%eax
  80199f:	73 2d                	jae    8019ce <memmove+0x46>
		s += n;
		d += n;
  8019a1:	8d 3c 08             	lea    (%eax,%ecx,1),%edi
		if ((int)s%4 == 0 && (int)d%4 == 0 && n%4 == 0)
  8019a4:	f6 c2 03             	test   $0x3,%dl
  8019a7:	75 1b                	jne    8019c4 <memmove+0x3c>
  8019a9:	f7 c7 03 00 00 00    	test   $0x3,%edi
  8019af:	75 13                	jne    8019c4 <memmove+0x3c>
  8019b1:	f6 c1 03             	test   $0x3,%cl
  8019b4:	75 0e                	jne    8019c4 <memmove+0x3c>
			asm volatile("std; rep movsl\n"
				:: "D" (d-4), "S" (s-4), "c" (n/4) : "cc", "memory");
  8019b6:	83 ef 04             	sub    $0x4,%edi
  8019b9:	8d 72 fc             	lea    -0x4(%edx),%esi
  8019bc:	c1 e9 02             	shr    $0x2,%ecx
	d = dst;
	if (s < d && s + n > d) {
		s += n;
		d += n;
		if ((int)s%4 == 0 && (int)d%4 == 0 && n%4 == 0)
			asm volatile("std; rep movsl\n"
  8019bf:	fd                   	std    
  8019c0:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  8019c2:	eb 07                	jmp    8019cb <memmove+0x43>
				:: "D" (d-4), "S" (s-4), "c" (n/4) : "cc", "memory");
		else
			asm volatile("std; rep movsb\n"
				:: "D" (d-1), "S" (s-1), "c" (n) : "cc", "memory");
  8019c4:	4f                   	dec    %edi
  8019c5:	8d 72 ff             	lea    -0x1(%edx),%esi
		d += n;
		if ((int)s%4 == 0 && (int)d%4 == 0 && n%4 == 0)
			asm volatile("std; rep movsl\n"
				:: "D" (d-4), "S" (s-4), "c" (n/4) : "cc", "memory");
			...
			asm volatile("std; rep movsb\n"
  8019c8:	fd                   	std    
  8019c9:	f3 a4                	rep movsb %ds:(%esi),%es:(%edi)
				:: "D" (d-1), "S" (s-1), "c" (n) : "cc", "memory");
		// Some versions of GCC rely on DF being clear
		asm volatile("cld" ::: "cc");
  8019cb:	fc                   	cld    
  8019cc:	eb 20                	jmp    8019ee <memmove+0x66>
	} else {
		if ((int)s%4 == 0 && (int)d%4 == 0 && n%4 == 0)
  8019ce:	f7 c6 03 00 00 00    	test   $0x3,%esi
  8019d4:	75 13                	jne    8019e9 <memmove+0x61>
  8019d6:	a8 03                	test   $0x3,%al
  8019d8:	75 0f                	jne    8019e9 <memmove+0x61>
  8019da:	f6 c1 03             	test   $0x3,%cl
  8019dd:	75 0a                	jne    8019e9 <memmove+0x61>
  ...
  8019e7:	eb 05                	jmp    8019ee <memmove+0x66>
				:: "D" (d), "S" (s), "c" (n/4) : "cc", "memory");
		else
...
memcpy(void *dst, const void *src, size_t n)
{
  ...
  8019fb:	89 44 24 08          	mov    %eax,0x8(%esp)
  ...
  801a0c:	e8 77 ff ff ff       	call   801988 <memmove>
}
  801a11:	c9                   	leave  
  801a12:	c3                   	ret    
...
memcmp(const void *v1, const void *v2, size_t n)
{
  ...
  801a27:	eb 16                	jmp    801a3f <memcmp+0x2c>
		if (*s1 != *s2)
  801a29:	8a 04 17             	mov    (%edi,%edx,1),%al
  801a2c:	42                   	inc    %edx
  801a2d:	8a 4c 16 ff          	mov    -0x1(%esi,%edx,1),%cl
  801a31:	38 c8                	cmp    %cl,%al
  801a33:	74 0a                	je     801a3f <memcmp+0x2c>
			return (int) *s1 - (int) *s2;
  801a35:	0f b6 c0             	movzbl %al,%eax
  801a38:	0f b6 c9             	movzbl %cl,%ecx
  801a3b:	29 c8                	sub    %ecx,%eax
  801a3d:	eb 09                	jmp    801a48 <memcmp+0x35>
memcmp(const void *v1, const void *v2, size_t n)
{
	const uint8_t *s1 = (const uint8_t *) v1;
	const uint8_t *s2 = (const uint8_t *) v2;
	...
	while (n-- > 0) {
  801a3f:	39 da                	cmp    %ebx,%edx
  801a41:	75 e6                	jne    801a29 <memcmp+0x16>
		if (*s1 != *s2)
			return (int) *s1 - (int) *s2;
		s1++, s2++;
	}
...
memfind(const void *s, int c, size_t n)
{
  ...
  801a58:	03 55 10             	add    0x10(%ebp),%edx
	for (; s < ends; s++)
  801a5b:	eb 05                	jmp    801a62 <memfind+0x15>
		if (*(const unsigned char *) s == (unsigned char) c)
  801a5d:	38 08                	cmp    %cl,(%eax)
  801a5f:	74 05                	je     801a66 <memfind+0x19>
...
memfind(const void *s, int c, size_t n)
{
	...
	for (; s < ends; s++)
  801a61:	40                   	inc    %eax
  801a62:	39 d0                	cmp    %edx,%eax
  801a64:	72 f7                	jb     801a5d <memfind+0x10>
		if (*(const unsigned char *) s == (unsigned char) c)
			break;
	return (void *) s;
}
...
strtol(const char *s, char **endptr, int base)
{
  ...
  801a71:	8b 5d 10             	mov    0x10(%ebp),%ebx
	...
	while (*s == ' ' || *s == '\t')
  801a74:	eb 01                	jmp    801a77 <strtol+0xf>
		s++;
  801a76:	42                   	inc    %edx
{
	int neg = 0;
	...
	// gobble initial whitespace
	while (*s == ' ' || *s == '\t')
  801a77:	8a 02                	mov    (%edx),%al
  801a79:	3c 20                	cmp    $0x20,%al
  801a7b:	74 f9                	je     801a76 <strtol+0xe>
  801a7d:	3c 09                	cmp    $0x9,%al
  801a7f:	74 f5                	je     801a76 <strtol+0xe>
		s++;

	// plus/minus sign
	if (*s == '+')
  801a81:	3c 2b                	cmp    $0x2b,%al
  801a83:	75 08                	jne    801a8d <strtol+0x25>
		s++;
  801a85:	42                   	inc    %edx
}
...
{
	int neg = 0;
  801a86:	bf 00 00 00 00       	mov    $0x0,%edi
  801a8b:	eb 13                	jmp    801aa0 <strtol+0x38>
		s++;
  ...
  801a8d:	3c 2d                	cmp    $0x2d,%al
  801a8f:	75 0a                	jne    801a9b <strtol+0x33>
		s++, neg = 1;
  801a91:	8d 52 01             	lea    0x1(%edx),%edx
  801a94:	bf 01 00 00 00       	mov    $0x1,%edi
  801a99:	eb 05                	jmp    801aa0 <strtol+0x38>
}
...
strtol(const char *s, char **endptr, int base)
{
  ...
  801aa2:	74 05                	je     801aa9 <strtol+0x41>
  801aa4:	83 fb 10             	cmp    $0x10,%ebx
  801aa7:	75 28                	jne    801ad1 <strtol+0x69>
  801aa9:	8a 02                	mov    (%edx),%al
  801aab:	3c 30                	cmp    $0x30,%al
  801aad:	75 10                	jne    801abf <strtol+0x57>
  801aaf:	80 7a 01 78          	cmpb   $0x78,0x1(%edx)
  801ab3:	75 0a                	jne    801abf <strtol+0x57>
		s += 2, base = 16;
  801ab5:	83 c2 02             	add    $0x2,%edx
  801ab8:	bb 10 00 00 00       	mov    $0x10,%ebx
  801abd:	eb 12                	jmp    801ad1 <strtol+0x69>
	else if (base == 0 && s[0] == '0')
  801abf:	85 db                	test   %ebx,%ebx
  801ac1:	75 0e                	jne    801ad1 <strtol+0x69>
  801ac3:	3c 30                	cmp    $0x30,%al
  801ac5:	75 05                	jne    801acc <strtol+0x64>
		s++, base = 8;
  801ac7:	42                   	inc    %edx
  801ac8:	b3 08                	mov    $0x8,%bl
  801aca:	eb 05                	jmp    801ad1 <strtol+0x69>
	else if (base == 0)
		base = 10;
  801acc:	bb 0a 00 00 00       	mov    $0xa,%ebx
  ...
  801ad6:	89 de                	mov    %ebx,%esi
	...
	while (1) {
		...
		if (*s >= '0' && *s <= '9')
  801ad8:	8a 0a                	mov    (%edx),%cl
  801ada:	8d 59 d0             	lea    -0x30(%ecx),%ebx
  801add:	80 fb 09             	cmp    $0x9,%bl
  801ae0:	77 08                	ja     801aea <strtol+0x82>
			dig = *s - '0';
  801ae2:	0f be c9             	movsbl %cl,%ecx
  801ae5:	83 e9 30             	sub    $0x30,%ecx
  801ae8:	eb 1e                	jmp    801b08 <strtol+0xa0>
		else if (*s >= 'a' && *s <= 'z')
  801aea:	8d 59 9f             	lea    -0x61(%ecx),%ebx
  801aed:	80 fb 19             	cmp    $0x19,%bl
  801af0:	77 08                	ja     801afa <strtol+0x92>
			dig = *s - 'a' + 10;
  801af2:	0f be c9             	movsbl %cl,%ecx
  801af5:	83 e9 57             	sub    $0x57,%ecx
  801af8:	eb 0e                	jmp    801b08 <strtol+0xa0>
		else if (*s >= 'A' && *s <= 'Z')
  801afa:	8d 59 bf             	lea    -0x41(%ecx),%ebx
  801afd:	80 fb 19             	cmp    $0x19,%bl
  801b00:	77 12                	ja     801b14 <strtol+0xac>
			dig = *s - 'A' + 10;
  801b02:	0f be c9             	movsbl %cl,%ecx
  801b05:	83 e9 37             	sub    $0x37,%ecx
		else
			break;
		if (dig >= base)
  801b08:	39 f1                	cmp    %esi,%ecx
  801b0a:	7d 0c                	jge    801b18 <strtol+0xb0>
			break;
		s++, val = (val * base) + dig;
  801b0c:	42                   	inc    %edx
  801b0d:	0f af c6             	imul   %esi,%eax
  801b10:	01 c8                	add    %ecx,%eax
		// we don't properly detect overflow!
	}
  801b12:	eb c4                	jmp    801ad8 <strtol+0x70>
  ...
  801b16:	eb 02                	jmp    801b1a <strtol+0xb2>
			dig = *s - 'A' + 10;
		else
			break;
		if (dig >= base)
  ...
  801b1e:	74 05                	je     801b25 <strtol+0xbd>
		*endptr = (char *) s;
  801b20:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  801b23:	89 13                	mov    %edx,(%ebx)
	return (neg ? -val : val);
  801b25:	85 ff                	test   %edi,%edi
  801b27:	74 04                	je     801b2d <strtol+0xc5>
  801b29:	89 c8                	mov    %ecx,%eax
  801b2b:	f7 d8                	neg    %eax
}
  801b2d:	5b                   	pop    %ebx
  801b2e:	5e                   	pop    %esi
  801b2f:	5f                   	pop    %edi
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801b43:	8b 7d 10             	mov    0x10(%ebp),%edi
	// LAB 4: Your code here.
	if(!pg)
  801b46:	85 db                	test   %ebx,%ebx
  801b48:	75 05                	jne    801b4f <ipc_recv+0x1b>
		pg = (void *)UTOP;
  801b4a:	bb 00 00 c0 ee       	mov    $0xeec00000,%ebx
	if(sys_ipc_recv(pg) < 0){
  801b4f:	89 1c 24             	mov    %ebx,(%esp)
  801b52:	e8 48 e8 ff ff       	call   80039f <sys_ipc_recv>
  801b57:	85 c0                	test   %eax,%eax
  801b59:	79 16                	jns    801b71 <ipc_recv+0x3d>
		*from_env_store = 0;
  801b5b:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		*perm_store = 0;			
  801b61:	c7 07 00 00 00 00    	movl   $0x0,(%edi)
		return sys_ipc_recv(pg);
  801b67:	89 1c 24             	mov    %ebx,(%esp)
  801b6a:	e8 30 e8 ff ff       	call   80039f <sys_ipc_recv>
  801b6f:	eb 24                	jmp    801b95 <ipc_recv+0x61>
	}		
	
	if(from_env_store)
  801b71:	85 f6                	test   %esi,%esi
  801b73:	74 0a                	je     801b7f <ipc_recv+0x4b>
		*from_env_store = thisenv->env_ipc_from;
  801b75:	a1 04 40 80 00       	mov    0x804004,%eax
  801b7a:	8b 40 74             	mov    0x74(%eax),%eax
  801b7d:	89 06                	mov    %eax,(%esi)
	if(perm_store)
  801b7f:	85 ff                	test   %edi,%edi
  801b81:	74 0a                	je     801b8d <ipc_recv+0x59>
		*perm_store = thisenv->env_ipc_perm;
  801b83:	a1 04 40 80 00       	mov    0x804004,%eax
  801b88:	8b 40 78             	mov    0x78(%eax),%eax
  801b8b:	89 07                	mov    %eax,(%edi)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801ba6:	8b 7d 0c             	mov    0xc(%ebp),%edi
  801ba9:	8b 5d 10             	mov    0x10(%ebp),%ebx
  801bac:	8b 75 14             	mov    0x14(%ebp),%esi
	// LAB 4: Your code here.
	if (pg == NULL) {
  801baf:	85 db                	test   %ebx,%ebx
  801bb1:	75 05                	jne    801bb8 <ipc_send+0x1b>
		pg = (void *)-1;
  801bb3:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
	}
	int r;
	while(1) {
		r = sys_ipc_try_send(to_env, val, pg, perm);
  801bb8:	89 74 24 0c          	mov    %esi,0xc(%esp)
  801bbc:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  801bc0:	89 7c 24 04          	mov    %edi,0x4(%esp)
  801bc4:	8b 45 08             	mov    0x8(%ebp),%eax
  801bc7:	89 04 24             	mov    %eax,(%esp)
  801bca:	e8 ad e7 ff ff       	call   80037c <sys_ipc_try_send>
		if (r == 0) {		
  801bcf:	85 c0                	test   %eax,%eax
  801bd1:	74 2c                	je     801bff <ipc_send+0x62>
			return;
		} else if (r == -E_IPC_NOT_RECV) {	
  801bd3:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801bd6:	75 07                	jne    801bdf <ipc_send+0x42>
			sys_yield();
  801bd8:	e8 8d e5 ff ff       	call   80016a <sys_yield>
		} else {			
			panic("ipc_send():%e", r);
		}
	}
  801bdd:	eb d9                	jmp    801bb8 <ipc_send+0x1b>
		if (r == 0) {		
			return;
		} else if (r == -E_IPC_NOT_RECV) {	
			sys_yield();
  ...
  801be3:	c7 44 24 08 40 23 80 	movl   $0x802340,0x8(%esp)
  801bea:	00 
  801beb:	c7 44 24 04 40 00 00 	movl   $0x40,0x4(%esp)
  801bf2:	00 
  801bf3:	c7 04 24 4e 23 80 00 	movl   $0x80234e,(%esp)
  801bfa:	e8 6d f5 ff ff       	call   80116c <_panic>
		}
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801c0a:	53                   	push   %ebx
  801c0b:	8b 5d 08             	mov    0x8(%ebp),%ebx
	int i;
	for (i = 0; i < NENV; i++)
  801c0e:	b8 00 00 00 00       	mov    $0x0,%eax
		if (envs[i].env_type == type)
  801c13:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
  801c1a:	89 c2                	mov    %eax,%edx
  801c1c:	c1 e2 07             	shl    $0x7,%edx
  801c1f:	29 ca                	sub    %ecx,%edx
  801c21:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801c27:	8b 52 50             	mov    0x50(%edx),%edx
  801c2a:	39 da                	cmp    %ebx,%edx
  801c2c:	75 0f                	jne    801c3d <ipc_find_env+0x36>
			return envs[i].env_id;
  801c2e:	c1 e0 07             	shl    $0x7,%eax
  801c31:	29 c8                	sub    %ecx,%eax
  801c33:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  801c38:	8b 40 40             	mov    0x40(%eax),%eax
  801c3b:	eb 0c                	jmp    801c49 <ipc_find_env+0x42>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801c43:	75 ce                	jne    801c13 <ipc_find_env+0xc>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  801c45:	66 b8 00 00          	mov    $0x0,%ax
}
  801c49:	5b                   	pop    %ebx
  801c4a:	5d                   	pop    %ebp
  801c4b:	c3                   	ret    
...
pageref(void *v)
{
  ...
  801c54:	c1 ea 16             	shr    $0x16,%edx
  801c57:	8b 14 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%edx
  801c5e:	f6 c2 01             	test   $0x1,%dl
  801c61:	74 1e                	je     801c81 <pageref+0x35>
		return 0;
	pte = uvpt[PGNUM(v)];
  ...
  801c6f:	74 17                	je     801c88 <pageref+0x3c>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801c71:	c1 e8 0c             	shr    $0xc,%eax
  801c74:	66 8b 04 c5 04 00 00 	mov    -0x10fffffc(,%eax,8),%ax
  801c7b:	ef 
  801c7c:	0f b7 c0             	movzwl %ax,%eax
  801c7f:	eb 0c                	jmp    801c8d <pageref+0x41>
pageref(void *v)
{
	pte_t pte;
  ...
  801c86:	eb 05                	jmp    801c8d <pageref+0x41>
	pte = uvpt[PGNUM(v)];
	if (!(pte & PTE_P))
		return 0;
...
00801c90 <__udivdi3>:
  ...
  801c96:	8b 74 24 20          	mov    0x20(%esp),%esi
  801c9a:	8b 4c 24 28          	mov    0x28(%esp),%ecx
  801c9e:	89 74 24 04          	mov    %esi,0x4(%esp)
  801ca2:	8b 7c 24 24          	mov    0x24(%esp),%edi
  801ca6:	89 cd                	mov    %ecx,%ebp
  801ca8:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801cac:	85 c0                	test   %eax,%eax
  801cae:	75 2c                	jne    801cdc <__udivdi3+0x4c>
  801cb0:	39 f9                	cmp    %edi,%ecx
  801cb2:	77 68                	ja     801d1c <__udivdi3+0x8c>
  801cb4:	85 c9                	test   %ecx,%ecx
  801cb6:	75 0b                	jne    801cc3 <__udivdi3+0x33>
  ...
  801cde:	77 2c                	ja     801d0c <__udivdi3+0x7c>
  801ce0:	0f bd f0             	bsr    %eax,%esi
  801ce3:	83 f6 1f             	xor    $0x1f,%esi
  801ce6:	75 4c                	jne    801d34 <__udivdi3+0xa4>
  801ce8:	39 f8                	cmp    %edi,%eax
  801cea:	bf 00 00 00 00       	mov    $0x0,%edi
  801cef:	72 0a                	jb     801cfb <__udivdi3+0x6b>
  801cf1:	3b 4c 24 04          	cmp    0x4(%esp),%ecx
  801cf5:	0f 87 ad 00 00 00    	ja     801da8 <__udivdi3+0x118>
  ...
  801d38:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801d3c:	b8 20 00 00 00       	mov    $0x20,%eax
  801d41:	29 f0                	sub    %esi,%eax
  801d43:	89 ea                	mov    %ebp,%edx
  801d45:	88 c1                	mov    %al,%cl
  801d47:	d3 ea                	shr    %cl,%edx
  801d49:	8b 4c 24 0c          	mov    0xc(%esp),%ecx
  801d4d:	09 ca                	or     %ecx,%edx
  801d4f:	89 54 24 08          	mov    %edx,0x8(%esp)
  801d53:	89 f1                	mov    %esi,%ecx
  801d55:	d3 e5                	shl    %cl,%ebp
  801d57:	89 6c 24 0c          	mov    %ebp,0xc(%esp)
  ...
  801d67:	8b 7c 24 04          	mov    0x4(%esp),%edi
  801d6b:	88 c1                	mov    %al,%cl
  801d6d:	d3 ef                	shr    %cl,%edi
  801d6f:	09 d7                	or     %edx,%edi
  801d71:	89 f8                	mov    %edi,%eax
  801d73:	89 ea                	mov    %ebp,%edx
...
00801db0 <__umoddi3>:
  ...
  801db6:	8b 44 24 30          	mov    0x30(%esp),%eax
  801dba:	8b 4c 24 38          	mov    0x38(%esp),%ecx
  801dbe:	89 44 24 14          	mov    %eax,0x14(%esp)
  801dc2:	8b 74 24 34          	mov    0x34(%esp),%esi
  801dc6:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  801dca:	8b 6c 24 3c          	mov    0x3c(%esp),%ebp
  801dce:	89 c7                	mov    %eax,%edi
  801dd0:	89 f2                	mov    %esi,%edx
  801dd2:	85 ed                	test   %ebp,%ebp
  801dd4:	75 16                	jne    801dec <__umoddi3+0x3c>
  801dd6:	39 f1                	cmp    %esi,%ecx
  801dd8:	0f 86 a6 00 00 00    	jbe    801e84 <__umoddi3+0xd4>
  801dde:	f7 f1                	div    %ecx
  ...
  801dea:	c3                   	ret    
  801deb:	90                   	nop
  801dec:	39 f5                	cmp    %esi,%ebp
  801dee:	0f 87 ac 00 00 00    	ja     801ea0 <__umoddi3+0xf0>
  801df4:	0f bd c5             	bsr    %ebp,%eax
  801df7:	83 f0 1f             	xor    $0x1f,%eax
  801dfa:	89 44 24 10          	mov    %eax,0x10(%esp)
  801dfe:	0f 84 a8 00 00 00    	je     801eac <__umoddi3+0xfc>
  801e04:	8a 4c 24 10          	mov    0x10(%esp),%cl
  801e08:	d3 e5                	shl    %cl,%ebp
  801e0a:	bf 20 00 00 00       	mov    $0x20,%edi
  801e0f:	2b 7c 24 10          	sub    0x10(%esp),%edi
  801e13:	8b 44 24 0c          	mov    0xc(%esp),%eax
  801e17:	89 f9                	mov    %edi,%ecx
  801e19:	d3 e8                	shr    %cl,%eax
  801e1b:	09 e8                	or     %ebp,%eax
  801e1d:	89 44 24 18          	mov    %eax,0x18(%esp)
  801e21:	8b 44 24 0c          	mov    0xc(%esp),%eax
  801e25:	8a 4c 24 10          	mov    0x10(%esp),%cl
  801e29:	d3 e0                	shl    %cl,%eax
  801e2b:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801e2f:	89 f2                	mov    %esi,%edx
  801e31:	d3 e2                	shl    %cl,%edx
  801e33:	8b 44 24 14          	mov    0x14(%esp),%eax
  801e37:	d3 e0                	shl    %cl,%eax
  801e39:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  801e3d:	8b 44 24 14          	mov    0x14(%esp),%eax
  801e41:	89 f9                	mov    %edi,%ecx
  801e43:	d3 e8                	shr    %cl,%eax
  801e45:	09 d0                	or     %edx,%eax
  801e47:	d3 ee                	shr    %cl,%esi
  801e49:	89 f2                	mov    %esi,%edx
  801e4b:	f7 74 24 18          	divl   0x18(%esp)
  801e4f:	89 d6                	mov    %edx,%esi
  801e51:	f7 64 24 0c          	mull   0xc(%esp)
  801e55:	89 c5                	mov    %eax,%ebp
  801e57:	89 d1                	mov    %edx,%ecx
  801e59:	39 d6                	cmp    %edx,%esi
  801e5b:	72 67                	jb     801ec4 <__umoddi3+0x114>
  801e5d:	74 75                	je     801ed4 <__umoddi3+0x124>
  801e5f:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801e63:	29 e8                	sub    %ebp,%eax
  801e65:	19 ce                	sbb    %ecx,%esi
  801e67:	8a 4c 24 10          	mov    0x10(%esp),%cl
  ...
  801e86:	75 0b                	jne    801e93 <__umoddi3+0xe3>
  801e88:	b8 01 00 00 00       	mov    $0x1,%eax
  801e8d:	31 d2                	xor    %edx,%edx
  801e8f:	f7 f1                	div    %ecx
  801e91:	89 c1                	mov    %eax,%ecx
  801e93:	89 f0                	mov    %esi,%eax
  801e95:	31 d2                	xor    %edx,%edx
  801e97:	f7 f1                	div    %ecx
  801e99:	89 f8                	mov    %edi,%eax
  801e9b:	e9 3e ff ff ff       	jmp    801dde <__umoddi3+0x2e>
  801ea0:	89 f2                	mov    %esi,%edx
  801ea2:	83 c4 20             	add    $0x20,%esp
  801ea5:	5e                   	pop    %esi
  801ea6:	5f                   	pop    %edi
  801ea7:	5d                   	pop    %ebp
  801ea8:	c3                   	ret    
  801ea9:	8d 76 00             	lea    0x0(%esi),%esi
  801eac:	39 f5                	cmp    %esi,%ebp
  801eae:	72 04                	jb     801eb4 <__umoddi3+0x104>
  801eb0:	39 f9                	cmp    %edi,%ecx
  801eb2:	77 06                	ja     801eba <__umoddi3+0x10a>
  801eb4:	89 f2                	mov    %esi,%edx
  801eb6:	29 cf                	sub    %ecx,%edi
  801eb8:	19 ea                	sbb    %ebp,%edx
  ...
  801ec2:	c3                   	ret    
  801ec3:	90                   	nop
  801ec4:	89 d1                	mov    %edx,%ecx
  801ec6:	89 c5                	mov    %eax,%ebp
  801ec8:	2b 6c 24 0c          	sub    0xc(%esp),%ebp
  801ecc:	1b 4c 24 18          	sbb    0x18(%esp),%ecx
  801ed0:	eb 8d                	jmp    801e5f <__umoddi3+0xaf>
  801ed2:	66 90                	xchg   %ax,%ax
  801ed4:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801ed8:	72 ea                	jb     801ec4 <__umoddi3+0x114>
  801eda:	89 f1                	mov    %esi,%ecx
  801edc:	eb 81                	jmp    801e5f <__umoddi3+0xaf>
