...
umain(int argc, char **argv)
{
  ...
  800048:	c7 44 24 04 a0 1f 80 	movl   $0x801fa0,0x4(%esp)
  80004f:	00 
...
umain(int argc, char **argv)
{
  ...
  80008f:	00 
  800090:	c7 44 24 04 a3 1f 80 	movl   $0x801fa3,0x4(%esp)
  800097:	00 
  ...
  8000d8:	00 
  8000d9:	c7 44 24 04 d1 20 80 	movl   $0x8020d1,0x4(%esp)
  8000e0:	00 
...
sys_env_destroy(envid_t envid)
{
  ...
  80052a:	00 
  80052b:	c7 44 24 08 af 1f 80 	movl   $0x801faf,0x8(%esp)
  800532:	00 
  800533:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80053a:	00 
  80053b:	c7 04 24 cc 1f 80 00 	movl   $0x801fcc,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8005bc:	00 
  8005bd:	c7 44 24 08 af 1f 80 	movl   $0x801faf,0x8(%esp)
  8005c4:	00 
  8005c5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8005cc:	00 
  8005cd:	c7 04 24 cc 1f 80 00 	movl   $0x801fcc,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80060f:	00 
  800610:	c7 44 24 08 af 1f 80 	movl   $0x801faf,0x8(%esp)
  800617:	00 
  800618:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80061f:	00 
  800620:	c7 04 24 cc 1f 80 00 	movl   $0x801fcc,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800662:	00 
  800663:	c7 44 24 08 af 1f 80 	movl   $0x801faf,0x8(%esp)
  80066a:	00 
  80066b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800672:	00 
  800673:	c7 04 24 cc 1f 80 00 	movl   $0x801fcc,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8006b5:	00 
  8006b6:	c7 44 24 08 af 1f 80 	movl   $0x801faf,0x8(%esp)
  8006bd:	00 
  8006be:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8006c5:	00 
  8006c6:	c7 04 24 cc 1f 80 00 	movl   $0x801fcc,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800708:	00 
  800709:	c7 44 24 08 af 1f 80 	movl   $0x801faf,0x8(%esp)
  800710:	00 
  800711:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800718:	00 
  800719:	c7 04 24 cc 1f 80 00 	movl   $0x801fcc,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80075b:	00 
  80075c:	c7 44 24 08 af 1f 80 	movl   $0x801faf,0x8(%esp)
  800763:	00 
  800764:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80076b:	00 
  80076c:	c7 04 24 cc 1f 80 00 	movl   $0x801fcc,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  8007d0:	00 
  8007d1:	c7 44 24 08 af 1f 80 	movl   $0x801faf,0x8(%esp)
  8007d8:	00 
  8007d9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8007e0:	00 
  8007e1:	c7 04 24 cc 1f 80 00 	movl   $0x801fcc,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
  8008ed:	42                   	inc    %edx
  8008ee:	8b 04 95 58 20 80 00 	mov    0x802058(,%edx,4),%eax
  ...
  800909:	c7 04 24 dc 1f 80 00 	movl   $0x801fdc,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800b65:	c7 04 24 1d 20 80 00 	movl   $0x80201d,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800c3b:	c7 04 24 39 20 80 00 	movl   $0x802039,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800cf2:	c7 04 24 fc 1f 80 00 	movl   $0x801ffc,(%esp)
...
fsipc(unsigned type, void *dstva)
{
  ...
  800e04:	e8 aa 0e 00 00       	call   801cb3 <ipc_find_env>
  ...
  800e2a:	e8 1a 0e 00 00       	call   801c49 <ipc_send>
  ...
  800e42:	e8 99 0d 00 00       	call   801be0 <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  800ef6:	83 ec 18             	sub    $0x18,%esp
	...
	panic("devfile_write not implemented");
  800ef9:	c7 44 24 08 68 20 80 	movl   $0x802068,0x8(%esp)
  800f00:	00 
  800f01:	c7 44 24 04 90 00 00 	movl   $0x90,0x4(%esp)
  800f08:	00 
  800f09:	c7 04 24 86 20 80 00 	movl   $0x802086,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800f4a:	c7 44 24 0c 91 20 80 	movl   $0x802091,0xc(%esp)
  800f51:	00 
  800f52:	c7 44 24 08 98 20 80 	movl   $0x802098,0x8(%esp)
  800f59:	00 
  800f5a:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  800f61:	00 
  800f62:	c7 04 24 86 20 80 00 	movl   $0x802086,(%esp)
  800f69:	e8 02 06 00 00       	call   801570 <_panic>
	assert(r <= PGSIZE);
  800f6e:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800f73:	7e 24                	jle    800f99 <devfile_read+0x84>
  800f75:	c7 44 24 0c ad 20 80 	movl   $0x8020ad,0xc(%esp)
  800f7c:	00 
  800f7d:	c7 44 24 08 98 20 80 	movl   $0x802098,0x8(%esp)
  800f84:	00 
  800f85:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  800f8c:	00 
  800f8d:	c7 04 24 86 20 80 00 	movl   $0x802086,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801070:	c7 44 24 04 b9 20 80 	movl   $0x8020b9,0x4(%esp)
  801077:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801143:	c7 04 24 c0 20 80 00 	movl   $0x8020c0,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8013e0:	c7 44 24 04 d8 20 80 	movl   $0x8020d8,0x4(%esp)
  8013e7:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80159c:	c7 04 24 e4 20 80 00 	movl   $0x8020e4,(%esp)
  ...
  8015b2:	e8 50 00 00 00       	call   801607 <vcprintf>
	cprintf("\n");
  8015b7:	c7 04 24 d1 20 80 00 	movl   $0x8020d1,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8016dd:	e8 5a 06 00 00       	call   801d3c <__udivdi3>
  ...
  801730:	e8 27 07 00 00       	call   801e5c <__umoddi3>
  801735:	89 7c 24 04          	mov    %edi,0x4(%esp)
  801739:	0f be 80 07 21 80 00 	movsbl 0x802107(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8017dd:	0f 84 6b 03 00 00    	je     801b4e <vprintfmt+0x384>
				return;
			putch(ch, putdat);
  ...
  80184b:	0f 87 e1 02 00 00    	ja     801b32 <vprintfmt+0x368>
  801851:	0f b6 d2             	movzbl %dl,%edx
  801854:	ff 24 95 40 22 80 00 	jmp    *0x802240(,%edx,4)
  ...
  801914:	c7 44 24 08 aa 20 80 	movl   $0x8020aa,0x8(%esp)
  80191b:	00 
  ...
  801948:	75 05                	jne    80194f <vprintfmt+0x185>
				p = "(null)";
  80194a:	be 18 21 80 00       	mov    $0x802118,%esi
			if (width > 0 && padc != '-')
...
getint(va_list *ap, int lflag)
{
  ...
  801a63:	e9 8c 00 00 00       	jmp    801af4 <vprintfmt+0x32a>
  ...
  801a82:	eb 70                	jmp    801af4 <vprintfmt+0x32a>
			goto number;

		// unsigned decimal
		case 'u':
			num = getuint(&ap, lflag);
  801a84:	89 ca                	mov    %ecx,%edx
  801a86:	8d 45 14             	lea    0x14(%ebp),%eax
  801a89:	e8 c0 fc ff ff       	call   80174e <getuint>
  801a8e:	89 c6                	mov    %eax,%esi
  801a90:	89 d7                	mov    %edx,%edi
			base = 10;
  801a92:	b8 0a 00 00 00       	mov    $0xa,%eax
			goto number;
  801a97:	eb 5b                	jmp    801af4 <vprintfmt+0x32a>

		// (unsigned) octal
		case 'o':
			num = getuint(&ap, lflag);
  801a99:	89 ca                	mov    %ecx,%edx
  801a9b:	8d 45 14             	lea    0x14(%ebp),%eax
  801a9e:	e8 ab fc ff ff       	call   80174e <getuint>
  801aa3:	89 c6                	mov    %eax,%esi
  801aa5:	89 d7                	mov    %edx,%edi
			base = 8;
  801aa7:	b8 08 00 00 00       	mov    $0x8,%eax
			goto number;
  801aac:	eb 46                	jmp    801af4 <vprintfmt+0x32a>

		// pointer
		case 'p':
			putch('0', putdat);
  801aae:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801ab2:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
  801ab9:	ff 55 08             	call   *0x8(%ebp)
			putch('x', putdat);
  801abc:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801ac0:	c7 04 24 78 00 00 00 	movl   $0x78,(%esp)
  801ac7:	ff 55 08             	call   *0x8(%ebp)
			num = (unsigned long long)
				(uintptr_t) va_arg(ap, void *);
  801aca:	8b 45 14             	mov    0x14(%ebp),%eax
  801acd:	8d 50 04             	lea    0x4(%eax),%edx
  801ad0:	89 55 14             	mov    %edx,0x14(%ebp)
		...
		case 'p':
			...
			putch('x', putdat);
			num = (unsigned long long)
  801ad3:	8b 30                	mov    (%eax),%esi
  801ad5:	bf 00 00 00 00       	mov    $0x0,%edi
				(uintptr_t) va_arg(ap, void *);
			base = 16;
  801ada:	b8 10 00 00 00       	mov    $0x10,%eax
			goto number;
  801adf:	eb 13                	jmp    801af4 <vprintfmt+0x32a>

		// (unsigned) hexadecimal
		case 'x':
			num = getuint(&ap, lflag);
  801ae1:	89 ca                	mov    %ecx,%edx
  801ae3:	8d 45 14             	lea    0x14(%ebp),%eax
  801ae6:	e8 63 fc ff ff       	call   80174e <getuint>
  ...
  801af4:	0f be 55 d8          	movsbl -0x28(%ebp),%edx
  801af8:	89 54 24 10          	mov    %edx,0x10(%esp)
  801afc:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801aff:	89 54 24 0c          	mov    %edx,0xc(%esp)
  ...
  801b13:	e8 6c fb ff ff       	call   801684 <printnum>
			break;
  801b18:	8b 75 e0             	mov    -0x20(%ebp),%esi
  801b1b:	e9 cd fc ff ff       	jmp    8017ed <vprintfmt+0x23>
  ...
  801b27:	ff 55 08             	call   *0x8(%ebp)
	...
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
  801b2a:	8b 75 e0             	mov    -0x20(%ebp),%esi
			break;
		...
		case '%':
			putch(ch, putdat);
			break;
  801b2d:	e9 bb fc ff ff       	jmp    8017ed <vprintfmt+0x23>

		// unrecognized escape sequence - just print it literally
		default:
			putch('%', putdat);
  801b32:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801b36:	c7 04 24 25 00 00 00 	movl   $0x25,(%esp)
  801b3d:	ff 55 08             	call   *0x8(%ebp)
			for (fmt--; fmt[-1] != '%'; fmt--)
  801b40:	eb 01                	jmp    801b43 <vprintfmt+0x379>
  801b42:	4e                   	dec    %esi
  801b43:	80 7e ff 25          	cmpb   $0x25,-0x1(%esi)
  801b47:	75 f9                	jne    801b42 <vprintfmt+0x378>
  801b49:	e9 9f fc ff ff       	jmp    8017ed <vprintfmt+0x23>
				/* do nothing */;
			break;
		}
	}
}
  801b4e:	83 c4 4c             	add    $0x4c,%esp
  801b51:	5b                   	pop    %ebx
  801b52:	5e                   	pop    %esi
  801b53:	5f                   	pop    %edi
  801b54:	5d                   	pop    %ebp
...
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
  ...
  801b65:	8d 4c 10 ff          	lea    -0x1(%eax,%edx,1),%ecx
  801b69:	89 4d f0             	mov    %ecx,-0x10(%ebp)
  801b6c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)

	if (buf == NULL || n < 1)
  801b73:	85 c0                	test   %eax,%eax
  801b75:	74 30                	je     801ba7 <vsnprintf+0x51>
  801b77:	85 d2                	test   %edx,%edx
  801b79:	7e 33                	jle    801bae <vsnprintf+0x58>
		return -E_INVAL;
  ...
  801b89:	8d 45 ec             	lea    -0x14(%ebp),%eax
  801b8c:	89 44 24 04          	mov    %eax,0x4(%esp)
  801b90:	c7 04 24 88 17 80 00 	movl   $0x801788,(%esp)
  801b97:	e8 2e fc ff ff       	call   8017ca <vprintfmt>
  ...
  801ba5:	eb 0c                	jmp    801bb3 <vsnprintf+0x5d>
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
	struct sprintbuf b = {buf, buf+n-1, 0};
  ...
  801bac:	eb 05                	jmp    801bb3 <vsnprintf+0x5d>
...
snprintf(char *buf, int n, const char *fmt, ...)
{
  ...
  801bd6:	e8 7b ff ff ff       	call   801b56 <vsnprintf>
	va_end(ap);
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801bef:	8b 7d 10             	mov    0x10(%ebp),%edi
	// LAB 4: Your code here.
	if(!pg)
  801bf2:	85 db                	test   %ebx,%ebx
  801bf4:	75 05                	jne    801bfb <ipc_recv+0x1b>
		pg = (void *)UTOP;
  801bf6:	bb 00 00 c0 ee       	mov    $0xeec00000,%ebx
	if(sys_ipc_recv(pg) < 0){
  801bfb:	89 1c 24             	mov    %ebx,(%esp)
  801bfe:	e8 a0 eb ff ff       	call   8007a3 <sys_ipc_recv>
  801c03:	85 c0                	test   %eax,%eax
  801c05:	79 16                	jns    801c1d <ipc_recv+0x3d>
		*from_env_store = 0;
  801c07:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		*perm_store = 0;			
  801c0d:	c7 07 00 00 00 00    	movl   $0x0,(%edi)
		return sys_ipc_recv(pg);
  801c13:	89 1c 24             	mov    %ebx,(%esp)
  801c16:	e8 88 eb ff ff       	call   8007a3 <sys_ipc_recv>
  ...
  801c2f:	a1 04 40 80 00       	mov    0x804004,%eax
  801c34:	8b 40 78             	mov    0x78(%eax),%eax
  801c37:	89 07                	mov    %eax,(%edi)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c52:	8b 7d 0c             	mov    0xc(%ebp),%edi
  801c55:	8b 5d 10             	mov    0x10(%ebp),%ebx
  801c58:	8b 75 14             	mov    0x14(%ebp),%esi
	// LAB 4: Your code here.
	if (pg == NULL) {
  801c5b:	85 db                	test   %ebx,%ebx
  801c5d:	75 05                	jne    801c64 <ipc_send+0x1b>
		pg = (void *)-1;
  801c5f:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
	}
	int r;
	while(1) {
  ...
  801c6c:	89 7c 24 04          	mov    %edi,0x4(%esp)
  801c70:	8b 45 08             	mov    0x8(%ebp),%eax
  801c73:	89 04 24             	mov    %eax,(%esp)
  801c76:	e8 05 eb ff ff       	call   800780 <sys_ipc_try_send>
		if (r == 0) {		
  801c7b:	85 c0                	test   %eax,%eax
  801c7d:	74 2c                	je     801cab <ipc_send+0x62>
			return;
		} else if (r == -E_IPC_NOT_RECV) {	
  801c7f:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801c82:	75 07                	jne    801c8b <ipc_send+0x42>
			sys_yield();
  801c84:	e8 e5 e8 ff ff       	call   80056e <sys_yield>
		} else {			
			panic("ipc_send():%e", r);
		}
	}
  801c89:	eb d9                	jmp    801c64 <ipc_send+0x1b>
		if (r == 0) {		
			return;
		} else if (r == -E_IPC_NOT_RECV) {	
			sys_yield();
  ...
  801c8f:	c7 44 24 08 00 24 80 	movl   $0x802400,0x8(%esp)
  801c96:	00 
  801c97:	c7 44 24 04 40 00 00 	movl   $0x40,0x4(%esp)
  801c9e:	00 
  801c9f:	c7 04 24 0e 24 80 00 	movl   $0x80240e,(%esp)
  801ca6:	e8 c5 f8 ff ff       	call   801570 <_panic>
		}
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801cbf:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
  801cc6:	89 c2                	mov    %eax,%edx
  801cc8:	c1 e2 07             	shl    $0x7,%edx
  801ccb:	29 ca                	sub    %ecx,%edx
  801ccd:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801cd3:	8b 52 50             	mov    0x50(%edx),%edx
  801cd6:	39 da                	cmp    %ebx,%edx
  801cd8:	75 0f                	jne    801ce9 <ipc_find_env+0x36>
			return envs[i].env_id;
  801cda:	c1 e0 07             	shl    $0x7,%eax
  801cdd:	29 c8                	sub    %ecx,%eax
  801cdf:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  801ce4:	8b 40 40             	mov    0x40(%eax),%eax
  801ce7:	eb 0c                	jmp    801cf5 <ipc_find_env+0x42>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801cef:	75 ce                	jne    801cbf <ipc_find_env+0xc>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
pageref(void *v)
{
  ...
  801d00:	c1 ea 16             	shr    $0x16,%edx
  801d03:	8b 14 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%edx
  801d0a:	f6 c2 01             	test   $0x1,%dl
  801d0d:	74 1e                	je     801d2d <pageref+0x35>
		return 0;
	pte = uvpt[PGNUM(v)];
  801d0f:	c1 e8 0c             	shr    $0xc,%eax
  801d12:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	if (!(pte & PTE_P))
  801d19:	a8 01                	test   $0x1,%al
  801d1b:	74 17                	je     801d34 <pageref+0x3c>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801d1d:	c1 e8 0c             	shr    $0xc,%eax
  801d20:	66 8b 04 c5 04 00 00 	mov    -0x10fffffc(,%eax,8),%ax
  801d27:	ef 
  801d28:	0f b7 c0             	movzwl %ax,%eax
  801d2b:	eb 0c                	jmp    801d39 <pageref+0x41>
pageref(void *v)
{
	pte_t pte;
  ...
  801d32:	eb 05                	jmp    801d39 <pageref+0x41>
	pte = uvpt[PGNUM(v)];
	if (!(pte & PTE_P))
		return 0;
...
00801d3c <__udivdi3>:
  ...
  801d42:	8b 74 24 20          	mov    0x20(%esp),%esi
  801d46:	8b 4c 24 28          	mov    0x28(%esp),%ecx
  801d4a:	89 74 24 04          	mov    %esi,0x4(%esp)
  801d4e:	8b 7c 24 24          	mov    0x24(%esp),%edi
  801d52:	89 cd                	mov    %ecx,%ebp
  801d54:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801d58:	85 c0                	test   %eax,%eax
  801d5a:	75 2c                	jne    801d88 <__udivdi3+0x4c>
  801d5c:	39 f9                	cmp    %edi,%ecx
  801d5e:	77 68                	ja     801dc8 <__udivdi3+0x8c>
  801d60:	85 c9                	test   %ecx,%ecx
  801d62:	75 0b                	jne    801d6f <__udivdi3+0x33>
  ...
  801d8a:	77 2c                	ja     801db8 <__udivdi3+0x7c>
  801d8c:	0f bd f0             	bsr    %eax,%esi
  801d8f:	83 f6 1f             	xor    $0x1f,%esi
  801d92:	75 4c                	jne    801de0 <__udivdi3+0xa4>
  801d94:	39 f8                	cmp    %edi,%eax
  801d96:	bf 00 00 00 00       	mov    $0x0,%edi
  801d9b:	72 0a                	jb     801da7 <__udivdi3+0x6b>
  801d9d:	3b 4c 24 04          	cmp    0x4(%esp),%ecx
  801da1:	0f 87 ad 00 00 00    	ja     801e54 <__udivdi3+0x118>
  801da7:	be 01 00 00 00       	mov    $0x1,%esi
  ...
  801ded:	29 f0                	sub    %esi,%eax
  801def:	89 ea                	mov    %ebp,%edx
  801df1:	88 c1                	mov    %al,%cl
  801df3:	d3 ea                	shr    %cl,%edx
  801df5:	8b 4c 24 0c          	mov    0xc(%esp),%ecx
  801df9:	09 ca                	or     %ecx,%edx
  801dfb:	89 54 24 08          	mov    %edx,0x8(%esp)
  801dff:	89 f1                	mov    %esi,%ecx
  801e01:	d3 e5                	shl    %cl,%ebp
  801e03:	89 6c 24 0c          	mov    %ebp,0xc(%esp)
  801e07:	89 fd                	mov    %edi,%ebp
  801e09:	88 c1                	mov    %al,%cl
  801e0b:	d3 ed                	shr    %cl,%ebp
  801e0d:	89 fa                	mov    %edi,%edx
  801e0f:	89 f1                	mov    %esi,%ecx
  801e11:	d3 e2                	shl    %cl,%edx
  801e13:	8b 7c 24 04          	mov    0x4(%esp),%edi
  801e17:	88 c1                	mov    %al,%cl
  801e19:	d3 ef                	shr    %cl,%edi
  801e1b:	09 d7                	or     %edx,%edi
  801e1d:	89 f8                	mov    %edi,%eax
  801e1f:	89 ea                	mov    %ebp,%edx
  801e21:	f7 74 24 08          	divl   0x8(%esp)
  801e25:	89 d1                	mov    %edx,%ecx
  801e27:	89 c7                	mov    %eax,%edi
  801e29:	f7 64 24 0c          	mull   0xc(%esp)
  801e2d:	39 d1                	cmp    %edx,%ecx
  801e2f:	72 17                	jb     801e48 <__udivdi3+0x10c>
  801e31:	74 09                	je     801e3c <__udivdi3+0x100>
  801e33:	89 fe                	mov    %edi,%esi
  801e35:	31 ff                	xor    %edi,%edi
  801e37:	e9 41 ff ff ff       	jmp    801d7d <__udivdi3+0x41>
  801e3c:	8b 54 24 04          	mov    0x4(%esp),%edx
  801e40:	89 f1                	mov    %esi,%ecx
  801e42:	d3 e2                	shl    %cl,%edx
  801e44:	39 c2                	cmp    %eax,%edx
  801e46:	73 eb                	jae    801e33 <__udivdi3+0xf7>
  801e48:	8d 77 ff             	lea    -0x1(%edi),%esi
  801e4b:	31 ff                	xor    %edi,%edi
  801e4d:	e9 2b ff ff ff       	jmp    801d7d <__udivdi3+0x41>
  801e52:	66 90                	xchg   %ax,%ax
  801e54:	31 f6                	xor    %esi,%esi
  801e56:	e9 22 ff ff ff       	jmp    801d7d <__udivdi3+0x41>
	...
...
00801e5c <__umoddi3>:
  ...
  801e66:	8b 4c 24 38          	mov    0x38(%esp),%ecx
  801e6a:	89 44 24 14          	mov    %eax,0x14(%esp)
  801e6e:	8b 74 24 34          	mov    0x34(%esp),%esi
  801e72:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  801e76:	8b 6c 24 3c          	mov    0x3c(%esp),%ebp
  801e7a:	89 c7                	mov    %eax,%edi
  801e7c:	89 f2                	mov    %esi,%edx
  801e7e:	85 ed                	test   %ebp,%ebp
  801e80:	75 16                	jne    801e98 <__umoddi3+0x3c>
  801e82:	39 f1                	cmp    %esi,%ecx
  801e84:	0f 86 a6 00 00 00    	jbe    801f30 <__umoddi3+0xd4>
  801e8a:	f7 f1                	div    %ecx
  801e8c:	89 d0                	mov    %edx,%eax
  801e8e:	31 d2                	xor    %edx,%edx
  801e90:	83 c4 20             	add    $0x20,%esp
  801e93:	5e                   	pop    %esi
  801e94:	5f                   	pop    %edi
  801e95:	5d                   	pop    %ebp
  801e96:	c3                   	ret    
  801e97:	90                   	nop
  801e98:	39 f5                	cmp    %esi,%ebp
  801e9a:	0f 87 ac 00 00 00    	ja     801f4c <__umoddi3+0xf0>
  801ea0:	0f bd c5             	bsr    %ebp,%eax
  801ea3:	83 f0 1f             	xor    $0x1f,%eax
  801ea6:	89 44 24 10          	mov    %eax,0x10(%esp)
  801eaa:	0f 84 a8 00 00 00    	je     801f58 <__umoddi3+0xfc>
  801eb0:	8a 4c 24 10          	mov    0x10(%esp),%cl
  801eb4:	d3 e5                	shl    %cl,%ebp
  801eb6:	bf 20 00 00 00       	mov    $0x20,%edi
  801ebb:	2b 7c 24 10          	sub    0x10(%esp),%edi
  801ebf:	8b 44 24 0c          	mov    0xc(%esp),%eax
  801ec3:	89 f9                	mov    %edi,%ecx
  801ec5:	d3 e8                	shr    %cl,%eax
  801ec7:	09 e8                	or     %ebp,%eax
  801ec9:	89 44 24 18          	mov    %eax,0x18(%esp)
  801ecd:	8b 44 24 0c          	mov    0xc(%esp),%eax
  801ed1:	8a 4c 24 10          	mov    0x10(%esp),%cl
  801ed5:	d3 e0                	shl    %cl,%eax
  801ed7:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801edb:	89 f2                	mov    %esi,%edx
  801edd:	d3 e2                	shl    %cl,%edx
  801edf:	8b 44 24 14          	mov    0x14(%esp),%eax
  801ee3:	d3 e0                	shl    %cl,%eax
  801ee5:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  801ee9:	8b 44 24 14          	mov    0x14(%esp),%eax
  801eed:	89 f9                	mov    %edi,%ecx
  801eef:	d3 e8                	shr    %cl,%eax
  801ef1:	09 d0                	or     %edx,%eax
  801ef3:	d3 ee                	shr    %cl,%esi
  801ef5:	89 f2                	mov    %esi,%edx
  801ef7:	f7 74 24 18          	divl   0x18(%esp)
  801efb:	89 d6                	mov    %edx,%esi
  801efd:	f7 64 24 0c          	mull   0xc(%esp)
  801f01:	89 c5                	mov    %eax,%ebp
  801f03:	89 d1                	mov    %edx,%ecx
  801f05:	39 d6                	cmp    %edx,%esi
  801f07:	72 67                	jb     801f70 <__umoddi3+0x114>
  801f09:	74 75                	je     801f80 <__umoddi3+0x124>
  801f0b:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801f0f:	29 e8                	sub    %ebp,%eax
  ...
  801f23:	8a 4c 24 10          	mov    0x10(%esp),%cl
  ...
  801f32:	75 0b                	jne    801f3f <__umoddi3+0xe3>
  ...
  801f47:	e9 3e ff ff ff       	jmp    801e8a <__umoddi3+0x2e>
  ...
  801f58:	39 f5                	cmp    %esi,%ebp
  801f5a:	72 04                	jb     801f60 <__umoddi3+0x104>
  801f5c:	39 f9                	cmp    %edi,%ecx
  801f5e:	77 06                	ja     801f66 <__umoddi3+0x10a>
  801f60:	89 f2                	mov    %esi,%edx
  801f62:	29 cf                	sub    %ecx,%edi
  801f64:	19 ea                	sbb    %ebp,%edx
  ...
  801f74:	2b 6c 24 0c          	sub    0xc(%esp),%ebp
  801f78:	1b 4c 24 18          	sbb    0x18(%esp),%ecx
  801f7c:	eb 8d                	jmp    801f0b <__umoddi3+0xaf>
  801f7e:	66 90                	xchg   %ax,%ax
  801f80:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801f84:	72 ea                	jb     801f70 <__umoddi3+0x114>
  801f86:	89 f1                	mov    %esi,%ecx
  801f88:	eb 81                	jmp    801f0b <__umoddi3+0xaf>
