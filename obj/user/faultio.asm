...
read_eflags(void)
{
  ...
  80003f:	74 0c                	je     80004d <umain+0x19>
		cprintf("eflags wrong\n");
  800041:	c7 04 24 00 1f 80 00 	movl   $0x801f00,(%esp)
  800048:	e8 27 01 00 00       	call   800174 <cprintf>
}
...
outb(int port, uint8_t data)
{
  ...
  80004d:	ba f6 01 00 00       	mov    $0x1f6,%edx
  800052:	b0 f0                	mov    $0xf0,%al
  800054:	ee                   	out    %al,(%dx)
  ...
  800055:	c7 04 24 0e 1f 80 00 	movl   $0x801f0e,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800245:	0f be 80 32 1f 80 00 	movsbl 0x801f32(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003fd:	c7 44 24 08 4a 1f 80 	movl   $0x801f4a,0x8(%esp)
  800404:	00 
  ...
  800454:	75 05                	jne    80045b <vprintfmt+0x185>
				p = "(null)";
  800456:	be 43 1f 80 00       	mov    $0x801f43,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800aae:	00 
  800aaf:	c7 44 24 08 3f 22 80 	movl   $0x80223f,0x8(%esp)
  800ab6:	00 
  800ab7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800abe:	00 
  800abf:	c7 04 24 5c 22 80 00 	movl   $0x80225c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b40:	00 
  800b41:	c7 44 24 08 3f 22 80 	movl   $0x80223f,0x8(%esp)
  800b48:	00 
  800b49:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b50:	00 
  800b51:	c7 04 24 5c 22 80 00 	movl   $0x80225c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b93:	00 
  800b94:	c7 44 24 08 3f 22 80 	movl   $0x80223f,0x8(%esp)
  800b9b:	00 
  800b9c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ba3:	00 
  800ba4:	c7 04 24 5c 22 80 00 	movl   $0x80225c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800be6:	00 
  800be7:	c7 44 24 08 3f 22 80 	movl   $0x80223f,0x8(%esp)
  800bee:	00 
  800bef:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bf6:	00 
  800bf7:	c7 04 24 5c 22 80 00 	movl   $0x80225c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c39:	00 
  800c3a:	c7 44 24 08 3f 22 80 	movl   $0x80223f,0x8(%esp)
  800c41:	00 
  800c42:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c49:	00 
  800c4a:	c7 04 24 5c 22 80 00 	movl   $0x80225c,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c8c:	00 
  800c8d:	c7 44 24 08 3f 22 80 	movl   $0x80223f,0x8(%esp)
  800c94:	00 
  800c95:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c9c:	00 
  800c9d:	c7 04 24 5c 22 80 00 	movl   $0x80225c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cdf:	00 
  800ce0:	c7 44 24 08 3f 22 80 	movl   $0x80223f,0x8(%esp)
  800ce7:	00 
  800ce8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cef:	00 
  800cf0:	c7 04 24 5c 22 80 00 	movl   $0x80225c,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800d54:	00 
  800d55:	c7 44 24 08 3f 22 80 	movl   $0x80223f,0x8(%esp)
  800d5c:	00 
  800d5d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d64:	00 
  800d65:	c7 04 24 5c 22 80 00 	movl   $0x80225c,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
  800e71:	42                   	inc    %edx
  800e72:	8b 04 95 e8 22 80 00 	mov    0x8022e8(,%edx,4),%eax
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8010e9:	c7 04 24 ad 22 80 00 	movl   $0x8022ad,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8011bf:	c7 04 24 c9 22 80 00 	movl   $0x8022c9,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801276:	c7 04 24 8c 22 80 00 	movl   $0x80228c,(%esp)
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  80147a:	83 ec 18             	sub    $0x18,%esp
	...
	panic("devfile_write not implemented");
  80147d:	c7 44 24 08 f8 22 80 	movl   $0x8022f8,0x8(%esp)
  801484:	00 
  801485:	c7 44 24 04 90 00 00 	movl   $0x90,0x4(%esp)
  80148c:	00 
  80148d:	c7 04 24 16 23 80 00 	movl   $0x802316,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8014ce:	c7 44 24 0c 21 23 80 	movl   $0x802321,0xc(%esp)
  8014d5:	00 
  8014d6:	c7 44 24 08 28 23 80 	movl   $0x802328,0x8(%esp)
  8014dd:	00 
  8014de:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  8014e5:	00 
  8014e6:	c7 04 24 16 23 80 00 	movl   $0x802316,(%esp)
  8014ed:	e8 02 06 00 00       	call   801af4 <_panic>
	assert(r <= PGSIZE);
  8014f2:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8014f7:	7e 24                	jle    80151d <devfile_read+0x84>
  8014f9:	c7 44 24 0c 3d 23 80 	movl   $0x80233d,0xc(%esp)
  801500:	00 
  801501:	c7 44 24 08 28 23 80 	movl   $0x802328,0x8(%esp)
  801508:	00 
  801509:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  801510:	00 
  801511:	c7 04 24 16 23 80 00 	movl   $0x802316,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8015f4:	c7 44 24 04 49 23 80 	movl   $0x802349,0x4(%esp)
  8015fb:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801697:	0f b6 c0             	movzbl %al,%eax
		nn = thisenv->env_runs;
  80169a:	8b 15 04 40 80 00    	mov    0x804004,%edx
  ...
  8016c7:	c7 04 24 50 23 80 00 	movl   $0x802350,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801964:	c7 44 24 04 68 23 80 	movl   $0x802368,0x4(%esp)
  80196b:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801b20:	c7 04 24 74 23 80 00 	movl   $0x802374,(%esp)
  ...
  801b36:	e8 d8 e5 ff ff       	call   800113 <vcprintf>
	cprintf("\n");
  801b3b:	c7 04 24 61 23 80 00 	movl   $0x802361,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801bfb:	c7 44 24 08 98 23 80 	movl   $0x802398,0x8(%esp)
  801c02:	00 
  801c03:	c7 44 24 04 40 00 00 	movl   $0x40,0x4(%esp)
  801c0a:	00 
  801c0b:	c7 04 24 a6 23 80 00 	movl   $0x8023a6,(%esp)
