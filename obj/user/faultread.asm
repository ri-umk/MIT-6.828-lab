	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800235:	0f be 80 28 1f 80 00 	movsbl 0x801f28(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800350:	ff 24 95 60 20 80 00 	jmp    *0x802060(,%edx,4)
  ...
  800410:	c7 44 24 08 1a 23 80 	movl   $0x80231a,0x8(%esp)
  800417:	00 
  ...
  800444:	75 05                	jne    80044b <vprintfmt+0x185>
				p = "(null)";
  800446:	be 39 1f 80 00       	mov    $0x801f39,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800a9e:	00 
  800a9f:	c7 44 24 08 1f 22 80 	movl   $0x80221f,0x8(%esp)
  800aa6:	00 
  800aa7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800aae:	00 
  800aaf:	c7 04 24 3c 22 80 00 	movl   $0x80223c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b30:	00 
  800b31:	c7 44 24 08 1f 22 80 	movl   $0x80221f,0x8(%esp)
  800b38:	00 
  800b39:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b40:	00 
  800b41:	c7 04 24 3c 22 80 00 	movl   $0x80223c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b83:	00 
  800b84:	c7 44 24 08 1f 22 80 	movl   $0x80221f,0x8(%esp)
  800b8b:	00 
  800b8c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b93:	00 
  800b94:	c7 04 24 3c 22 80 00 	movl   $0x80223c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bd6:	00 
  800bd7:	c7 44 24 08 1f 22 80 	movl   $0x80221f,0x8(%esp)
  800bde:	00 
  800bdf:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800be6:	00 
  800be7:	c7 04 24 3c 22 80 00 	movl   $0x80223c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c29:	00 
  800c2a:	c7 44 24 08 1f 22 80 	movl   $0x80221f,0x8(%esp)
  800c31:	00 
  800c32:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c39:	00 
  800c3a:	c7 04 24 3c 22 80 00 	movl   $0x80223c,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c7c:	00 
  800c7d:	c7 44 24 08 1f 22 80 	movl   $0x80221f,0x8(%esp)
  800c84:	00 
  800c85:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c8c:	00 
  800c8d:	c7 04 24 3c 22 80 00 	movl   $0x80223c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ccf:	00 
  800cd0:	c7 44 24 08 1f 22 80 	movl   $0x80221f,0x8(%esp)
  800cd7:	00 
  800cd8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cdf:	00 
  800ce0:	c7 04 24 3c 22 80 00 	movl   $0x80223c,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800d44:	00 
  800d45:	c7 44 24 08 1f 22 80 	movl   $0x80221f,0x8(%esp)
  800d4c:	00 
  800d4d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d54:	00 
  800d55:	c7 04 24 3c 22 80 00 	movl   $0x80223c,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
  800e61:	42                   	inc    %edx
  800e62:	8b 04 95 c8 22 80 00 	mov    0x8022c8(,%edx,4),%eax
  ...
  800e7d:	c7 04 24 4c 22 80 00 	movl   $0x80224c,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8010d9:	c7 04 24 8d 22 80 00 	movl   $0x80228d,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8011af:	c7 04 24 a9 22 80 00 	movl   $0x8022a9,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801266:	c7 04 24 6c 22 80 00 	movl   $0x80226c,(%esp)
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  80146a:	83 ec 18             	sub    $0x18,%esp
	...
	panic("devfile_write not implemented");
  80146d:	c7 44 24 08 d8 22 80 	movl   $0x8022d8,0x8(%esp)
  801474:	00 
  801475:	c7 44 24 04 90 00 00 	movl   $0x90,0x4(%esp)
  80147c:	00 
  80147d:	c7 04 24 f6 22 80 00 	movl   $0x8022f6,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8014be:	c7 44 24 0c 01 23 80 	movl   $0x802301,0xc(%esp)
  8014c5:	00 
  8014c6:	c7 44 24 08 08 23 80 	movl   $0x802308,0x8(%esp)
  8014cd:	00 
  8014ce:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  8014d5:	00 
  8014d6:	c7 04 24 f6 22 80 00 	movl   $0x8022f6,(%esp)
  8014dd:	e8 02 06 00 00       	call   801ae4 <_panic>
	assert(r <= PGSIZE);
  8014e2:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8014e7:	7e 24                	jle    80150d <devfile_read+0x84>
  8014e9:	c7 44 24 0c 1d 23 80 	movl   $0x80231d,0xc(%esp)
  8014f0:	00 
  8014f1:	c7 44 24 08 08 23 80 	movl   $0x802308,0x8(%esp)
  8014f8:	00 
  8014f9:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  801500:	00 
  801501:	c7 04 24 f6 22 80 00 	movl   $0x8022f6,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8015e4:	c7 44 24 04 29 23 80 	movl   $0x802329,0x4(%esp)
  8015eb:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8016b7:	c7 04 24 30 23 80 00 	movl   $0x802330,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801954:	c7 44 24 04 48 23 80 	movl   $0x802348,0x4(%esp)
  80195b:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801b10:	c7 04 24 54 23 80 00 	movl   $0x802354,(%esp)
  ...
  801b26:	e8 d8 e5 ff ff       	call   800103 <vcprintf>
	cprintf("\n");
  801b2b:	c7 04 24 1c 1f 80 00 	movl   $0x801f1c,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801beb:	c7 44 24 08 78 23 80 	movl   $0x802378,0x8(%esp)
  801bf2:	00 
  801bf3:	c7 44 24 04 40 00 00 	movl   $0x40,0x4(%esp)
  801bfa:	00 
  801bfb:	c7 04 24 86 23 80 00 	movl   $0x802386,(%esp)
