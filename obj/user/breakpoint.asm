...
sys_env_destroy(envid_t envid)
{
  ...
  800116:	00 
  800117:	c7 44 24 08 ea 1e 80 	movl   $0x801eea,0x8(%esp)
  80011e:	00 
  80011f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800126:	00 
  800127:	c7 04 24 07 1f 80 00 	movl   $0x801f07,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001a8:	00 
  8001a9:	c7 44 24 08 ea 1e 80 	movl   $0x801eea,0x8(%esp)
  8001b0:	00 
  8001b1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001b8:	00 
  8001b9:	c7 04 24 07 1f 80 00 	movl   $0x801f07,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001fb:	00 
  8001fc:	c7 44 24 08 ea 1e 80 	movl   $0x801eea,0x8(%esp)
  800203:	00 
  800204:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80020b:	00 
  80020c:	c7 04 24 07 1f 80 00 	movl   $0x801f07,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80024e:	00 
  80024f:	c7 44 24 08 ea 1e 80 	movl   $0x801eea,0x8(%esp)
  800256:	00 
  800257:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80025e:	00 
  80025f:	c7 04 24 07 1f 80 00 	movl   $0x801f07,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002a1:	00 
  8002a2:	c7 44 24 08 ea 1e 80 	movl   $0x801eea,0x8(%esp)
  8002a9:	00 
  8002aa:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002b1:	00 
  8002b2:	c7 04 24 07 1f 80 00 	movl   $0x801f07,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002f4:	00 
  8002f5:	c7 44 24 08 ea 1e 80 	movl   $0x801eea,0x8(%esp)
  8002fc:	00 
  8002fd:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800304:	00 
  800305:	c7 04 24 07 1f 80 00 	movl   $0x801f07,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800347:	00 
  800348:	c7 44 24 08 ea 1e 80 	movl   $0x801eea,0x8(%esp)
  80034f:	00 
  800350:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800357:	00 
  800358:	c7 04 24 07 1f 80 00 	movl   $0x801f07,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  8003bc:	00 
  8003bd:	c7 44 24 08 ea 1e 80 	movl   $0x801eea,0x8(%esp)
  8003c4:	00 
  8003c5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003cc:	00 
  8003cd:	c7 04 24 07 1f 80 00 	movl   $0x801f07,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
  8004d9:	42                   	inc    %edx
  8004da:	8b 04 95 94 1f 80 00 	mov    0x801f94(,%edx,4),%eax
  ...
  8004f5:	c7 04 24 18 1f 80 00 	movl   $0x801f18,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800751:	c7 04 24 59 1f 80 00 	movl   $0x801f59,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800827:	c7 04 24 75 1f 80 00 	movl   $0x801f75,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8008de:	c7 04 24 38 1f 80 00 	movl   $0x801f38,(%esp)
...
fsipc(unsigned type, void *dstva)
{
  ...
  8009f0:	e8 02 12 00 00       	call   801bf7 <ipc_find_env>
  ...
  800a16:	e8 72 11 00 00       	call   801b8d <ipc_send>
  ...
  800a2e:	e8 f1 10 00 00       	call   801b24 <ipc_recv>
}
...
devfile_stat(struct Fd *fd, struct Stat *st)
{
  ...
  800ab9:	e8 41 0d 00 00       	call   8017ff <strcpy>
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  800ae2:	83 ec 18             	sub    $0x18,%esp
	...
	panic("devfile_write not implemented");
  800ae5:	c7 44 24 08 a4 1f 80 	movl   $0x801fa4,0x8(%esp)
  800aec:	00 
  800aed:	c7 44 24 04 90 00 00 	movl   $0x90,0x4(%esp)
  800af4:	00 
  800af5:	c7 04 24 c2 1f 80 00 	movl   $0x801fc2,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800b36:	c7 44 24 0c cd 1f 80 	movl   $0x801fcd,0xc(%esp)
  800b3d:	00 
  800b3e:	c7 44 24 08 d4 1f 80 	movl   $0x801fd4,0x8(%esp)
  800b45:	00 
  800b46:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  800b4d:	00 
  800b4e:	c7 04 24 c2 1f 80 00 	movl   $0x801fc2,(%esp)
  800b55:	e8 02 06 00 00       	call   80115c <_panic>
	assert(r <= PGSIZE);
  800b5a:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800b5f:	7e 24                	jle    800b85 <devfile_read+0x84>
  800b61:	c7 44 24 0c e9 1f 80 	movl   $0x801fe9,0xc(%esp)
  800b68:	00 
  800b69:	c7 44 24 08 d4 1f 80 	movl   $0x801fd4,0x8(%esp)
  800b70:	00 
  800b71:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  800b78:	00 
  800b79:	c7 04 24 c2 1f 80 00 	movl   $0x801fc2,(%esp)
  ...
  800b97:	e8 dc 0d 00 00       	call   801978 <memmove>
	return r;
}
...
open(const char *path, int mode)
{
  ...
  800bb3:	e8 14 0c 00 00       	call   8017cc <strlen>
  ...
  800bdb:	e8 1f 0c 00 00       	call   8017ff <strcpy>
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800c5c:	c7 44 24 04 f5 1f 80 	movl   $0x801ff5,0x4(%esp)
  800c63:	00 
  800c64:	89 34 24             	mov    %esi,(%esp)
  800c67:	e8 93 0b 00 00       	call   8017ff <strcpy>
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800d2f:	c7 04 24 fc 1f 80 00 	movl   $0x801ffc,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800fcc:	c7 44 24 04 14 20 80 	movl   $0x802014,0x4(%esp)
  800fd3:	00 
  800fd4:	8b 45 0c             	mov    0xc(%ebp),%eax
  800fd7:	89 04 24             	mov    %eax,(%esp)
  800fda:	e8 20 08 00 00       	call   8017ff <strcpy>
	return 0;
}
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80101c:	e8 57 09 00 00       	call   801978 <memmove>
		sys_cputs(buf, m);
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801188:	c7 04 24 20 20 80 00 	movl   $0x802020,(%esp)
  ...
  80119e:	e8 50 00 00 00       	call   8011f3 <vcprintf>
	cprintf("\n");
  8011a3:	c7 04 24 0d 20 80 00 	movl   $0x80200d,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8012c9:	e8 b2 09 00 00       	call   801c80 <__udivdi3>
  ...
  80131c:	e8 7f 0a 00 00       	call   801da0 <__umoddi3>
  801321:	89 7c 24 04          	mov    %edi,0x4(%esp)
  801325:	0f be 80 43 20 80 00 	movsbl 0x802043(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8013c9:	0f 84 6b 03 00 00    	je     80173a <vprintfmt+0x384>
				return;
			putch(ch, putdat);
  ...
  801437:	0f 87 e1 02 00 00    	ja     80171e <vprintfmt+0x368>
  80143d:	0f b6 d2             	movzbl %dl,%edx
  801440:	ff 24 95 80 21 80 00 	jmp    *0x802180(,%edx,4)
  ...
  801500:	c7 44 24 08 e6 1f 80 	movl   $0x801fe6,0x8(%esp)
  801507:	00 
  ...
  801534:	75 05                	jne    80153b <vprintfmt+0x185>
				p = "(null)";
  801536:	be 54 20 80 00       	mov    $0x802054,%esi
			if (width > 0 && padc != '-')
  ...
  801552:	e8 8b 02 00 00       	call   8017e2 <strnlen>
...
getint(va_list *ap, int lflag)
{
  ...
  80164f:	e9 8c 00 00 00       	jmp    8016e0 <vprintfmt+0x32a>
  ...
  80166e:	eb 70                	jmp    8016e0 <vprintfmt+0x32a>
			goto number;

		// unsigned decimal
		case 'u':
			num = getuint(&ap, lflag);
  801670:	89 ca                	mov    %ecx,%edx
  801672:	8d 45 14             	lea    0x14(%ebp),%eax
  801675:	e8 c0 fc ff ff       	call   80133a <getuint>
  80167a:	89 c6                	mov    %eax,%esi
  80167c:	89 d7                	mov    %edx,%edi
			base = 10;
  80167e:	b8 0a 00 00 00       	mov    $0xa,%eax
			goto number;
  801683:	eb 5b                	jmp    8016e0 <vprintfmt+0x32a>

		// (unsigned) octal
		case 'o':
			num = getuint(&ap, lflag);
  801685:	89 ca                	mov    %ecx,%edx
  801687:	8d 45 14             	lea    0x14(%ebp),%eax
  80168a:	e8 ab fc ff ff       	call   80133a <getuint>
  80168f:	89 c6                	mov    %eax,%esi
  801691:	89 d7                	mov    %edx,%edi
			base = 8;
  801693:	b8 08 00 00 00       	mov    $0x8,%eax
			goto number;
  801698:	eb 46                	jmp    8016e0 <vprintfmt+0x32a>

		// pointer
		case 'p':
			putch('0', putdat);
  80169a:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  80169e:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
  8016a5:	ff 55 08             	call   *0x8(%ebp)
			putch('x', putdat);
  8016a8:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8016ac:	c7 04 24 78 00 00 00 	movl   $0x78,(%esp)
  8016b3:	ff 55 08             	call   *0x8(%ebp)
			num = (unsigned long long)
				(uintptr_t) va_arg(ap, void *);
  8016b6:	8b 45 14             	mov    0x14(%ebp),%eax
  8016b9:	8d 50 04             	lea    0x4(%eax),%edx
  8016bc:	89 55 14             	mov    %edx,0x14(%ebp)
		...
		case 'p':
			...
			putch('x', putdat);
			num = (unsigned long long)
  8016bf:	8b 30                	mov    (%eax),%esi
  8016c1:	bf 00 00 00 00       	mov    $0x0,%edi
				(uintptr_t) va_arg(ap, void *);
			base = 16;
  8016c6:	b8 10 00 00 00       	mov    $0x10,%eax
			goto number;
  8016cb:	eb 13                	jmp    8016e0 <vprintfmt+0x32a>
  ...
  8016d2:	e8 63 fc ff ff       	call   80133a <getuint>
  8016d7:	89 c6                	mov    %eax,%esi
  8016d9:	89 d7                	mov    %edx,%edi
			base = 16;
  8016db:	b8 10 00 00 00       	mov    $0x10,%eax
		number:
			printnum(putch, putdat, num, base, width, padc);
  8016e0:	0f be 55 d8          	movsbl -0x28(%ebp),%edx
  8016e4:	89 54 24 10          	mov    %edx,0x10(%esp)
  8016e8:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8016eb:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8016ef:	89 44 24 08          	mov    %eax,0x8(%esp)
  8016f3:	89 34 24             	mov    %esi,(%esp)
  8016f6:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8016fa:	89 da                	mov    %ebx,%edx
  8016fc:	8b 45 08             	mov    0x8(%ebp),%eax
  8016ff:	e8 6c fb ff ff       	call   801270 <printnum>
			break;
  801704:	8b 75 e0             	mov    -0x20(%ebp),%esi
  801707:	e9 cd fc ff ff       	jmp    8013d9 <vprintfmt+0x23>
  ...
  801713:	ff 55 08             	call   *0x8(%ebp)
	...
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
  801716:	8b 75 e0             	mov    -0x20(%ebp),%esi
			break;
		...
		case '%':
			putch(ch, putdat);
			break;
  801719:	e9 bb fc ff ff       	jmp    8013d9 <vprintfmt+0x23>

		// unrecognized escape sequence - just print it literally
		default:
			putch('%', putdat);
  80171e:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801722:	c7 04 24 25 00 00 00 	movl   $0x25,(%esp)
  801729:	ff 55 08             	call   *0x8(%ebp)
			for (fmt--; fmt[-1] != '%'; fmt--)
  80172c:	eb 01                	jmp    80172f <vprintfmt+0x379>
  80172e:	4e                   	dec    %esi
  80172f:	80 7e ff 25          	cmpb   $0x25,-0x1(%esi)
  801733:	75 f9                	jne    80172e <vprintfmt+0x378>
  801735:	e9 9f fc ff ff       	jmp    8013d9 <vprintfmt+0x23>
				/* do nothing */;
			break;
		}
	}
}
  80173a:	83 c4 4c             	add    $0x4c,%esp
  80173d:	5b                   	pop    %ebx
  80173e:	5e                   	pop    %esi
  80173f:	5f                   	pop    %edi
  801740:	5d                   	pop    %ebp
...
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
  ...
  801761:	74 30                	je     801793 <vsnprintf+0x51>
  801763:	85 d2                	test   %edx,%edx
  801765:	7e 33                	jle    80179a <vsnprintf+0x58>
		return -E_INVAL;

	// print the string to the buffer
	vprintfmt((void*)sprintputch, &b, fmt, ap);
  801767:	8b 45 14             	mov    0x14(%ebp),%eax
  80176a:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80176e:	8b 45 10             	mov    0x10(%ebp),%eax
  801771:	89 44 24 08          	mov    %eax,0x8(%esp)
  801775:	8d 45 ec             	lea    -0x14(%ebp),%eax
  801778:	89 44 24 04          	mov    %eax,0x4(%esp)
  80177c:	c7 04 24 74 13 80 00 	movl   $0x801374,(%esp)
  801783:	e8 2e fc ff ff       	call   8013b6 <vprintfmt>
  ...
  801791:	eb 0c                	jmp    80179f <vsnprintf+0x5d>
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
	struct sprintbuf b = {buf, buf+n-1, 0};
  ...
  801798:	eb 05                	jmp    80179f <vsnprintf+0x5d>
...
snprintf(char *buf, int n, const char *fmt, ...)
{
  ...
  8017c2:	e8 7b ff ff ff       	call   801742 <vsnprintf>
	va_end(ap);
...
strlen(const char *s)
{
  ...
  8017d7:	eb 01                	jmp    8017da <strlen+0xe>
		n++;
  8017d9:	40                   	inc    %eax
int
strlen(const char *s)
{
	...
	for (n = 0; *s != '\0'; s++)
  8017da:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
  8017de:	75 f9                	jne    8017d9 <strlen+0xd>
		n++;
	return n;
}
  8017e0:	5d                   	pop    %ebp
  ...
  8017e8:	8b 55 0c             	mov    0xc(%ebp),%edx
{
  ...
  8017f0:	eb 01                	jmp    8017f3 <strnlen+0x11>
		n++;
  8017f2:	40                   	inc    %eax
int
strnlen(const char *s, size_t size)
{
  ...
  8017f5:	74 06                	je     8017fd <strnlen+0x1b>
  8017f7:	80 3c 01 00          	cmpb   $0x0,(%ecx,%eax,1)
  8017fb:	75 f5                	jne    8017f2 <strnlen+0x10>
		n++;
	return n;
}
  8017fd:	5d                   	pop    %ebp
...
strcpy(char *dst, const char *src)
{
  ...
  80180e:	8a 0c 13             	mov    (%ebx,%edx,1),%cl
  801811:	88 0c 10             	mov    %cl,(%eax,%edx,1)
  801814:	42                   	inc    %edx
  801815:	84 c9                	test   %cl,%cl
  801817:	75 f5                	jne    80180e <strcpy+0xf>
		/* do nothing */;
	return ret;
}
  801819:	5b                   	pop    %ebx
...
strcat(char *dst, const char *src)
{
  ...
  801829:	e8 9e ff ff ff       	call   8017cc <strlen>
	strcpy(dst + len, src);
  80182e:	8b 55 0c             	mov    0xc(%ebp),%edx
  801831:	89 54 24 04          	mov    %edx,0x4(%esp)
  801835:	01 d8                	add    %ebx,%eax
  801837:	89 04 24             	mov    %eax,(%esp)
  80183a:	e8 c0 ff ff ff       	call   8017ff <strcpy>
	return dst;
}
...
strncpy(char *dst, const char *src, size_t size) {
  ...
  80185a:	eb 0c                	jmp    801868 <strncpy+0x21>
		*dst++ = *src;
  80185c:	8a 1a                	mov    (%edx),%bl
  80185e:	88 1c 08             	mov    %bl,(%eax,%ecx,1)
		// If strlen(src) < size, null-pad 'dst' out to 'size' chars
		if (*src != '\0')
			src++;
  801861:	80 3a 01             	cmpb   $0x1,(%edx)
  801864:	83 da ff             	sbb    $0xffffffff,%edx
strncpy(char *dst, const char *src, size_t size) {
	size_t i;
	char *ret;
	...
	for (i = 0; i < size; i++) {
  801867:	41                   	inc    %ecx
  801868:	39 f1                	cmp    %esi,%ecx
  80186a:	75 f0                	jne    80185c <strncpy+0x15>
		// If strlen(src) < size, null-pad 'dst' out to 'size' chars
		if (*src != '\0')
			src++;
	}
...
strlcpy(char *dst, const char *src, size_t size)
{
  ...
  80187b:	8b 55 10             	mov    0x10(%ebp),%edx
	char *dst_in;

	dst_in = dst;
	if (size > 0) {
  80187e:	85 d2                	test   %edx,%edx
  801880:	75 0a                	jne    80188c <strlcpy+0x1c>
  801882:	89 f0                	mov    %esi,%eax
  801884:	eb 1a                	jmp    8018a0 <strlcpy+0x30>
		while (--size > 0 && *src != '\0')
			*dst++ = *src++;
  801886:	88 18                	mov    %bl,(%eax)
  801888:	40                   	inc    %eax
  801889:	41                   	inc    %ecx
  80188a:	eb 02                	jmp    80188e <strlcpy+0x1e>
strlcpy(char *dst, const char *src, size_t size)
{
	char *dst_in;
  ...
  80188c:	89 f0                	mov    %esi,%eax
		while (--size > 0 && *src != '\0')
  80188e:	4a                   	dec    %edx
  80188f:	74 0a                	je     80189b <strlcpy+0x2b>
  801891:	8a 19                	mov    (%ecx),%bl
  801893:	84 db                	test   %bl,%bl
  801895:	75 ef                	jne    801886 <strlcpy+0x16>
  801897:	89 c2                	mov    %eax,%edx
  801899:	eb 02                	jmp    80189d <strlcpy+0x2d>
  80189b:	89 c2                	mov    %eax,%edx
			*dst++ = *src++;
		*dst = '\0';
  80189d:	c6 02 00             	movb   $0x0,(%edx)
	}
	return dst - dst_in;
  8018a0:	29 f0                	sub    %esi,%eax
}
  8018a2:	5b                   	pop    %ebx
  8018a3:	5e                   	pop    %esi
  8018a4:	5d                   	pop    %ebp
...
strcmp(const char *p, const char *q)
{
  ...
  8018ac:	8b 55 0c             	mov    0xc(%ebp),%edx
	while (*p && *p == *q)
  8018af:	eb 02                	jmp    8018b3 <strcmp+0xd>
		p++, q++;
  8018b1:	41                   	inc    %ecx
  8018b2:	42                   	inc    %edx
}
...
{
	while (*p && *p == *q)
  8018b3:	8a 01                	mov    (%ecx),%al
  8018b5:	84 c0                	test   %al,%al
  8018b7:	74 04                	je     8018bd <strcmp+0x17>
  8018b9:	3a 02                	cmp    (%edx),%al
  8018bb:	74 f4                	je     8018b1 <strcmp+0xb>
		p++, q++;
	return (int) ((unsigned char) *p - (unsigned char) *q);
  8018bd:	0f b6 c0             	movzbl %al,%eax
...
strncmp(const char *p, const char *q, size_t n)
{
  ...
  8018ce:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  8018d1:	8b 55 10             	mov    0x10(%ebp),%edx
	while (n > 0 && *p && *p == *q)
  8018d4:	eb 03                	jmp    8018d9 <strncmp+0x12>
		n--, p++, q++;
  8018d6:	4a                   	dec    %edx
  8018d7:	40                   	inc    %eax
  8018d8:	41                   	inc    %ecx
...
strncmp(const char *p, const char *q, size_t n)
{
  ...
  8018db:	74 14                	je     8018f1 <strncmp+0x2a>
  8018dd:	8a 18                	mov    (%eax),%bl
  8018df:	84 db                	test   %bl,%bl
  8018e1:	74 04                	je     8018e7 <strncmp+0x20>
  8018e3:	3a 19                	cmp    (%ecx),%bl
  8018e5:	74 ef                	je     8018d6 <strncmp+0xf>
		n--, p++, q++;
	if (n == 0)
		return 0;
	else
		return (int) ((unsigned char) *p - (unsigned char) *q);
  8018e7:	0f b6 00             	movzbl (%eax),%eax
  8018ea:	0f b6 11             	movzbl (%ecx),%edx
  8018ed:	29 d0                	sub    %edx,%eax
  8018ef:	eb 05                	jmp    8018f6 <strncmp+0x2f>
strncmp(const char *p, const char *q, size_t n)
{
	while (n > 0 && *p && *p == *q)
		n--, p++, q++;
...
strchr(const char *s, char c)
{
  ...
  8018ff:	8a 4d 0c             	mov    0xc(%ebp),%cl
	for (; *s; s++)
  801902:	eb 05                	jmp    801909 <strchr+0x10>
		if (*s == c)
  801904:	38 ca                	cmp    %cl,%dl
  801906:	74 0c                	je     801914 <strchr+0x1b>
// Return a pointer to the first occurrence of 'c' in 's',
// or a null pointer if the string has no 'c'.
char *
strchr(const char *s, char c)
{
  ...
  80190b:	84 d2                	test   %dl,%dl
  80190d:	75 f5                	jne    801904 <strchr+0xb>
		if (*s == c)
			return (char *) s;
	return 0;
...
strfind(const char *s, char c)
{
  ...
  80191c:	8a 4d 0c             	mov    0xc(%ebp),%cl
	for (; *s; s++)
  80191f:	eb 05                	jmp    801926 <strfind+0x10>
		if (*s == c)
  801921:	38 ca                	cmp    %cl,%dl
  801923:	74 07                	je     80192c <strfind+0x16>
// Return a pointer to the first occurrence of 'c' in 's',
// or a pointer to the string-ending null character if the string has no 'c'.
char *
strfind(const char *s, char c)
{
  ...
  80192a:	75 f5                	jne    801921 <strfind+0xb>
		if (*s == c)
			break;
	return (char *) s;
}
...
memset(void *v, int c, size_t n)
{
  ...
  80193f:	74 30                	je     801971 <memset+0x43>
		return v;
	if ((int)v%4 == 0 && n%4 == 0) {
  801941:	f7 c7 03 00 00 00    	test   $0x3,%edi
  801947:	75 25                	jne    80196e <memset+0x40>
  801949:	f6 c1 03             	test   $0x3,%cl
  80194c:	75 20                	jne    80196e <memset+0x40>
		c &= 0xFF;
  80194e:	0f b6 d0             	movzbl %al,%edx
		c = (c<<24)|(c<<16)|(c<<8)|c;
  801951:	89 d3                	mov    %edx,%ebx
  801953:	c1 e3 08             	shl    $0x8,%ebx
  801956:	89 d6                	mov    %edx,%esi
  801958:	c1 e6 18             	shl    $0x18,%esi
  80195b:	89 d0                	mov    %edx,%eax
  80195d:	c1 e0 10             	shl    $0x10,%eax
  801960:	09 f0                	or     %esi,%eax
  801962:	09 d0                	or     %edx,%eax
  801964:	09 d8                	or     %ebx,%eax
		asm volatile("cld; rep stosl\n"
			:: "D" (v), "a" (c), "c" (n/4)
  801966:	c1 e9 02             	shr    $0x2,%ecx
	if (n == 0)
		return v;
	if ((int)v%4 == 0 && n%4 == 0) {
		c &= 0xFF;
  ...
  80196c:	eb 03                	jmp    801971 <memset+0x43>
			:: "D" (v), "a" (c), "c" (n/4)
			: "cc", "memory");
	} else
...
memmove(void *dst, const void *src, size_t n)
{
  ...
  801980:	8b 75 0c             	mov    0xc(%ebp),%esi
  801983:	8b 4d 10             	mov    0x10(%ebp),%ecx
	...
	d = dst;
	if (s < d && s + n > d) {
  801986:	39 c6                	cmp    %eax,%esi
  801988:	73 34                	jae    8019be <memmove+0x46>
  80198a:	8d 14 0e             	lea    (%esi,%ecx,1),%edx
  80198d:	39 d0                	cmp    %edx,%eax
  80198f:	73 2d                	jae    8019be <memmove+0x46>
		s += n;
		d += n;
  801991:	8d 3c 08             	lea    (%eax,%ecx,1),%edi
		if ((int)s%4 == 0 && (int)d%4 == 0 && n%4 == 0)
  801994:	f6 c2 03             	test   $0x3,%dl
  801997:	75 1b                	jne    8019b4 <memmove+0x3c>
  801999:	f7 c7 03 00 00 00    	test   $0x3,%edi
  80199f:	75 13                	jne    8019b4 <memmove+0x3c>
  8019a1:	f6 c1 03             	test   $0x3,%cl
  ...
  8019b2:	eb 07                	jmp    8019bb <memmove+0x43>
				:: "D" (d-4), "S" (s-4), "c" (n/4) : "cc", "memory");
		else
			asm volatile("std; rep movsb\n"
				:: "D" (d-1), "S" (s-1), "c" (n) : "cc", "memory");
  8019b4:	4f                   	dec    %edi
  8019b5:	8d 72 ff             	lea    -0x1(%edx),%esi
		d += n;
		if ((int)s%4 == 0 && (int)d%4 == 0 && n%4 == 0)
			asm volatile("std; rep movsl\n"
				:: "D" (d-4), "S" (s-4), "c" (n/4) : "cc", "memory");
			...
			asm volatile("std; rep movsb\n"
  8019b8:	fd                   	std    
  8019b9:	f3 a4                	rep movsb %ds:(%esi),%es:(%edi)
				:: "D" (d-1), "S" (s-1), "c" (n) : "cc", "memory");
		// Some versions of GCC rely on DF being clear
		asm volatile("cld" ::: "cc");
  8019bb:	fc                   	cld    
  8019bc:	eb 20                	jmp    8019de <memmove+0x66>
	} else {
		if ((int)s%4 == 0 && (int)d%4 == 0 && n%4 == 0)
  8019be:	f7 c6 03 00 00 00    	test   $0x3,%esi
  8019c4:	75 13                	jne    8019d9 <memmove+0x61>
  8019c6:	a8 03                	test   $0x3,%al
  8019c8:	75 0f                	jne    8019d9 <memmove+0x61>
  8019ca:	f6 c1 03             	test   $0x3,%cl
  8019cd:	75 0a                	jne    8019d9 <memmove+0x61>
  ...
  8019d7:	eb 05                	jmp    8019de <memmove+0x66>
				:: "D" (d), "S" (s), "c" (n/4) : "cc", "memory");
		else
...
memcpy(void *dst, const void *src, size_t n)
{
  ...
  8019fc:	e8 77 ff ff ff       	call   801978 <memmove>
}
  801a01:	c9                   	leave  
  801a02:	c3                   	ret    
...
memcmp(const void *v1, const void *v2, size_t n)
{
  ...
  801a17:	eb 16                	jmp    801a2f <memcmp+0x2c>
		if (*s1 != *s2)
  801a19:	8a 04 17             	mov    (%edi,%edx,1),%al
  801a1c:	42                   	inc    %edx
  801a1d:	8a 4c 16 ff          	mov    -0x1(%esi,%edx,1),%cl
  801a21:	38 c8                	cmp    %cl,%al
  801a23:	74 0a                	je     801a2f <memcmp+0x2c>
			return (int) *s1 - (int) *s2;
  801a25:	0f b6 c0             	movzbl %al,%eax
  801a28:	0f b6 c9             	movzbl %cl,%ecx
  801a2b:	29 c8                	sub    %ecx,%eax
  801a2d:	eb 09                	jmp    801a38 <memcmp+0x35>
memcmp(const void *v1, const void *v2, size_t n)
{
	const uint8_t *s1 = (const uint8_t *) v1;
	const uint8_t *s2 = (const uint8_t *) v2;
	...
	while (n-- > 0) {
  801a2f:	39 da                	cmp    %ebx,%edx
  801a31:	75 e6                	jne    801a19 <memcmp+0x16>
		if (*s1 != *s2)
			return (int) *s1 - (int) *s2;
		s1++, s2++;
	}
...
memfind(const void *s, int c, size_t n)
{
  ...
  801a48:	03 55 10             	add    0x10(%ebp),%edx
	for (; s < ends; s++)
  801a4b:	eb 05                	jmp    801a52 <memfind+0x15>
		if (*(const unsigned char *) s == (unsigned char) c)
  801a4d:	38 08                	cmp    %cl,(%eax)
  801a4f:	74 05                	je     801a56 <memfind+0x19>
...
memfind(const void *s, int c, size_t n)
{
  ...
  801a54:	72 f7                	jb     801a4d <memfind+0x10>
		if (*(const unsigned char *) s == (unsigned char) c)
			break;
	return (void *) s;
}
...
strtol(const char *s, char **endptr, int base)
{
  ...
  801a61:	8b 5d 10             	mov    0x10(%ebp),%ebx
	...
	while (*s == ' ' || *s == '\t')
  801a64:	eb 01                	jmp    801a67 <strtol+0xf>
		s++;
  801a66:	42                   	inc    %edx
{
	int neg = 0;
	...
	// gobble initial whitespace
	while (*s == ' ' || *s == '\t')
  801a67:	8a 02                	mov    (%edx),%al
  801a69:	3c 20                	cmp    $0x20,%al
  801a6b:	74 f9                	je     801a66 <strtol+0xe>
  801a6d:	3c 09                	cmp    $0x9,%al
  801a6f:	74 f5                	je     801a66 <strtol+0xe>
		s++;

	// plus/minus sign
	if (*s == '+')
  801a71:	3c 2b                	cmp    $0x2b,%al
  801a73:	75 08                	jne    801a7d <strtol+0x25>
		s++;
  801a75:	42                   	inc    %edx
}
...
strtol(const char *s, char **endptr, int base)
{
  ...
  801a7b:	eb 13                	jmp    801a90 <strtol+0x38>
		s++;
  ...
  801a7d:	3c 2d                	cmp    $0x2d,%al
  801a7f:	75 0a                	jne    801a8b <strtol+0x33>
		s++, neg = 1;
  801a81:	8d 52 01             	lea    0x1(%edx),%edx
  801a84:	bf 01 00 00 00       	mov    $0x1,%edi
  801a89:	eb 05                	jmp    801a90 <strtol+0x38>
}
...
strtol(const char *s, char **endptr, int base)
{
  ...
  801a92:	74 05                	je     801a99 <strtol+0x41>
  801a94:	83 fb 10             	cmp    $0x10,%ebx
  801a97:	75 28                	jne    801ac1 <strtol+0x69>
  801a99:	8a 02                	mov    (%edx),%al
  801a9b:	3c 30                	cmp    $0x30,%al
  801a9d:	75 10                	jne    801aaf <strtol+0x57>
  801a9f:	80 7a 01 78          	cmpb   $0x78,0x1(%edx)
  801aa3:	75 0a                	jne    801aaf <strtol+0x57>
		s += 2, base = 16;
  801aa5:	83 c2 02             	add    $0x2,%edx
  801aa8:	bb 10 00 00 00       	mov    $0x10,%ebx
  801aad:	eb 12                	jmp    801ac1 <strtol+0x69>
	else if (base == 0 && s[0] == '0')
  801aaf:	85 db                	test   %ebx,%ebx
  801ab1:	75 0e                	jne    801ac1 <strtol+0x69>
  801ab3:	3c 30                	cmp    $0x30,%al
  801ab5:	75 05                	jne    801abc <strtol+0x64>
		s++, base = 8;
  801ab7:	42                   	inc    %edx
  801ab8:	b3 08                	mov    $0x8,%bl
  801aba:	eb 05                	jmp    801ac1 <strtol+0x69>
	else if (base == 0)
		base = 10;
  801abc:	bb 0a 00 00 00       	mov    $0xa,%ebx
  ...
  801ac6:	89 de                	mov    %ebx,%esi
	...
	while (1) {
		...
		if (*s >= '0' && *s <= '9')
  801ac8:	8a 0a                	mov    (%edx),%cl
  801aca:	8d 59 d0             	lea    -0x30(%ecx),%ebx
  801acd:	80 fb 09             	cmp    $0x9,%bl
  801ad0:	77 08                	ja     801ada <strtol+0x82>
			dig = *s - '0';
  801ad2:	0f be c9             	movsbl %cl,%ecx
  801ad5:	83 e9 30             	sub    $0x30,%ecx
  801ad8:	eb 1e                	jmp    801af8 <strtol+0xa0>
		else if (*s >= 'a' && *s <= 'z')
  801ada:	8d 59 9f             	lea    -0x61(%ecx),%ebx
  801add:	80 fb 19             	cmp    $0x19,%bl
  801ae0:	77 08                	ja     801aea <strtol+0x92>
			dig = *s - 'a' + 10;
  801ae2:	0f be c9             	movsbl %cl,%ecx
  801ae5:	83 e9 57             	sub    $0x57,%ecx
  801ae8:	eb 0e                	jmp    801af8 <strtol+0xa0>
		else if (*s >= 'A' && *s <= 'Z')
  801aea:	8d 59 bf             	lea    -0x41(%ecx),%ebx
  801aed:	80 fb 19             	cmp    $0x19,%bl
  801af0:	77 12                	ja     801b04 <strtol+0xac>
			dig = *s - 'A' + 10;
  801af2:	0f be c9             	movsbl %cl,%ecx
  801af5:	83 e9 37             	sub    $0x37,%ecx
		else
			break;
		if (dig >= base)
  801af8:	39 f1                	cmp    %esi,%ecx
  801afa:	7d 0c                	jge    801b08 <strtol+0xb0>
			break;
		s++, val = (val * base) + dig;
  801afc:	42                   	inc    %edx
  801afd:	0f af c6             	imul   %esi,%eax
  801b00:	01 c8                	add    %ecx,%eax
		// we don't properly detect overflow!
	}
  801b02:	eb c4                	jmp    801ac8 <strtol+0x70>
  ...
  801b04:	89 c1                	mov    %eax,%ecx
  801b06:	eb 02                	jmp    801b0a <strtol+0xb2>
			dig = *s - 'A' + 10;
		else
			break;
		if (dig >= base)
  801b08:	89 c1                	mov    %eax,%ecx
	...
	if (endptr)
  801b0a:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
  801b0e:	74 05                	je     801b15 <strtol+0xbd>
		*endptr = (char *) s;
  801b10:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  801b13:	89 13                	mov    %edx,(%ebx)
	return (neg ? -val : val);
  801b15:	85 ff                	test   %edi,%edi
  801b17:	74 04                	je     801b1d <strtol+0xc5>
  801b19:	89 c8                	mov    %ecx,%eax
  801b1b:	f7 d8                	neg    %eax
}
  801b1d:	5b                   	pop    %ebx
  801b1e:	5e                   	pop    %esi
  801b1f:	5f                   	pop    %edi
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801b33:	8b 7d 10             	mov    0x10(%ebp),%edi
	// LAB 4: Your code here.
	if(!pg)
  801b36:	85 db                	test   %ebx,%ebx
  801b38:	75 05                	jne    801b3f <ipc_recv+0x1b>
		pg = (void *)UTOP;
  801b3a:	bb 00 00 c0 ee       	mov    $0xeec00000,%ebx
	if(sys_ipc_recv(pg) < 0){
  801b3f:	89 1c 24             	mov    %ebx,(%esp)
  801b42:	e8 48 e8 ff ff       	call   80038f <sys_ipc_recv>
  801b47:	85 c0                	test   %eax,%eax
  801b49:	79 16                	jns    801b61 <ipc_recv+0x3d>
		*from_env_store = 0;
  801b4b:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		*perm_store = 0;			
  801b51:	c7 07 00 00 00 00    	movl   $0x0,(%edi)
		return sys_ipc_recv(pg);
  801b57:	89 1c 24             	mov    %ebx,(%esp)
  801b5a:	e8 30 e8 ff ff       	call   80038f <sys_ipc_recv>
  801b5f:	eb 24                	jmp    801b85 <ipc_recv+0x61>
	}		
	
	if(from_env_store)
  801b61:	85 f6                	test   %esi,%esi
  801b63:	74 0a                	je     801b6f <ipc_recv+0x4b>
		*from_env_store = thisenv->env_ipc_from;
  801b65:	a1 04 40 80 00       	mov    0x804004,%eax
  801b6a:	8b 40 74             	mov    0x74(%eax),%eax
  801b6d:	89 06                	mov    %eax,(%esi)
	if(perm_store)
  801b6f:	85 ff                	test   %edi,%edi
  801b71:	74 0a                	je     801b7d <ipc_recv+0x59>
		*perm_store = thisenv->env_ipc_perm;
  801b73:	a1 04 40 80 00       	mov    0x804004,%eax
  801b78:	8b 40 78             	mov    0x78(%eax),%eax
  801b7b:	89 07                	mov    %eax,(%edi)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801b96:	8b 7d 0c             	mov    0xc(%ebp),%edi
  801b99:	8b 5d 10             	mov    0x10(%ebp),%ebx
  801b9c:	8b 75 14             	mov    0x14(%ebp),%esi
	// LAB 4: Your code here.
	if (pg == NULL) {
  801b9f:	85 db                	test   %ebx,%ebx
  801ba1:	75 05                	jne    801ba8 <ipc_send+0x1b>
		pg = (void *)-1;
  801ba3:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
	}
	int r;
	while(1) {
  ...
  801bb0:	89 7c 24 04          	mov    %edi,0x4(%esp)
  801bb4:	8b 45 08             	mov    0x8(%ebp),%eax
  801bb7:	89 04 24             	mov    %eax,(%esp)
  801bba:	e8 ad e7 ff ff       	call   80036c <sys_ipc_try_send>
		if (r == 0) {		
  801bbf:	85 c0                	test   %eax,%eax
  801bc1:	74 2c                	je     801bef <ipc_send+0x62>
			return;
		} else if (r == -E_IPC_NOT_RECV) {	
  801bc3:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801bc6:	75 07                	jne    801bcf <ipc_send+0x42>
			sys_yield();
  801bc8:	e8 8d e5 ff ff       	call   80015a <sys_yield>
		} else {			
			panic("ipc_send():%e", r);
		}
	}
  801bcd:	eb d9                	jmp    801ba8 <ipc_send+0x1b>
		if (r == 0) {		
			return;
		} else if (r == -E_IPC_NOT_RECV) {	
			sys_yield();
  ...
  801bd3:	c7 44 24 08 40 23 80 	movl   $0x802340,0x8(%esp)
  801bda:	00 
  801bdb:	c7 44 24 04 40 00 00 	movl   $0x40,0x4(%esp)
  801be2:	00 
  801be3:	c7 04 24 4e 23 80 00 	movl   $0x80234e,(%esp)
  801bea:	e8 6d f5 ff ff       	call   80115c <_panic>
		}
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801bfa:	53                   	push   %ebx
  801bfb:	8b 5d 08             	mov    0x8(%ebp),%ebx
	int i;
	for (i = 0; i < NENV; i++)
  801bfe:	b8 00 00 00 00       	mov    $0x0,%eax
		if (envs[i].env_type == type)
  801c03:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
  801c0a:	89 c2                	mov    %eax,%edx
  801c0c:	c1 e2 07             	shl    $0x7,%edx
  801c0f:	29 ca                	sub    %ecx,%edx
  801c11:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801c17:	8b 52 50             	mov    0x50(%edx),%edx
  801c1a:	39 da                	cmp    %ebx,%edx
  801c1c:	75 0f                	jne    801c2d <ipc_find_env+0x36>
			return envs[i].env_id;
  801c1e:	c1 e0 07             	shl    $0x7,%eax
  801c21:	29 c8                	sub    %ecx,%eax
  801c23:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  801c28:	8b 40 40             	mov    0x40(%eax),%eax
  801c2b:	eb 0c                	jmp    801c39 <ipc_find_env+0x42>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801c33:	75 ce                	jne    801c03 <ipc_find_env+0xc>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  801c35:	66 b8 00 00          	mov    $0x0,%ax
}
  801c39:	5b                   	pop    %ebx
  801c3a:	5d                   	pop    %ebp
  801c3b:	c3                   	ret    
...
00801c80 <__udivdi3>:
  ...
  801c86:	8b 74 24 20          	mov    0x20(%esp),%esi
  801c8a:	8b 4c 24 28          	mov    0x28(%esp),%ecx
  801c8e:	89 74 24 04          	mov    %esi,0x4(%esp)
  801c92:	8b 7c 24 24          	mov    0x24(%esp),%edi
  801c96:	89 cd                	mov    %ecx,%ebp
  801c98:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801c9c:	85 c0                	test   %eax,%eax
  801c9e:	75 2c                	jne    801ccc <__udivdi3+0x4c>
  801ca0:	39 f9                	cmp    %edi,%ecx
  801ca2:	77 68                	ja     801d0c <__udivdi3+0x8c>
  801ca4:	85 c9                	test   %ecx,%ecx
  801ca6:	75 0b                	jne    801cb3 <__udivdi3+0x33>
  ...
  801cca:	5d                   	pop    %ebp
  801ccb:	c3                   	ret    
  801ccc:	39 f8                	cmp    %edi,%eax
  801cce:	77 2c                	ja     801cfc <__udivdi3+0x7c>
  801cd0:	0f bd f0             	bsr    %eax,%esi
  801cd3:	83 f6 1f             	xor    $0x1f,%esi
  801cd6:	75 4c                	jne    801d24 <__udivdi3+0xa4>
  801cd8:	39 f8                	cmp    %edi,%eax
  801cda:	bf 00 00 00 00       	mov    $0x0,%edi
  801cdf:	72 0a                	jb     801ceb <__udivdi3+0x6b>
  801ce1:	3b 4c 24 04          	cmp    0x4(%esp),%ecx
  801ce5:	0f 87 ad 00 00 00    	ja     801d98 <__udivdi3+0x118>
  801ceb:	be 01 00 00 00       	mov    $0x1,%esi
  ...
  801d31:	29 f0                	sub    %esi,%eax
  801d33:	89 ea                	mov    %ebp,%edx
  801d35:	88 c1                	mov    %al,%cl
  801d37:	d3 ea                	shr    %cl,%edx
  801d39:	8b 4c 24 0c          	mov    0xc(%esp),%ecx
  801d3d:	09 ca                	or     %ecx,%edx
  801d3f:	89 54 24 08          	mov    %edx,0x8(%esp)
  801d43:	89 f1                	mov    %esi,%ecx
  801d45:	d3 e5                	shl    %cl,%ebp
  801d47:	89 6c 24 0c          	mov    %ebp,0xc(%esp)
  ...
  801d57:	8b 7c 24 04          	mov    0x4(%esp),%edi
  801d5b:	88 c1                	mov    %al,%cl
  801d5d:	d3 ef                	shr    %cl,%edi
  801d5f:	09 d7                	or     %edx,%edi
  801d61:	89 f8                	mov    %edi,%eax
  801d63:	89 ea                	mov    %ebp,%edx
  801d65:	f7 74 24 08          	divl   0x8(%esp)
  801d69:	89 d1                	mov    %edx,%ecx
  801d6b:	89 c7                	mov    %eax,%edi
  801d6d:	f7 64 24 0c          	mull   0xc(%esp)
  801d71:	39 d1                	cmp    %edx,%ecx
  801d73:	72 17                	jb     801d8c <__udivdi3+0x10c>
  801d75:	74 09                	je     801d80 <__udivdi3+0x100>
  801d77:	89 fe                	mov    %edi,%esi
  801d79:	31 ff                	xor    %edi,%edi
  801d7b:	e9 41 ff ff ff       	jmp    801cc1 <__udivdi3+0x41>
  801d80:	8b 54 24 04          	mov    0x4(%esp),%edx
  801d84:	89 f1                	mov    %esi,%ecx
  801d86:	d3 e2                	shl    %cl,%edx
  801d88:	39 c2                	cmp    %eax,%edx
  801d8a:	73 eb                	jae    801d77 <__udivdi3+0xf7>
  801d8c:	8d 77 ff             	lea    -0x1(%edi),%esi
  801d8f:	31 ff                	xor    %edi,%edi
  801d91:	e9 2b ff ff ff       	jmp    801cc1 <__udivdi3+0x41>
  801d96:	66 90                	xchg   %ax,%ax
  801d98:	31 f6                	xor    %esi,%esi
  801d9a:	e9 22 ff ff ff       	jmp    801cc1 <__udivdi3+0x41>
	...
...
00801da0 <__umoddi3>:
  ...
  801da6:	8b 44 24 30          	mov    0x30(%esp),%eax
  801daa:	8b 4c 24 38          	mov    0x38(%esp),%ecx
  801dae:	89 44 24 14          	mov    %eax,0x14(%esp)
  801db2:	8b 74 24 34          	mov    0x34(%esp),%esi
  801db6:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  801dba:	8b 6c 24 3c          	mov    0x3c(%esp),%ebp
  801dbe:	89 c7                	mov    %eax,%edi
  801dc0:	89 f2                	mov    %esi,%edx
  801dc2:	85 ed                	test   %ebp,%ebp
  801dc4:	75 16                	jne    801ddc <__umoddi3+0x3c>
  801dc6:	39 f1                	cmp    %esi,%ecx
  801dc8:	0f 86 a6 00 00 00    	jbe    801e74 <__umoddi3+0xd4>
  ...
  801dda:	c3                   	ret    
  801ddb:	90                   	nop
  801ddc:	39 f5                	cmp    %esi,%ebp
  801dde:	0f 87 ac 00 00 00    	ja     801e90 <__umoddi3+0xf0>
  801de4:	0f bd c5             	bsr    %ebp,%eax
  801de7:	83 f0 1f             	xor    $0x1f,%eax
  801dea:	89 44 24 10          	mov    %eax,0x10(%esp)
  801dee:	0f 84 a8 00 00 00    	je     801e9c <__umoddi3+0xfc>
  801df4:	8a 4c 24 10          	mov    0x10(%esp),%cl
  801df8:	d3 e5                	shl    %cl,%ebp
  801dfa:	bf 20 00 00 00       	mov    $0x20,%edi
  801dff:	2b 7c 24 10          	sub    0x10(%esp),%edi
  801e03:	8b 44 24 0c          	mov    0xc(%esp),%eax
  801e07:	89 f9                	mov    %edi,%ecx
  801e09:	d3 e8                	shr    %cl,%eax
  801e0b:	09 e8                	or     %ebp,%eax
  801e0d:	89 44 24 18          	mov    %eax,0x18(%esp)
  801e11:	8b 44 24 0c          	mov    0xc(%esp),%eax
  801e15:	8a 4c 24 10          	mov    0x10(%esp),%cl
  801e19:	d3 e0                	shl    %cl,%eax
  801e1b:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801e1f:	89 f2                	mov    %esi,%edx
  801e21:	d3 e2                	shl    %cl,%edx
  801e23:	8b 44 24 14          	mov    0x14(%esp),%eax
  801e27:	d3 e0                	shl    %cl,%eax
  801e29:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  801e2d:	8b 44 24 14          	mov    0x14(%esp),%eax
  801e31:	89 f9                	mov    %edi,%ecx
  801e33:	d3 e8                	shr    %cl,%eax
  801e35:	09 d0                	or     %edx,%eax
  801e37:	d3 ee                	shr    %cl,%esi
  801e39:	89 f2                	mov    %esi,%edx
  801e3b:	f7 74 24 18          	divl   0x18(%esp)
  801e3f:	89 d6                	mov    %edx,%esi
  801e41:	f7 64 24 0c          	mull   0xc(%esp)
  801e45:	89 c5                	mov    %eax,%ebp
  801e47:	89 d1                	mov    %edx,%ecx
  801e49:	39 d6                	cmp    %edx,%esi
  801e4b:	72 67                	jb     801eb4 <__umoddi3+0x114>
  801e4d:	74 75                	je     801ec4 <__umoddi3+0x124>
  801e4f:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801e53:	29 e8                	sub    %ebp,%eax
  801e55:	19 ce                	sbb    %ecx,%esi
  801e57:	8a 4c 24 10          	mov    0x10(%esp),%cl
  ...
  801e6d:	83 c4 20             	add    $0x20,%esp
  801e70:	5e                   	pop    %esi
  801e71:	5f                   	pop    %edi
  801e72:	5d                   	pop    %ebp
  801e73:	c3                   	ret    
  801e74:	85 c9                	test   %ecx,%ecx
  801e76:	75 0b                	jne    801e83 <__umoddi3+0xe3>
  ...
  801e8b:	e9 3e ff ff ff       	jmp    801dce <__umoddi3+0x2e>
  801e90:	89 f2                	mov    %esi,%edx
  801e92:	83 c4 20             	add    $0x20,%esp
  801e95:	5e                   	pop    %esi
  801e96:	5f                   	pop    %edi
  801e97:	5d                   	pop    %ebp
  801e98:	c3                   	ret    
  ...
  801e9e:	72 04                	jb     801ea4 <__umoddi3+0x104>
  801ea0:	39 f9                	cmp    %edi,%ecx
  801ea2:	77 06                	ja     801eaa <__umoddi3+0x10a>
  801ea4:	89 f2                	mov    %esi,%edx
  801ea6:	29 cf                	sub    %ecx,%edi
  801ea8:	19 ea                	sbb    %ebp,%edx
  ...
  801eb2:	c3                   	ret    
  801eb3:	90                   	nop
  801eb4:	89 d1                	mov    %edx,%ecx
  801eb6:	89 c5                	mov    %eax,%ebp
  801eb8:	2b 6c 24 0c          	sub    0xc(%esp),%ebp
  801ebc:	1b 4c 24 18          	sbb    0x18(%esp),%ecx
  801ec0:	eb 8d                	jmp    801e4f <__umoddi3+0xaf>
  801ec2:	66 90                	xchg   %ax,%ax
  801ec4:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801ec8:	72 ea                	jb     801eb4 <__umoddi3+0x114>
  801eca:	89 f1                	mov    %esi,%ecx
  801ecc:	eb 81                	jmp    801e4f <__umoddi3+0xaf>
