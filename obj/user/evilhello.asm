...
sys_env_destroy(envid_t envid)
{
  ...
  80012a:	00 
  80012b:	c7 44 24 08 0a 1f 80 	movl   $0x801f0a,0x8(%esp)
  800132:	00 
  800133:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80013a:	00 
  80013b:	c7 04 24 27 1f 80 00 	movl   $0x801f27,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001bc:	00 
  8001bd:	c7 44 24 08 0a 1f 80 	movl   $0x801f0a,0x8(%esp)
  8001c4:	00 
  8001c5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001cc:	00 
  8001cd:	c7 04 24 27 1f 80 00 	movl   $0x801f27,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80020f:	00 
  800210:	c7 44 24 08 0a 1f 80 	movl   $0x801f0a,0x8(%esp)
  800217:	00 
  800218:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80021f:	00 
  800220:	c7 04 24 27 1f 80 00 	movl   $0x801f27,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800262:	00 
  800263:	c7 44 24 08 0a 1f 80 	movl   $0x801f0a,0x8(%esp)
  80026a:	00 
  80026b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800272:	00 
  800273:	c7 04 24 27 1f 80 00 	movl   $0x801f27,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002b5:	00 
  8002b6:	c7 44 24 08 0a 1f 80 	movl   $0x801f0a,0x8(%esp)
  8002bd:	00 
  8002be:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002c5:	00 
  8002c6:	c7 04 24 27 1f 80 00 	movl   $0x801f27,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800308:	00 
  800309:	c7 44 24 08 0a 1f 80 	movl   $0x801f0a,0x8(%esp)
  800310:	00 
  800311:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800318:	00 
  800319:	c7 04 24 27 1f 80 00 	movl   $0x801f27,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80035b:	00 
  80035c:	c7 44 24 08 0a 1f 80 	movl   $0x801f0a,0x8(%esp)
  800363:	00 
  800364:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80036b:	00 
  80036c:	c7 04 24 27 1f 80 00 	movl   $0x801f27,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  8003d0:	00 
  8003d1:	c7 44 24 08 0a 1f 80 	movl   $0x801f0a,0x8(%esp)
  8003d8:	00 
  8003d9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003e0:	00 
  8003e1:	c7 04 24 27 1f 80 00 	movl   $0x801f27,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
  8004ed:	42                   	inc    %edx
  8004ee:	8b 04 95 b4 1f 80 00 	mov    0x801fb4(,%edx,4),%eax
  ...
  800509:	c7 04 24 38 1f 80 00 	movl   $0x801f38,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800765:	c7 04 24 79 1f 80 00 	movl   $0x801f79,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80083b:	c7 04 24 95 1f 80 00 	movl   $0x801f95,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8008f2:	c7 04 24 58 1f 80 00 	movl   $0x801f58,(%esp)
...
fsipc(unsigned type, void *dstva)
{
  ...
  800a04:	e8 02 12 00 00       	call   801c0b <ipc_find_env>
  ...
  800a2a:	e8 72 11 00 00       	call   801ba1 <ipc_send>
  ...
  800a42:	e8 f1 10 00 00       	call   801b38 <ipc_recv>
}
...
devfile_stat(struct Fd *fd, struct Stat *st)
{
  ...
  800acd:	e8 41 0d 00 00       	call   801813 <strcpy>
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  800af6:	83 ec 18             	sub    $0x18,%esp
	...
	panic("devfile_write not implemented");
  800af9:	c7 44 24 08 c4 1f 80 	movl   $0x801fc4,0x8(%esp)
  800b00:	00 
  800b01:	c7 44 24 04 90 00 00 	movl   $0x90,0x4(%esp)
  800b08:	00 
  800b09:	c7 04 24 e2 1f 80 00 	movl   $0x801fe2,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800b4a:	c7 44 24 0c ed 1f 80 	movl   $0x801fed,0xc(%esp)
  800b51:	00 
  800b52:	c7 44 24 08 f4 1f 80 	movl   $0x801ff4,0x8(%esp)
  800b59:	00 
  800b5a:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  800b61:	00 
  800b62:	c7 04 24 e2 1f 80 00 	movl   $0x801fe2,(%esp)
  800b69:	e8 02 06 00 00       	call   801170 <_panic>
	assert(r <= PGSIZE);
  800b6e:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800b73:	7e 24                	jle    800b99 <devfile_read+0x84>
  800b75:	c7 44 24 0c 09 20 80 	movl   $0x802009,0xc(%esp)
  800b7c:	00 
  800b7d:	c7 44 24 08 f4 1f 80 	movl   $0x801ff4,0x8(%esp)
  800b84:	00 
  800b85:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  800b8c:	00 
  800b8d:	c7 04 24 e2 1f 80 00 	movl   $0x801fe2,(%esp)
  ...
  800bab:	e8 dc 0d 00 00       	call   80198c <memmove>
	return r;
}
...
open(const char *path, int mode)
{
  ...
  800bc7:	e8 14 0c 00 00       	call   8017e0 <strlen>
  ...
  800bef:	e8 1f 0c 00 00       	call   801813 <strcpy>
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800c70:	c7 44 24 04 15 20 80 	movl   $0x802015,0x4(%esp)
  800c77:	00 
  800c78:	89 34 24             	mov    %esi,(%esp)
  800c7b:	e8 93 0b 00 00       	call   801813 <strcpy>
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800d43:	c7 04 24 1c 20 80 00 	movl   $0x80201c,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800fe0:	c7 44 24 04 34 20 80 	movl   $0x802034,0x4(%esp)
  800fe7:	00 
  800fe8:	8b 45 0c             	mov    0xc(%ebp),%eax
  800feb:	89 04 24             	mov    %eax,(%esp)
  800fee:	e8 20 08 00 00       	call   801813 <strcpy>
	return 0;
}
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801030:	e8 57 09 00 00       	call   80198c <memmove>
		sys_cputs(buf, m);
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80119c:	c7 04 24 40 20 80 00 	movl   $0x802040,(%esp)
  ...
  8011b2:	e8 50 00 00 00       	call   801207 <vcprintf>
	cprintf("\n");
  8011b7:	c7 04 24 2d 20 80 00 	movl   $0x80202d,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8012dd:	e8 b2 09 00 00       	call   801c94 <__udivdi3>
  ...
  801330:	e8 7f 0a 00 00       	call   801db4 <__umoddi3>
  801335:	89 7c 24 04          	mov    %edi,0x4(%esp)
  801339:	0f be 80 63 20 80 00 	movsbl 0x802063(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8013dd:	0f 84 6b 03 00 00    	je     80174e <vprintfmt+0x384>
				return;
			putch(ch, putdat);
  ...
  80144b:	0f 87 e1 02 00 00    	ja     801732 <vprintfmt+0x368>
  801451:	0f b6 d2             	movzbl %dl,%edx
  801454:	ff 24 95 a0 21 80 00 	jmp    *0x8021a0(,%edx,4)
  ...
  801514:	c7 44 24 08 06 20 80 	movl   $0x802006,0x8(%esp)
  80151b:	00 
  ...
  801548:	75 05                	jne    80154f <vprintfmt+0x185>
				p = "(null)";
  80154a:	be 74 20 80 00       	mov    $0x802074,%esi
			if (width > 0 && padc != '-')
  ...
  801566:	e8 8b 02 00 00       	call   8017f6 <strnlen>
...
getint(va_list *ap, int lflag)
{
  ...
  801663:	e9 8c 00 00 00       	jmp    8016f4 <vprintfmt+0x32a>
  ...
  801682:	eb 70                	jmp    8016f4 <vprintfmt+0x32a>
			goto number;
  ...
  8016da:	b8 10 00 00 00       	mov    $0x10,%eax
			goto number;
  8016df:	eb 13                	jmp    8016f4 <vprintfmt+0x32a>

		// (unsigned) hexadecimal
		case 'x':
			num = getuint(&ap, lflag);
  8016e1:	89 ca                	mov    %ecx,%edx
  8016e3:	8d 45 14             	lea    0x14(%ebp),%eax
  8016e6:	e8 63 fc ff ff       	call   80134e <getuint>
  8016eb:	89 c6                	mov    %eax,%esi
  8016ed:	89 d7                	mov    %edx,%edi
			base = 16;
  8016ef:	b8 10 00 00 00       	mov    $0x10,%eax
		number:
			printnum(putch, putdat, num, base, width, padc);
  8016f4:	0f be 55 d8          	movsbl -0x28(%ebp),%edx
  8016f8:	89 54 24 10          	mov    %edx,0x10(%esp)
  8016fc:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8016ff:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801703:	89 44 24 08          	mov    %eax,0x8(%esp)
  801707:	89 34 24             	mov    %esi,(%esp)
  80170a:	89 7c 24 04          	mov    %edi,0x4(%esp)
  80170e:	89 da                	mov    %ebx,%edx
  801710:	8b 45 08             	mov    0x8(%ebp),%eax
  801713:	e8 6c fb ff ff       	call   801284 <printnum>
			break;
  801718:	8b 75 e0             	mov    -0x20(%ebp),%esi
  80171b:	e9 cd fc ff ff       	jmp    8013ed <vprintfmt+0x23>
  ...
  801727:	ff 55 08             	call   *0x8(%ebp)
	...
	reswitch:
		switch (ch = *(unsigned char *) fmt++) {
  80172a:	8b 75 e0             	mov    -0x20(%ebp),%esi
			break;
		...
		case '%':
			putch(ch, putdat);
			break;
  80172d:	e9 bb fc ff ff       	jmp    8013ed <vprintfmt+0x23>

		// unrecognized escape sequence - just print it literally
		default:
			putch('%', putdat);
  801732:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801736:	c7 04 24 25 00 00 00 	movl   $0x25,(%esp)
  80173d:	ff 55 08             	call   *0x8(%ebp)
			for (fmt--; fmt[-1] != '%'; fmt--)
  801740:	eb 01                	jmp    801743 <vprintfmt+0x379>
  801742:	4e                   	dec    %esi
  801743:	80 7e ff 25          	cmpb   $0x25,-0x1(%esi)
  801747:	75 f9                	jne    801742 <vprintfmt+0x378>
  801749:	e9 9f fc ff ff       	jmp    8013ed <vprintfmt+0x23>
				/* do nothing */;
			break;
		}
	}
}
  80174e:	83 c4 4c             	add    $0x4c,%esp
  801751:	5b                   	pop    %ebx
  801752:	5e                   	pop    %esi
  801753:	5f                   	pop    %edi
  801754:	5d                   	pop    %ebp
...
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
  ...
  801765:	8d 4c 10 ff          	lea    -0x1(%eax,%edx,1),%ecx
  801769:	89 4d f0             	mov    %ecx,-0x10(%ebp)
  80176c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)

	if (buf == NULL || n < 1)
  801773:	85 c0                	test   %eax,%eax
  801775:	74 30                	je     8017a7 <vsnprintf+0x51>
  801777:	85 d2                	test   %edx,%edx
  801779:	7e 33                	jle    8017ae <vsnprintf+0x58>
		return -E_INVAL;
  ...
  801789:	8d 45 ec             	lea    -0x14(%ebp),%eax
  80178c:	89 44 24 04          	mov    %eax,0x4(%esp)
  801790:	c7 04 24 88 13 80 00 	movl   $0x801388,(%esp)
  801797:	e8 2e fc ff ff       	call   8013ca <vprintfmt>

	// null terminate the buffer
	*b.buf = '\0';
  80179c:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80179f:	c6 00 00             	movb   $0x0,(%eax)

	return b.cnt;
  8017a2:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8017a5:	eb 0c                	jmp    8017b3 <vsnprintf+0x5d>
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
	struct sprintbuf b = {buf, buf+n-1, 0};
  ...
  8017ac:	eb 05                	jmp    8017b3 <vsnprintf+0x5d>
...
snprintf(char *buf, int n, const char *fmt, ...)
{
  ...
  8017d6:	e8 7b ff ff ff       	call   801756 <vsnprintf>
	va_end(ap);
...
strlen(const char *s)
{
  ...
  8017eb:	eb 01                	jmp    8017ee <strlen+0xe>
		n++;
  8017ed:	40                   	inc    %eax
int
strlen(const char *s)
{
	...
	for (n = 0; *s != '\0'; s++)
  8017ee:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
  8017f2:	75 f9                	jne    8017ed <strlen+0xd>
		n++;
	return n;
}
  8017f4:	5d                   	pop    %ebp
  ...
  8017fc:	8b 55 0c             	mov    0xc(%ebp),%edx
{
  ...
  801804:	eb 01                	jmp    801807 <strnlen+0x11>
		n++;
  801806:	40                   	inc    %eax
int
strnlen(const char *s, size_t size)
{
  ...
  801809:	74 06                	je     801811 <strnlen+0x1b>
  80180b:	80 3c 01 00          	cmpb   $0x0,(%ecx,%eax,1)
  80180f:	75 f5                	jne    801806 <strnlen+0x10>
		n++;
	return n;
}
  801811:	5d                   	pop    %ebp
...
strcpy(char *dst, const char *src)
{
  ...
  801822:	8a 0c 13             	mov    (%ebx,%edx,1),%cl
  801825:	88 0c 10             	mov    %cl,(%eax,%edx,1)
  801828:	42                   	inc    %edx
  801829:	84 c9                	test   %cl,%cl
  80182b:	75 f5                	jne    801822 <strcpy+0xf>
		/* do nothing */;
	return ret;
}
  80182d:	5b                   	pop    %ebx
...
strcat(char *dst, const char *src)
{
  ...
  80183d:	e8 9e ff ff ff       	call   8017e0 <strlen>
	strcpy(dst + len, src);
  801842:	8b 55 0c             	mov    0xc(%ebp),%edx
  801845:	89 54 24 04          	mov    %edx,0x4(%esp)
  801849:	01 d8                	add    %ebx,%eax
  80184b:	89 04 24             	mov    %eax,(%esp)
  80184e:	e8 c0 ff ff ff       	call   801813 <strcpy>
	return dst;
}
...
strncpy(char *dst, const char *src, size_t size) {
  ...
  80186e:	eb 0c                	jmp    80187c <strncpy+0x21>
		*dst++ = *src;
  801870:	8a 1a                	mov    (%edx),%bl
  801872:	88 1c 08             	mov    %bl,(%eax,%ecx,1)
		// If strlen(src) < size, null-pad 'dst' out to 'size' chars
		if (*src != '\0')
			src++;
  801875:	80 3a 01             	cmpb   $0x1,(%edx)
  801878:	83 da ff             	sbb    $0xffffffff,%edx
strncpy(char *dst, const char *src, size_t size) {
	size_t i;
	char *ret;
	...
	for (i = 0; i < size; i++) {
  80187b:	41                   	inc    %ecx
  80187c:	39 f1                	cmp    %esi,%ecx
  80187e:	75 f0                	jne    801870 <strncpy+0x15>
		// If strlen(src) < size, null-pad 'dst' out to 'size' chars
		if (*src != '\0')
			src++;
	}
...
strlcpy(char *dst, const char *src, size_t size)
{
  ...
  801894:	75 0a                	jne    8018a0 <strlcpy+0x1c>
  801896:	89 f0                	mov    %esi,%eax
  801898:	eb 1a                	jmp    8018b4 <strlcpy+0x30>
		while (--size > 0 && *src != '\0')
			*dst++ = *src++;
  80189a:	88 18                	mov    %bl,(%eax)
  80189c:	40                   	inc    %eax
  80189d:	41                   	inc    %ecx
  80189e:	eb 02                	jmp    8018a2 <strlcpy+0x1e>
strlcpy(char *dst, const char *src, size_t size)
{
	char *dst_in;
  ...
  8018a0:	89 f0                	mov    %esi,%eax
		while (--size > 0 && *src != '\0')
  8018a2:	4a                   	dec    %edx
  8018a3:	74 0a                	je     8018af <strlcpy+0x2b>
  8018a5:	8a 19                	mov    (%ecx),%bl
  8018a7:	84 db                	test   %bl,%bl
  8018a9:	75 ef                	jne    80189a <strlcpy+0x16>
  8018ab:	89 c2                	mov    %eax,%edx
  8018ad:	eb 02                	jmp    8018b1 <strlcpy+0x2d>
  8018af:	89 c2                	mov    %eax,%edx
			*dst++ = *src++;
		*dst = '\0';
  8018b1:	c6 02 00             	movb   $0x0,(%edx)
	}
	return dst - dst_in;
...
strcmp(const char *p, const char *q)
{
  ...
  8018c0:	8b 55 0c             	mov    0xc(%ebp),%edx
	while (*p && *p == *q)
  8018c3:	eb 02                	jmp    8018c7 <strcmp+0xd>
		p++, q++;
  8018c5:	41                   	inc    %ecx
  8018c6:	42                   	inc    %edx
}
...
{
	while (*p && *p == *q)
  8018c7:	8a 01                	mov    (%ecx),%al
  8018c9:	84 c0                	test   %al,%al
  8018cb:	74 04                	je     8018d1 <strcmp+0x17>
  8018cd:	3a 02                	cmp    (%edx),%al
  8018cf:	74 f4                	je     8018c5 <strcmp+0xb>
		p++, q++;
	return (int) ((unsigned char) *p - (unsigned char) *q);
  8018d1:	0f b6 c0             	movzbl %al,%eax
  8018d4:	0f b6 12             	movzbl (%edx),%edx
...
strncmp(const char *p, const char *q, size_t n)
{
  ...
  8018e5:	8b 55 10             	mov    0x10(%ebp),%edx
	while (n > 0 && *p && *p == *q)
  8018e8:	eb 03                	jmp    8018ed <strncmp+0x12>
		n--, p++, q++;
  8018ea:	4a                   	dec    %edx
  8018eb:	40                   	inc    %eax
  8018ec:	41                   	inc    %ecx
...
strncmp(const char *p, const char *q, size_t n)
{
  ...
  8018ef:	74 14                	je     801905 <strncmp+0x2a>
  8018f1:	8a 18                	mov    (%eax),%bl
  8018f3:	84 db                	test   %bl,%bl
  8018f5:	74 04                	je     8018fb <strncmp+0x20>
  8018f7:	3a 19                	cmp    (%ecx),%bl
  8018f9:	74 ef                	je     8018ea <strncmp+0xf>
		n--, p++, q++;
	if (n == 0)
		return 0;
	else
  ...
  8018fe:	0f b6 11             	movzbl (%ecx),%edx
  801901:	29 d0                	sub    %edx,%eax
  801903:	eb 05                	jmp    80190a <strncmp+0x2f>
strncmp(const char *p, const char *q, size_t n)
{
	while (n > 0 && *p && *p == *q)
		n--, p++, q++;
...
strchr(const char *s, char c)
{
  ...
  801913:	8a 4d 0c             	mov    0xc(%ebp),%cl
	for (; *s; s++)
  801916:	eb 05                	jmp    80191d <strchr+0x10>
		if (*s == c)
  801918:	38 ca                	cmp    %cl,%dl
  80191a:	74 0c                	je     801928 <strchr+0x1b>
// Return a pointer to the first occurrence of 'c' in 's',
// or a null pointer if the string has no 'c'.
char *
strchr(const char *s, char c)
{
	for (; *s; s++)
  80191c:	40                   	inc    %eax
  80191d:	8a 10                	mov    (%eax),%dl
  80191f:	84 d2                	test   %dl,%dl
  801921:	75 f5                	jne    801918 <strchr+0xb>
		if (*s == c)
			return (char *) s;
	return 0;
...
strfind(const char *s, char c)
{
  ...
  801930:	8a 4d 0c             	mov    0xc(%ebp),%cl
	for (; *s; s++)
  801933:	eb 05                	jmp    80193a <strfind+0x10>
		if (*s == c)
...
strfind(const char *s, char c)
{
  ...
  80193e:	75 f5                	jne    801935 <strfind+0xb>
		if (*s == c)
			break;
	return (char *) s;
}
...
memset(void *v, int c, size_t n)
{
  ...
  801953:	74 30                	je     801985 <memset+0x43>
		return v;
	if ((int)v%4 == 0 && n%4 == 0) {
  801955:	f7 c7 03 00 00 00    	test   $0x3,%edi
  80195b:	75 25                	jne    801982 <memset+0x40>
  80195d:	f6 c1 03             	test   $0x3,%cl
  801960:	75 20                	jne    801982 <memset+0x40>
		c &= 0xFF;
  801962:	0f b6 d0             	movzbl %al,%edx
		c = (c<<24)|(c<<16)|(c<<8)|c;
  801965:	89 d3                	mov    %edx,%ebx
  801967:	c1 e3 08             	shl    $0x8,%ebx
  80196a:	89 d6                	mov    %edx,%esi
  80196c:	c1 e6 18             	shl    $0x18,%esi
  80196f:	89 d0                	mov    %edx,%eax
  801971:	c1 e0 10             	shl    $0x10,%eax
  801974:	09 f0                	or     %esi,%eax
  801976:	09 d0                	or     %edx,%eax
  801978:	09 d8                	or     %ebx,%eax
  ...
  80197a:	c1 e9 02             	shr    $0x2,%ecx
	...
	if ((int)v%4 == 0 && n%4 == 0) {
		...
		asm volatile("cld; rep stosl\n"
  80197d:	fc                   	cld    
  80197e:	f3 ab                	rep stos %eax,%es:(%edi)
  801980:	eb 03                	jmp    801985 <memset+0x43>
			:: "D" (v), "a" (c), "c" (n/4)
			: "cc", "memory");
	} else
...
memmove(void *dst, const void *src, size_t n)
{
  ...
  801994:	8b 75 0c             	mov    0xc(%ebp),%esi
  801997:	8b 4d 10             	mov    0x10(%ebp),%ecx
	...
	d = dst;
	if (s < d && s + n > d) {
  80199a:	39 c6                	cmp    %eax,%esi
  80199c:	73 34                	jae    8019d2 <memmove+0x46>
  80199e:	8d 14 0e             	lea    (%esi,%ecx,1),%edx
  8019a1:	39 d0                	cmp    %edx,%eax
  8019a3:	73 2d                	jae    8019d2 <memmove+0x46>
		s += n;
		d += n;
  8019a5:	8d 3c 08             	lea    (%eax,%ecx,1),%edi
		if ((int)s%4 == 0 && (int)d%4 == 0 && n%4 == 0)
  8019a8:	f6 c2 03             	test   $0x3,%dl
  8019ab:	75 1b                	jne    8019c8 <memmove+0x3c>
  8019ad:	f7 c7 03 00 00 00    	test   $0x3,%edi
  8019b3:	75 13                	jne    8019c8 <memmove+0x3c>
  8019b5:	f6 c1 03             	test   $0x3,%cl
  ...
  8019c6:	eb 07                	jmp    8019cf <memmove+0x43>
				:: "D" (d-4), "S" (s-4), "c" (n/4) : "cc", "memory");
		else
			asm volatile("std; rep movsb\n"
				:: "D" (d-1), "S" (s-1), "c" (n) : "cc", "memory");
  8019c8:	4f                   	dec    %edi
  8019c9:	8d 72 ff             	lea    -0x1(%edx),%esi
		d += n;
		if ((int)s%4 == 0 && (int)d%4 == 0 && n%4 == 0)
			asm volatile("std; rep movsl\n"
				:: "D" (d-4), "S" (s-4), "c" (n/4) : "cc", "memory");
			...
			asm volatile("std; rep movsb\n"
  8019cc:	fd                   	std    
  8019cd:	f3 a4                	rep movsb %ds:(%esi),%es:(%edi)
				:: "D" (d-1), "S" (s-1), "c" (n) : "cc", "memory");
		// Some versions of GCC rely on DF being clear
		asm volatile("cld" ::: "cc");
  8019cf:	fc                   	cld    
  8019d0:	eb 20                	jmp    8019f2 <memmove+0x66>
	} else {
		if ((int)s%4 == 0 && (int)d%4 == 0 && n%4 == 0)
  8019d2:	f7 c6 03 00 00 00    	test   $0x3,%esi
  8019d8:	75 13                	jne    8019ed <memmove+0x61>
  8019da:	a8 03                	test   $0x3,%al
  8019dc:	75 0f                	jne    8019ed <memmove+0x61>
  8019de:	f6 c1 03             	test   $0x3,%cl
  8019e1:	75 0a                	jne    8019ed <memmove+0x61>
  ...
  8019eb:	eb 05                	jmp    8019f2 <memmove+0x66>
				:: "D" (d), "S" (s), "c" (n/4) : "cc", "memory");
		else
...
memcpy(void *dst, const void *src, size_t n)
{
  ...
  801a10:	e8 77 ff ff ff       	call   80198c <memmove>
}
  801a15:	c9                   	leave  
  801a16:	c3                   	ret    
...
memcmp(const void *v1, const void *v2, size_t n)
{
  ...
  801a2b:	eb 16                	jmp    801a43 <memcmp+0x2c>
		if (*s1 != *s2)
  801a2d:	8a 04 17             	mov    (%edi,%edx,1),%al
  801a30:	42                   	inc    %edx
  801a31:	8a 4c 16 ff          	mov    -0x1(%esi,%edx,1),%cl
  801a35:	38 c8                	cmp    %cl,%al
  801a37:	74 0a                	je     801a43 <memcmp+0x2c>
			return (int) *s1 - (int) *s2;
  801a39:	0f b6 c0             	movzbl %al,%eax
  801a3c:	0f b6 c9             	movzbl %cl,%ecx
  801a3f:	29 c8                	sub    %ecx,%eax
  801a41:	eb 09                	jmp    801a4c <memcmp+0x35>
memcmp(const void *v1, const void *v2, size_t n)
{
	const uint8_t *s1 = (const uint8_t *) v1;
	const uint8_t *s2 = (const uint8_t *) v2;
	...
	while (n-- > 0) {
  801a43:	39 da                	cmp    %ebx,%edx
  801a45:	75 e6                	jne    801a2d <memcmp+0x16>
		if (*s1 != *s2)
			return (int) *s1 - (int) *s2;
		s1++, s2++;
	}
...
memfind(const void *s, int c, size_t n)
{
  ...
  801a5c:	03 55 10             	add    0x10(%ebp),%edx
	for (; s < ends; s++)
  801a5f:	eb 05                	jmp    801a66 <memfind+0x15>
		if (*(const unsigned char *) s == (unsigned char) c)
  801a61:	38 08                	cmp    %cl,(%eax)
  801a63:	74 05                	je     801a6a <memfind+0x19>
...
memfind(const void *s, int c, size_t n)
{
  ...
  801a68:	72 f7                	jb     801a61 <memfind+0x10>
		if (*(const unsigned char *) s == (unsigned char) c)
			break;
	return (void *) s;
}
...
strtol(const char *s, char **endptr, int base)
{
  ...
  801a75:	8b 5d 10             	mov    0x10(%ebp),%ebx
	...
	while (*s == ' ' || *s == '\t')
  801a78:	eb 01                	jmp    801a7b <strtol+0xf>
		s++;
  801a7a:	42                   	inc    %edx
{
	int neg = 0;
	...
	// gobble initial whitespace
	while (*s == ' ' || *s == '\t')
  801a7b:	8a 02                	mov    (%edx),%al
  801a7d:	3c 20                	cmp    $0x20,%al
  801a7f:	74 f9                	je     801a7a <strtol+0xe>
  801a81:	3c 09                	cmp    $0x9,%al
  801a83:	74 f5                	je     801a7a <strtol+0xe>
		s++;

	// plus/minus sign
	if (*s == '+')
  801a85:	3c 2b                	cmp    $0x2b,%al
  801a87:	75 08                	jne    801a91 <strtol+0x25>
		s++;
  801a89:	42                   	inc    %edx
}
...
strtol(const char *s, char **endptr, int base)
{
  ...
  801a8f:	eb 13                	jmp    801aa4 <strtol+0x38>
		s++;
  ...
  801a91:	3c 2d                	cmp    $0x2d,%al
  801a93:	75 0a                	jne    801a9f <strtol+0x33>
		s++, neg = 1;
  801a95:	8d 52 01             	lea    0x1(%edx),%edx
  801a98:	bf 01 00 00 00       	mov    $0x1,%edi
  801a9d:	eb 05                	jmp    801aa4 <strtol+0x38>
}
...
strtol(const char *s, char **endptr, int base)
{
  ...
  801aa6:	74 05                	je     801aad <strtol+0x41>
  801aa8:	83 fb 10             	cmp    $0x10,%ebx
  801aab:	75 28                	jne    801ad5 <strtol+0x69>
  801aad:	8a 02                	mov    (%edx),%al
  801aaf:	3c 30                	cmp    $0x30,%al
  801ab1:	75 10                	jne    801ac3 <strtol+0x57>
  801ab3:	80 7a 01 78          	cmpb   $0x78,0x1(%edx)
  801ab7:	75 0a                	jne    801ac3 <strtol+0x57>
		s += 2, base = 16;
  801ab9:	83 c2 02             	add    $0x2,%edx
  801abc:	bb 10 00 00 00       	mov    $0x10,%ebx
  801ac1:	eb 12                	jmp    801ad5 <strtol+0x69>
	else if (base == 0 && s[0] == '0')
  801ac3:	85 db                	test   %ebx,%ebx
  801ac5:	75 0e                	jne    801ad5 <strtol+0x69>
  801ac7:	3c 30                	cmp    $0x30,%al
  801ac9:	75 05                	jne    801ad0 <strtol+0x64>
		s++, base = 8;
  801acb:	42                   	inc    %edx
  801acc:	b3 08                	mov    $0x8,%bl
  801ace:	eb 05                	jmp    801ad5 <strtol+0x69>
	else if (base == 0)
		base = 10;
  801ad0:	bb 0a 00 00 00       	mov    $0xa,%ebx
  ...
  801ada:	89 de                	mov    %ebx,%esi
	...
	while (1) {
		...
		if (*s >= '0' && *s <= '9')
  801adc:	8a 0a                	mov    (%edx),%cl
  801ade:	8d 59 d0             	lea    -0x30(%ecx),%ebx
  801ae1:	80 fb 09             	cmp    $0x9,%bl
  801ae4:	77 08                	ja     801aee <strtol+0x82>
			dig = *s - '0';
  801ae6:	0f be c9             	movsbl %cl,%ecx
  801ae9:	83 e9 30             	sub    $0x30,%ecx
  801aec:	eb 1e                	jmp    801b0c <strtol+0xa0>
		else if (*s >= 'a' && *s <= 'z')
  801aee:	8d 59 9f             	lea    -0x61(%ecx),%ebx
  801af1:	80 fb 19             	cmp    $0x19,%bl
  801af4:	77 08                	ja     801afe <strtol+0x92>
			dig = *s - 'a' + 10;
  801af6:	0f be c9             	movsbl %cl,%ecx
  801af9:	83 e9 57             	sub    $0x57,%ecx
  801afc:	eb 0e                	jmp    801b0c <strtol+0xa0>
		else if (*s >= 'A' && *s <= 'Z')
  801afe:	8d 59 bf             	lea    -0x41(%ecx),%ebx
  801b01:	80 fb 19             	cmp    $0x19,%bl
  801b04:	77 12                	ja     801b18 <strtol+0xac>
			dig = *s - 'A' + 10;
  801b06:	0f be c9             	movsbl %cl,%ecx
  801b09:	83 e9 37             	sub    $0x37,%ecx
		else
			break;
		if (dig >= base)
  801b0c:	39 f1                	cmp    %esi,%ecx
  801b0e:	7d 0c                	jge    801b1c <strtol+0xb0>
			break;
		s++, val = (val * base) + dig;
  801b10:	42                   	inc    %edx
  801b11:	0f af c6             	imul   %esi,%eax
  801b14:	01 c8                	add    %ecx,%eax
		// we don't properly detect overflow!
	}
  801b16:	eb c4                	jmp    801adc <strtol+0x70>
  ...
  801b1a:	eb 02                	jmp    801b1e <strtol+0xb2>
			dig = *s - 'A' + 10;
		else
			break;
		if (dig >= base)
  ...
  801b22:	74 05                	je     801b29 <strtol+0xbd>
		*endptr = (char *) s;
  801b24:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  801b27:	89 13                	mov    %edx,(%ebx)
	return (neg ? -val : val);
  801b29:	85 ff                	test   %edi,%edi
  801b2b:	74 04                	je     801b31 <strtol+0xc5>
  801b2d:	89 c8                	mov    %ecx,%eax
  801b2f:	f7 d8                	neg    %eax
}
  801b31:	5b                   	pop    %ebx
  801b32:	5e                   	pop    %esi
  801b33:	5f                   	pop    %edi
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801b47:	8b 7d 10             	mov    0x10(%ebp),%edi
	// LAB 4: Your code here.
	if(!pg)
  801b4a:	85 db                	test   %ebx,%ebx
  801b4c:	75 05                	jne    801b53 <ipc_recv+0x1b>
		pg = (void *)UTOP;
  801b4e:	bb 00 00 c0 ee       	mov    $0xeec00000,%ebx
	if(sys_ipc_recv(pg) < 0){
  801b53:	89 1c 24             	mov    %ebx,(%esp)
  801b56:	e8 48 e8 ff ff       	call   8003a3 <sys_ipc_recv>
  801b5b:	85 c0                	test   %eax,%eax
  801b5d:	79 16                	jns    801b75 <ipc_recv+0x3d>
		*from_env_store = 0;
  ...
  801b6e:	e8 30 e8 ff ff       	call   8003a3 <sys_ipc_recv>
  801b73:	eb 24                	jmp    801b99 <ipc_recv+0x61>
	}		
	
	if(from_env_store)
  801b75:	85 f6                	test   %esi,%esi
  801b77:	74 0a                	je     801b83 <ipc_recv+0x4b>
		*from_env_store = thisenv->env_ipc_from;
  801b79:	a1 04 40 80 00       	mov    0x804004,%eax
  801b7e:	8b 40 74             	mov    0x74(%eax),%eax
  801b81:	89 06                	mov    %eax,(%esi)
	if(perm_store)
  801b83:	85 ff                	test   %edi,%edi
  801b85:	74 0a                	je     801b91 <ipc_recv+0x59>
		*perm_store = thisenv->env_ipc_perm;
  801b87:	a1 04 40 80 00       	mov    0x804004,%eax
  801b8c:	8b 40 78             	mov    0x78(%eax),%eax
  801b8f:	89 07                	mov    %eax,(%edi)
	return thisenv->env_ipc_value;	
  801b91:	a1 04 40 80 00       	mov    0x804004,%eax
  801b96:	8b 40 70             	mov    0x70(%eax),%eax
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801bad:	8b 5d 10             	mov    0x10(%ebp),%ebx
  801bb0:	8b 75 14             	mov    0x14(%ebp),%esi
	// LAB 4: Your code here.
	if (pg == NULL) {
  801bb3:	85 db                	test   %ebx,%ebx
  801bb5:	75 05                	jne    801bbc <ipc_send+0x1b>
		pg = (void *)-1;
  801bb7:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
	}
	int r;
	while(1) {
		r = sys_ipc_try_send(to_env, val, pg, perm);
  801bbc:	89 74 24 0c          	mov    %esi,0xc(%esp)
  801bc0:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  801bc4:	89 7c 24 04          	mov    %edi,0x4(%esp)
  801bc8:	8b 45 08             	mov    0x8(%ebp),%eax
  801bcb:	89 04 24             	mov    %eax,(%esp)
  801bce:	e8 ad e7 ff ff       	call   800380 <sys_ipc_try_send>
		if (r == 0) {		
  801bd3:	85 c0                	test   %eax,%eax
  801bd5:	74 2c                	je     801c03 <ipc_send+0x62>
			return;
		} else if (r == -E_IPC_NOT_RECV) {	
  801bd7:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801bda:	75 07                	jne    801be3 <ipc_send+0x42>
			sys_yield();
  801bdc:	e8 8d e5 ff ff       	call   80016e <sys_yield>
		} else {			
			panic("ipc_send():%e", r);
		}
	}
  801be1:	eb d9                	jmp    801bbc <ipc_send+0x1b>
		if (r == 0) {		
			return;
		} else if (r == -E_IPC_NOT_RECV) {	
			sys_yield();
  ...
  801be7:	c7 44 24 08 60 23 80 	movl   $0x802360,0x8(%esp)
  801bee:	00 
  801bef:	c7 44 24 04 40 00 00 	movl   $0x40,0x4(%esp)
  801bf6:	00 
  801bf7:	c7 04 24 6e 23 80 00 	movl   $0x80236e,(%esp)
  801bfe:	e8 6d f5 ff ff       	call   801170 <_panic>
		}
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801c17:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
  801c1e:	89 c2                	mov    %eax,%edx
  801c20:	c1 e2 07             	shl    $0x7,%edx
  801c23:	29 ca                	sub    %ecx,%edx
  801c25:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801c2b:	8b 52 50             	mov    0x50(%edx),%edx
  801c2e:	39 da                	cmp    %ebx,%edx
  801c30:	75 0f                	jne    801c41 <ipc_find_env+0x36>
			return envs[i].env_id;
  801c32:	c1 e0 07             	shl    $0x7,%eax
  801c35:	29 c8                	sub    %ecx,%eax
  801c37:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  801c3c:	8b 40 40             	mov    0x40(%eax),%eax
  801c3f:	eb 0c                	jmp    801c4d <ipc_find_env+0x42>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801c47:	75 ce                	jne    801c17 <ipc_find_env+0xc>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  801c49:	66 b8 00 00          	mov    $0x0,%ax
}
  801c4d:	5b                   	pop    %ebx
  801c4e:	5d                   	pop    %ebp
  801c4f:	c3                   	ret    
...
00801c94 <__udivdi3>:
  ...
  801c9a:	8b 74 24 20          	mov    0x20(%esp),%esi
  801c9e:	8b 4c 24 28          	mov    0x28(%esp),%ecx
  801ca2:	89 74 24 04          	mov    %esi,0x4(%esp)
  801ca6:	8b 7c 24 24          	mov    0x24(%esp),%edi
  801caa:	89 cd                	mov    %ecx,%ebp
  801cac:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  801cb0:	85 c0                	test   %eax,%eax
  801cb2:	75 2c                	jne    801ce0 <__udivdi3+0x4c>
  801cb4:	39 f9                	cmp    %edi,%ecx
  801cb6:	77 68                	ja     801d20 <__udivdi3+0x8c>
  801cb8:	85 c9                	test   %ecx,%ecx
  801cba:	75 0b                	jne    801cc7 <__udivdi3+0x33>
  ...
  801ce2:	77 2c                	ja     801d10 <__udivdi3+0x7c>
  801ce4:	0f bd f0             	bsr    %eax,%esi
  801ce7:	83 f6 1f             	xor    $0x1f,%esi
  801cea:	75 4c                	jne    801d38 <__udivdi3+0xa4>
  801cec:	39 f8                	cmp    %edi,%eax
  801cee:	bf 00 00 00 00       	mov    $0x0,%edi
  801cf3:	72 0a                	jb     801cff <__udivdi3+0x6b>
  801cf5:	3b 4c 24 04          	cmp    0x4(%esp),%ecx
  801cf9:	0f 87 ad 00 00 00    	ja     801dac <__udivdi3+0x118>
  ...
  801d45:	29 f0                	sub    %esi,%eax
  801d47:	89 ea                	mov    %ebp,%edx
  801d49:	88 c1                	mov    %al,%cl
  801d4b:	d3 ea                	shr    %cl,%edx
  801d4d:	8b 4c 24 0c          	mov    0xc(%esp),%ecx
  801d51:	09 ca                	or     %ecx,%edx
  801d53:	89 54 24 08          	mov    %edx,0x8(%esp)
  801d57:	89 f1                	mov    %esi,%ecx
  801d59:	d3 e5                	shl    %cl,%ebp
  801d5b:	89 6c 24 0c          	mov    %ebp,0xc(%esp)
  ...
  801d6b:	8b 7c 24 04          	mov    0x4(%esp),%edi
  801d6f:	88 c1                	mov    %al,%cl
  801d71:	d3 ef                	shr    %cl,%edi
  801d73:	09 d7                	or     %edx,%edi
  ...
  801d85:	39 d1                	cmp    %edx,%ecx
  801d87:	72 17                	jb     801da0 <__udivdi3+0x10c>
  801d89:	74 09                	je     801d94 <__udivdi3+0x100>
  801d8b:	89 fe                	mov    %edi,%esi
  801d8d:	31 ff                	xor    %edi,%edi
  801d8f:	e9 41 ff ff ff       	jmp    801cd5 <__udivdi3+0x41>
  801d94:	8b 54 24 04          	mov    0x4(%esp),%edx
  801d98:	89 f1                	mov    %esi,%ecx
  801d9a:	d3 e2                	shl    %cl,%edx
  801d9c:	39 c2                	cmp    %eax,%edx
  801d9e:	73 eb                	jae    801d8b <__udivdi3+0xf7>
  801da0:	8d 77 ff             	lea    -0x1(%edi),%esi
  801da3:	31 ff                	xor    %edi,%edi
  801da5:	e9 2b ff ff ff       	jmp    801cd5 <__udivdi3+0x41>
  801daa:	66 90                	xchg   %ax,%ax
  801dac:	31 f6                	xor    %esi,%esi
  801dae:	e9 22 ff ff ff       	jmp    801cd5 <__udivdi3+0x41>
	...
...
00801db4 <__umoddi3>:
  ...
  801dba:	8b 44 24 30          	mov    0x30(%esp),%eax
  801dbe:	8b 4c 24 38          	mov    0x38(%esp),%ecx
  801dc2:	89 44 24 14          	mov    %eax,0x14(%esp)
  801dc6:	8b 74 24 34          	mov    0x34(%esp),%esi
  801dca:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  801dce:	8b 6c 24 3c          	mov    0x3c(%esp),%ebp
  801dd2:	89 c7                	mov    %eax,%edi
  801dd4:	89 f2                	mov    %esi,%edx
  801dd6:	85 ed                	test   %ebp,%ebp
  801dd8:	75 16                	jne    801df0 <__umoddi3+0x3c>
  801dda:	39 f1                	cmp    %esi,%ecx
  801ddc:	0f 86 a6 00 00 00    	jbe    801e88 <__umoddi3+0xd4>
  801de2:	f7 f1                	div    %ecx
  ...
  801dee:	c3                   	ret    
  801def:	90                   	nop
  801df0:	39 f5                	cmp    %esi,%ebp
  801df2:	0f 87 ac 00 00 00    	ja     801ea4 <__umoddi3+0xf0>
  801df8:	0f bd c5             	bsr    %ebp,%eax
  801dfb:	83 f0 1f             	xor    $0x1f,%eax
  801dfe:	89 44 24 10          	mov    %eax,0x10(%esp)
  801e02:	0f 84 a8 00 00 00    	je     801eb0 <__umoddi3+0xfc>
  801e08:	8a 4c 24 10          	mov    0x10(%esp),%cl
  801e0c:	d3 e5                	shl    %cl,%ebp
  801e0e:	bf 20 00 00 00       	mov    $0x20,%edi
  801e13:	2b 7c 24 10          	sub    0x10(%esp),%edi
  801e17:	8b 44 24 0c          	mov    0xc(%esp),%eax
  801e1b:	89 f9                	mov    %edi,%ecx
  801e1d:	d3 e8                	shr    %cl,%eax
  801e1f:	09 e8                	or     %ebp,%eax
  801e21:	89 44 24 18          	mov    %eax,0x18(%esp)
  801e25:	8b 44 24 0c          	mov    0xc(%esp),%eax
  801e29:	8a 4c 24 10          	mov    0x10(%esp),%cl
  801e2d:	d3 e0                	shl    %cl,%eax
  801e2f:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801e33:	89 f2                	mov    %esi,%edx
  801e35:	d3 e2                	shl    %cl,%edx
  801e37:	8b 44 24 14          	mov    0x14(%esp),%eax
  801e3b:	d3 e0                	shl    %cl,%eax
  801e3d:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  801e41:	8b 44 24 14          	mov    0x14(%esp),%eax
  801e45:	89 f9                	mov    %edi,%ecx
  801e47:	d3 e8                	shr    %cl,%eax
  801e49:	09 d0                	or     %edx,%eax
  801e4b:	d3 ee                	shr    %cl,%esi
  801e4d:	89 f2                	mov    %esi,%edx
  801e4f:	f7 74 24 18          	divl   0x18(%esp)
  801e53:	89 d6                	mov    %edx,%esi
  801e55:	f7 64 24 0c          	mull   0xc(%esp)
  801e59:	89 c5                	mov    %eax,%ebp
  801e5b:	89 d1                	mov    %edx,%ecx
  801e5d:	39 d6                	cmp    %edx,%esi
  801e5f:	72 67                	jb     801ec8 <__umoddi3+0x114>
  801e61:	74 75                	je     801ed8 <__umoddi3+0x124>
  801e63:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801e67:	29 e8                	sub    %ebp,%eax
  801e69:	19 ce                	sbb    %ecx,%esi
  801e6b:	8a 4c 24 10          	mov    0x10(%esp),%cl
  801e6f:	d3 e8                	shr    %cl,%eax
  801e71:	89 f2                	mov    %esi,%edx
  801e73:	89 f9                	mov    %edi,%ecx
  801e75:	d3 e2                	shl    %cl,%edx
  ...
  801e86:	5d                   	pop    %ebp
  801e87:	c3                   	ret    
  801e88:	85 c9                	test   %ecx,%ecx
  801e8a:	75 0b                	jne    801e97 <__umoddi3+0xe3>
  ...
  801e99:	31 d2                	xor    %edx,%edx
  801e9b:	f7 f1                	div    %ecx
  801e9d:	89 f8                	mov    %edi,%eax
  801e9f:	e9 3e ff ff ff       	jmp    801de2 <__umoddi3+0x2e>
  ...
  801eb0:	39 f5                	cmp    %esi,%ebp
  801eb2:	72 04                	jb     801eb8 <__umoddi3+0x104>
  801eb4:	39 f9                	cmp    %edi,%ecx
  801eb6:	77 06                	ja     801ebe <__umoddi3+0x10a>
  801eb8:	89 f2                	mov    %esi,%edx
  801eba:	29 cf                	sub    %ecx,%edi
  801ebc:	19 ea                	sbb    %ebp,%edx
  ...
  801ecc:	2b 6c 24 0c          	sub    0xc(%esp),%ebp
  801ed0:	1b 4c 24 18          	sbb    0x18(%esp),%ecx
  801ed4:	eb 8d                	jmp    801e63 <__umoddi3+0xaf>
  801ed6:	66 90                	xchg   %ax,%ax
  801ed8:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801edc:	72 ea                	jb     801ec8 <__umoddi3+0x114>
  801ede:	89 f1                	mov    %esi,%ecx
  801ee0:	eb 81                	jmp    801e63 <__umoddi3+0xaf>
